...
const mobileMenuBar = document.querySelector(
  "#sidebar .brand .mobile-sidebar-close .bi-arrow-left-circle"
);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  button.addEventListener("click", function () {
    ...
    legendBody.style.display =
      legendBody.style.display === "none" ? "block" : "none";
  });
});
...
employeeFilter.addEventListener("change", function () {
  // Check if the selected option is the default option
  if (this.value === "") {
    // If so, set the color of the select element to gray
    this.style.color = "#AAAAAA";
    this.style.backgroundColor = "#f6f6f6";
  } else {
    // Otherwise, set the color of the select element to red
    this.style.color = "#3d3b40";
