...
?>
    ...
    <section id="content">
        <main>
            <div class="content-container" id="content-container">
                ...
                <a href="../../personnel/map.php" class="closeFloor"><i class="bi bi-arrow-left"></i></a>
                ...
                <img src='../image.php?id=5762'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5762; ?>"
                    data-room="<?php echo htmlspecialchars($room5762); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5762); ?>"
                    data-image="<?php echo base64_encode($upload_img5762); ?>"
                    data-status="<?php echo htmlspecialchars($status5762); ?>"
                    data-category="<?php echo htmlspecialchars($category5762); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5762); ?>">
    ...
    position:absolute; top:60px; left:875px;'>
                ...
                <img src='../image.php?id=5763'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5763; ?>"
                    data-room="<?php echo htmlspecialchars($room5763); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5763); ?>"
                    data-image="<?php echo base64_encode($upload_img5763); ?>"
                    data-status="<?php echo htmlspecialchars($status5763); ?>"
                    data-category="<?php echo htmlspecialchars($category5763); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5763); ?>">
    ...
    position:absolute; top:155px; left:135px;'>
                ...
                <img src='../image.php?id=5764'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5764; ?>"
                    data-room="<?php echo htmlspecialchars($room5764); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5764); ?>"
                    data-image="<?php echo base64_encode($upload_img5764); ?>"
                    data-category="<?php echo htmlspecialchars($category5764); ?>"
                    data-status="<?php echo htmlspecialchars($status5764); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5764); ?>">
    ...
    position:absolute; top:155px; left:305px;'>
                ...
                <img src='../image.php?id=5765'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5765; ?>"
                    data-room="<?php echo htmlspecialchars($room5765); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5765); ?>"
                    data-image="<?php echo base64_encode($upload_img5765); ?>"
                    data-category="<?php echo htmlspecialchars($category5765); ?>"
                    data-status="<?php echo htmlspecialchars($status5765); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5765); ?>">
    ...
    position:absolute; top:155px; left:465px;'>
                ...
                <img src='../image.php?id=5766'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5766; ?>"
                    data-room="<?php echo htmlspecialchars($room5766); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5766); ?>"
                    data-image="<?php echo base64_encode($upload_img5766); ?>"
                    data-category="<?php echo htmlspecialchars($category5766); ?>"
                    data-status="<?php echo htmlspecialchars($status5766); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5766); ?>">
    ...
    position:absolute; top:155px; left:805px;'>
                ...
                <img src='../image.php?id=5767'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5767; ?>"
                    data-room="<?php echo htmlspecialchars($room5767); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5767); ?>"
                    data-image="<?php echo base64_encode($upload_img5767); ?>"
                    data-category="<?php echo htmlspecialchars($category5767); ?>"
                    data-status="<?php echo htmlspecialchars($status5767); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5767); ?>">
    ...
    position:absolute; top:155px; left:945px;'>
                ...
                <img src='../image.php?id=5768'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5768; ?>"
                    data-room="<?php echo htmlspecialchars($room5768); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5768); ?>"
                    data-image="<?php echo base64_encode($upload_img5768); ?>"
                    data-category="<?php echo htmlspecialchars($category5768); ?>"
                    data-status="<?php echo htmlspecialchars($status5768); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5768); ?>">
    ...
    position:absolute; top:155px; left:1075px;'>
                ...
                <img src='../image.php?id=5769'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5769; ?>"
                    data-room="<?php echo htmlspecialchars($room5769); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5769); ?>"
                    data-image="<?php echo base64_encode($upload_img5769); ?>"
                    data-category="<?php echo htmlspecialchars($category5769); ?>"
                    data-status="<?php echo htmlspecialchars($status5769); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5769); ?>">
    ...
    position:absolute; top:255px; left:135px;'>
                ...
                <img src='../image.php?id=5770'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5770; ?>"
                    data-room="<?php echo htmlspecialchars($room5770); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5770); ?>"
                    data-image="<?php echo base64_encode($upload_img5770); ?>"
                    data-category="<?php echo htmlspecialchars($category5770); ?>"
                    data-status="<?php echo htmlspecialchars($status5770); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5770); ?>">
    ...
    position:absolute; top:255px; left:305px;'>
                ...
                <img src='../image.php?id=5771'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5771; ?>"
                    data-room="<?php echo htmlspecialchars($room5771); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5771); ?>"
                    data-image="<?php echo base64_encode($upload_img5771); ?>"
                    data-category="<?php echo htmlspecialchars($category5771); ?>"
                    data-status="<?php echo htmlspecialchars($status5771); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5771); ?>">
    ...
    position:absolute; top:255px; left:465px;'>
                ...
                <img src='../image.php?id=5772'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5772; ?>"
                    data-room="<?php echo htmlspecialchars($room5772); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5772); ?>"
                    data-image="<?php echo base64_encode($upload_img5772); ?>"
                    data-status="<?php echo htmlspecialchars($status5772); ?>"
                    data-category="<?php echo htmlspecialchars($category5772); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5772); ?>">
    ...
    position:absolute; top:255px; left:625px;'>
                ...
                <img src='../image.php?id=5773'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5773; ?>"
                    data-room="<?php echo htmlspecialchars($room5773); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5773); ?>"
                    data-image="<?php echo base64_encode($upload_img5773); ?>"
                    data-category="<?php echo htmlspecialchars($category5773); ?>"
                    data-status="<?php echo htmlspecialchars($status5773); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5773); ?>">
    ...
    position:absolute; top:255px; left:805px;'>
                ...
                <img src='../image.php?id=5774'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5774; ?>"
                    data-room="<?php echo htmlspecialchars($room5774); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5774); ?>"
                    data-image="<?php echo base64_encode($upload_img5774); ?>"
                    data-category="<?php echo htmlspecialchars($category5774); ?>"
                    data-status="<?php echo htmlspecialchars($status5774); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5774); ?>">
    ...
    position:absolute; top:255px; left:960px;'>
                ...
                <img src='../image.php?id=5775'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5775; ?>"
                    data-room="<?php echo htmlspecialchars($room5775); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5775); ?>"
                    data-image="<?php echo base64_encode($upload_img5775); ?>"
                    data-category="<?php echo htmlspecialchars($category5775); ?>"
                    data-status="<?php echo htmlspecialchars($status5775); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5775); ?>">
    ...
    position:absolute; top:255px; left:1105px;'>
                ...
                <img src='../image.php?id=5776'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5776; ?>"
                    data-room="<?php echo htmlspecialchars($room5776); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5776); ?>"
                    data-image="<?php echo base64_encode($upload_img5776); ?>"
                    data-category="<?php echo htmlspecialchars($category5776); ?>"
                    data-status="<?php echo htmlspecialchars($status5776); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5776); ?>">
    ...
    position:absolute; top:335px; left:135px;'>
                ...
                <img src='../image.php?id=5777'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5777; ?>"
                    data-room="<?php echo htmlspecialchars($room5777); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5777); ?>"
                    data-image="<?php echo base64_encode($upload_img5777); ?>"
                    data-status="<?php echo htmlspecialchars($status5777); ?>"
                    data-category="<?php echo htmlspecialchars($category5777); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5777); ?>">
    ...
    position:absolute; top:335px; left:245px;'>
                ...
                <img src='../image.php?id=5778'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5778; ?>"
                    data-room="<?php echo htmlspecialchars($room5778); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5778); ?>"
                    data-image="<?php echo base64_encode($upload_img5778); ?>"
                    data-category="<?php echo htmlspecialchars($category5778); ?>"
                    data-status="<?php echo htmlspecialchars($status5778); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5778); ?>">
    ...
    position:absolute; top:370px; left:300px;'>
                ...
                <img src='../image.php?id=5779'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5779; ?>"
                    data-room="<?php echo htmlspecialchars($room5779); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5779); ?>"
                    data-image="<?php echo base64_encode($upload_img5779); ?>"
                    data-category="<?php echo htmlspecialchars($category5779); ?>"
                    data-status="<?php echo htmlspecialchars($status5779); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5779); ?>">
    ...
    position:absolute; top:370px; left:455px;'>
                ...
                <img src='../image.php?id=5780'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5780; ?>"
                    data-room="<?php echo htmlspecialchars($room5780); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5780); ?>"
                    data-image="<?php echo base64_encode($upload_img5780); ?>"
                    data-status="<?php echo htmlspecialchars($status5780); ?>"
                    data-category="<?php echo htmlspecialchars($category5780); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5780); ?>">
    ...
    position:absolute; top:410px; left:355px;'>
                ...
                <img src='../image.php?id=5781'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5781; ?>"
                    data-room="<?php echo htmlspecialchars($room5781); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5781); ?>"
                    data-image="<?php echo base64_encode($upload_img5781); ?>"
                    data-category="<?php echo htmlspecialchars($category5781); ?>"
                    data-status="<?php echo htmlspecialchars($status5781); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5781); ?>">
    ...
    position:absolute; top:410px; left:395px;'>
                ...
                <img src='../image.php?id=5782'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5782; ?>"
                    data-room="<?php echo htmlspecialchars($room5782); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5782); ?>"
                    data-image="<?php echo base64_encode($upload_img5782); ?>"
                    data-status="<?php echo htmlspecialchars($status5782); ?>"
                    data-category="<?php echo htmlspecialchars($category5782); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5782); ?>">
    ...
    position:absolute; top:450px; left:300px;'>
                ...
                <img src='../image.php?id=5783'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5783; ?>"
                    data-room="<?php echo htmlspecialchars($room5783); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5783); ?>"
                    data-image="<?php echo base64_encode($upload_img5783); ?>"
                    data-status="<?php echo htmlspecialchars($status5783); ?>"
                    data-category="<?php echo htmlspecialchars($category5783); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5783); ?>">
    ...
    position:absolute; top:450px; left:455px;'>
                ...
                <img src='../image.php?id=5784'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5784; ?>"
                    data-room="<?php echo htmlspecialchars($room5784); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5784); ?>"
                    data-image="<?php echo base64_encode($upload_img5784); ?>"
                    data-status="<?php echo htmlspecialchars($status5784); ?>"
                    data-category="<?php echo htmlspecialchars($category5784); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5784); ?>">
    ...
    position:absolute; top:350px; left:595px;'>
                ...
                <img src='../image.php?id=5785'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5785; ?>"
                    data-room="<?php echo htmlspecialchars($room5785); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5785); ?>"
                    data-image="<?php echo base64_encode($upload_img5785); ?>"
                    data-status="<?php echo htmlspecialchars($status5785); ?>"
                    data-category="<?php echo htmlspecialchars($category5785); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5785); ?>">
    ...
    position:absolute; top:350px; left:665px;'>
                ...
                <img src='../image.php?id=5786'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5786; ?>"
                    data-room="<?php echo htmlspecialchars($room5786); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5786); ?>"
                    data-image="<?php echo base64_encode($upload_img5786); ?>"
                    data-status="<?php echo htmlspecialchars($status5786); ?>"
                    data-category="<?php echo htmlspecialchars($category5786); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5786); ?>">
    ...
    position:absolute; top:370px; left:795px;'>
                ...
                <img src='../image.php?id=5787'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5787; ?>"
                    data-room="<?php echo htmlspecialchars($room5787); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5787); ?>"
                    data-image="<?php echo base64_encode($upload_img5787); ?>"
                    data-status="<?php echo htmlspecialchars($status5787); ?>"
                    data-category="<?php echo htmlspecialchars($category5787); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5787); ?>">
    ...
    position:absolute; top:370px; left:945px;'>
                ...
                <img src='../image.php?id=5788'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5788; ?>"
                    data-room="<?php echo htmlspecialchars($room5788); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5788); ?>"
                    data-image="<?php echo base64_encode($upload_img5788); ?>"
                    data-status="<?php echo htmlspecialchars($status5788); ?>"
                    data-category="<?php echo htmlspecialchars($category5788); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5788); ?>">
    ...
    position:absolute; top:410px; left:845px;'>
                ...
                <img src='../image.php?id=5789'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5789; ?>"
                    data-room="<?php echo htmlspecialchars($room5789); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5789); ?>"
                    data-image="<?php echo base64_encode($upload_img5789); ?>"
                    data-category="<?php echo htmlspecialchars($category5789); ?>"
                    data-status="<?php echo htmlspecialchars($status5789); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5789); ?>">
    ...
    position:absolute; top:410px; left:885px;'>
                ...
                <img src='../image.php?id=5790'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5790; ?>"
                    data-room="<?php echo htmlspecialchars($room5790); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5790); ?>"
                    data-image="<?php echo base64_encode($upload_img5790); ?>"
                    data-category="<?php echo htmlspecialchars($category5790); ?>"
                    data-status="<?php echo htmlspecialchars($status5790); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5790); ?>">
    ...
    position:absolute; top:450px; left:795px;'>
                ...
                <img src='../image.php?id=5791'
                    ...
                    class="asset-image" data-id="<?php echo $assetId5791; ?>"
                    data-room="<?php echo htmlspecialchars($room5791); ?>"
                    data-floor="<?php echo htmlspecialchars($floor5791); ?>"
                    data-image="<?php echo base64_encode($upload_img5791); ?>"
                    data-status="<?php echo htmlspecialchars($status5791); ?>"
                    data-category="<?php echo htmlspecialchars($category5791); ?>"
                    data-assignedname="<?php echo htmlspecialchars($assignedName5791); ?>">
    ...
    position:absolute; top:450px; left:945px;'>
            ...
            <div class='modal fade' id='imageModal5763' tabindex='-1' aria-labelledby='imageModalLabel5763'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5763); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5763); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5763); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5763); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5763); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5763); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5763); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5763); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5763); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5763); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5763); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5763-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5763" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5764' tabindex='-1' aria-labelledby='imageModalLabel5764'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5764); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5764); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5764); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5764); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5764); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5764); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5764); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5764); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5764); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5764); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5764); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5764-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5764" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5765' tabindex='-1' aria-labelledby='imageModalLabel5765'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5765); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5765); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5765); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5765); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5765); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5765); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5765); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5765); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5765); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5765); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5765); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5765-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5765" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5766' tabindex='-1' aria-labelledby='imageModalLabel5766'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5766); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5766); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5766); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5766); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5766); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5766); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5766); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5766); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5766); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5766); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5766); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5766-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5766" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5767' tabindex='-1' aria-labelledby='imageModalLabel5767'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5767); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5767); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5767); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5767); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5767); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5767); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5767); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5767); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5767); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5767); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5767); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5767-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5767" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5768' tabindex='-1' aria-labelledby='imageModalLabel5768'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5768); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5768); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5768); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5768); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5768); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5768); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5768); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5768); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5768); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5768); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5768); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5768-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5768" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5769' tabindex='-1' aria-labelledby='imageModalLabel5769'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5769); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5769); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5769); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5769); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5769); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5769); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5769); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5769); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5769); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5769); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5769); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5769-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5769" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5770' tabindex='-1' aria-labelledby='imageModalLabel5771'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5770); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5770); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5770); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5770); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5770); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5770); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5770); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5770); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5770); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5770); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5770); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5770-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5770" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5771' tabindex='-1' aria-labelledby='imageModalLabel5771'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5771); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5771); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5771); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5771); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5771); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5771); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5771); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5771); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5771); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5771); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5771); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5771-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5771" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5772' tabindex='-1' aria-labelledby='imageModalLabel5772'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5772); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5772); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5772); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5772); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5772); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5772); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5772); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5772); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5772); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5772); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5772); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5772-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5772" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5773' tabindex='-1' aria-labelledby='imageModalLabel5773'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5773); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5773); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5773); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5773); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5773); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5773); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5773); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5773); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5773); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5773); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5773); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5773-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5773" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5774' tabindex='-1' aria-labelledby='imageModalLabel5774'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5774); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5774); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5774); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5774); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5774); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5774); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5774); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5774); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5774); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5774); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5774); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5774-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5774" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5775' tabindex='-1' aria-labelledby='imageModalLabel5775'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5775); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5775); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5775); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5775); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5775); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5775); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5775); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5775); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5775); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5775); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5775); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5775-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5775" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5776' tabindex='-1' aria-labelledby='imageModalLabel5776'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5776); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5776); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5776); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5776); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5776); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5776); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5776); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5776); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5776); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5776); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5776); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5776-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5776" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5777' tabindex='-1' aria-labelledby='imageModalLabel5777'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5777); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5777); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5777); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5777); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5777); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5777); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5777); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5777); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5777); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5777); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5777); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5777-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5777" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5778' tabindex='-1' aria-labelledby='imageModalLabel5778'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5778); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5778); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5778); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5778); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5778); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5778); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5778); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5778); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5778); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5778); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5778); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5778-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5778" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5779' tabindex='-1' aria-labelledby='imageModalLabel5779'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5779); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5779); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5779); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5779); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5779); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5779); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5779); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5779); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5779); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5779); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5779); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5779-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5779" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5780' tabindex='-1' aria-labelledby='imageModalLabel5780'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5780); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5780); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5780); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5780); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5780); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5780); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5780); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5780); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5780); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5780); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5780); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5780-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5780" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5781' tabindex='-1' aria-labelledby='imageModalLabel5781'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5781); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5781); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5781); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5781); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5781); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5781); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5781); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5781); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5781); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5781); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5781); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5781-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5781" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5782' tabindex='-1' aria-labelledby='imageModalLabel5782'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5782); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5782); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5782); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5782); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5782); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5782); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5782); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5782); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5782); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5782); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5782); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5782-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5782" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5783' tabindex='-1' aria-labelledby='imageModalLabel5783'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5783); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5783); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5783); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5783); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5783); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5783); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5783); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5783); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5783); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5783); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5783); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5783-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5783" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5784' tabindex='-1' aria-labelledby='imageModalLabel5784'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5784); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5784); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5784); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5784); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5784); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5784); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5784); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5784); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5784); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5784); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5784); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5784-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5784" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5785' tabindex='-1' aria-labelledby='imageModalLabel5785'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5785); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5785); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5785); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5785); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5785); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5785); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5785); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5785); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5785); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5785); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5785); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5785-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5785" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5786' tabindex='-1' aria-labelledby='imageModalLabel5786'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5786); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5786); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5786); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5786); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5786); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5786); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5786); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5786); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5786); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5786); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5786); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5786-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5786" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5787' tabindex='-1' aria-labelledby='imageModalLabel5787'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5787); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5787); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5787); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5787); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5787); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5787); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5787); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5787); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5787); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5787); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5787); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5787-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5787" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5788' tabindex='-1' aria-labelledby='imageModalLabel5788'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5788); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5788); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5788); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5788); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5788); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5788); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5788); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5788); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5788); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5788); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5788); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5788-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5788" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5789' tabindex='-1' aria-labelledby='imageModalLabel5789'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5789); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5789); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5789); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5789); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5789); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5789); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5789); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5789); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5789); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5789); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5789); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5789-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5789" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5790' tabindex='-1' aria-labelledby='imageModalLabel5790'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5790); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5790); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5790); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5790); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5790); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5790); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5790); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5790); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5790); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5790); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5790); ?>" />
                                </div>
                                <!--End of Fifth Row-->
            ...
            <!--Edit for table 5790-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5790" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
            ...
            <div class='modal fade' id='imageModal5791' tabindex='-1' aria-labelledby='imageModalLabel5791'
                aria-hidden='true'>
                <div class='modal-dialog modal-xl modal-dialog-centered'>
                    <div class='modal-content'>
                        <!-- Modal header -->
                        ...
                        <div class='modal-body'>
                            <form method="post" class="row g-3" enctype="multipart/form-data">
                                <input type="hidden" name="assetId"
                                    value="<?php echo htmlspecialchars($assetId5791); ?>">
                                <!--START DIV FOR IMAGE -->

                                <!--First Row-->
                                <!--IMAGE HERE-->
                                <div class="col-12 center-content">
                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img5791); ?>"
                                        alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                </div>
                                <!--END DIV FOR IMAGE -->
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assetId" class="form-label">Tracking #:</label>
                                    <input type="text" class="form-control" id="assetId" name="assetId"
                                        value="<?php echo htmlspecialchars($assetId5791); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="date" class="form-label">Date:</label>
                                    <input type="text" class="form-control" id="date" name="date"
                                        value="<?php echo htmlspecialchars($date5791); ?>" readonly />
                                </div>

                                <!--Second Row-->
                                <div class="col-6">
                                    <input type="text" class="form-control" id="room" name="room"
                                        value="<?php echo htmlspecialchars($room5791); ?>" readonly />
                                </div>


                                <div class="col-6" style="display:none">
                                    <input type="text" class="form-control  center-content" id="building"
                                        name="building" value="<?php echo htmlspecialchars($building5791); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control" id="floor" name="floor"
                                        value="<?php echo htmlspecialchars($floor5791); ?>" readonly />
                                </div>

                                <div class="col-12 center-content">
                                    <input type="text" class="form-control  center-content" id="category"
                                        name="category" value="<?php echo htmlspecialchars($category5791); ?>"
                                        readonly />
                                </div>
                                ...
                                <div class="col-4" style="display:none">
                                    <label for="assignedName" class="form-label">Assigned Name:</label>
                                    <input type="text" class="form-control" id="assignedName" name="assignedName"
                                        value="<?php echo htmlspecialchars($assignedName5791); ?>" readonly />
                                </div>

                                <div class="col-4" style="display:none">
                                    <label for="assignedBy" class="form-label">Assigned By:</label>
                                    <input type="text" class="form-control" id="assignedBy" name="assignedBy"
                                        value="<?php echo htmlspecialchars($assignedBy5791); ?>" readonly />
                                </div>
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="description" name="description"
                                        value="<?php echo htmlspecialchars($description5791); ?>" />
                                </div>
                                <!--End of Fifth Row-->
                                ...
                                <div class="button-submit-container">
                                    <button type="button" class="btn add-modal-btn" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdrop5791">
                                        Save
                                    </button>
                                </div>
                        </div>
            ...
            <!--Edit for table 5791-->
            <div class="map-alert">
                <div class="modal fade" id="staticBackdrop5791" data-bs-backdrop="static" data-bs-keyboard="false"
                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-footer">
