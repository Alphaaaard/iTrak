...
if (isset($_SESSION['accountId']) && isset($_SESSION['email']) && isset($_SESSION['role']) && isset($_SESSION['userLevel'])) {
    ...
    // For Admin page, check if userLevel is 1
    // For Manager page, check if userLevel is 2
...
?>
    ...
    <section id="content">
        ...
        <main>
                ...
                <section class="content1">
                    <main class="present-buttons-container">
                        ...
                        <div class="present-main-per">
                            ...
                            <div class="modal-parent">
                                <div class="modal modal-xl fade" id="Modal-Manager" data-bs-backdrop="static"
                                    tabindex="-1" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                    ...
                    <main id="calendar">
                        ...
                        <div class="modal-parents">
                            <div class="modal modal-xl fade schedmodal" id="exampleModal3" tabindex="-1"
                        ...
                        <!--Modal for Old Acad-->
                        <div class="modal-parent">
                            <div class="modal modal-xl fade schedmodal" id="exampleModal4" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="header-modal">
                        ...
                        <!--Modal for belmonte-->
                        <div class="modal-parent">
                            <div class="modal modal-xl fade schedmodal" id="exampleModal5" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="header-modal">
                        ...
                        <div class="modal-parent">
                            <div class="modal modal-xl fade schedmodal" id="exampleModal6" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="header-modal">
            ...
            <!--Modal for korphil-->
            <div class="modal-parent">
                <div class="modal modal-xl fade schedmodal" id="exampleModal7" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="header-modal">
    ...
    <div class="modal-parent">
        <div class="modal modal-xl fade schedmodal" id="exampleModal8" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header-modal">
    ...
    <!--Modal for chineseA-->
    <div class="modal-parent">
        <div class="modal modal-xl fade schedmodal" id="exampleModal9" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header-modal">
    ...
    <!--Modal for chineseB-->
    <div class="modal-parent">
        <div class="modal modal-xl fade schedmodal" id="exampleModal10" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header-modal">
    ...
    <div class="modal-parent">
        <div class="modal modal-xl fade schedmodal" id="exampleModal11" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header-modal">
    ...
    <div class="modal-parent">
        <div class="modal modal-xl fade schedmodal" id="exampleModal12" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header-modal">
    ...
    <!--Modal for bautista-->
    <div class="modal-parent">
        <div class="modal modal-xl fade schedmodal" id="exampleModal13" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header-modal">
    ...
    <!--Modal for newAcad-->
    <div class="modal-parent">
        <div class="modal modal-xl fade schedmodal" id="exampleModal14" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header-modal">
