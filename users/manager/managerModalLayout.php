        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 class="mb-5">Maintenance Personnel Info</h5>
                    ...
                    <form method="post" class="row g-3">
                        ...
                        <div class="col-4">
                            ...
                            <button type="button" class="form-control">RFID</button>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal modal-xl fade" id="updateSelfModal" tabindex="-1" aria-labelledby="updateModalSelfLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <h5>Edit Maintenance Personnel</h5>
                    ...
                    <form class="row g-3 userUpdateFormSelf" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-4">
                            <label for="firstname" class="form-label">First name</label>
                            <input type="text" class="form-control firstnameEdit" id="firstnameEditSelf" name="firstname" value="<?php echo $user['firstName'] ?>" readonly/>
                        </div>

                        <div class="col-4">
                            <label for="middlename" class="form-label">Middle name</label>
                            <input type="text" class="form-control middlenameEdit" id="middlenameEditSelf" name="middlename" value="<?php echo $user['middleName'] ?>" readonly/>
                        </div>

                        <div class="col-4">
                            <label for="lastname" class="form-label">Last name</label>
                            <input type="text" class="form-control lastnameEdit" id="lastnameEditSelf" name="lastname" value="<?php echo $user['lastName'] ?>" readonly/>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <input type="date" class="form-control birthdayEdit" id="birthdayEditSelf" max="2006-01-01" name="birthday" value="<?php echo $user['birthday'] ?>"/>
                        </div>

                        <div class="col-4">
                            <label for="role" class="form-label">Role</label>
                            <input type="text" class="form-control roleEdit" id="roleEditSelf" name="role" value="<?php echo $user['role'] ?>" readonly/>
                        </div>

                        <div class="col-4">
                            <label for="user_pass" class="form-label">Register RFID</label>
                            <button type="button" class="form-control btn-custom" readonly>RFID</button>

                            <input type="password rfidFieldEdit" id='rfidFieldEditSelf' name="rfid" class="d-none" value="<?php echo $user['rfidNumber'] ?>">
                        </div>
