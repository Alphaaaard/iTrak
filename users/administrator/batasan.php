...
if (isset($_SESSION['accountId']) && isset($_SESSION['email']) && isset($_SESSION['role']) && isset($_SESSION['userLevel'])) {
    ...
    AND status IN ('Pending', 'Done', 'For Approval') 
                                        ...
                                        <div class="modal-body">
                                            <form id="addrequestForm" method="post" class="row g-3">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" class="form-control" id="new_building" name="new_building" />
                                                </div>

                                                <div class="col-4">
                                                    <label for="new_floor" class="form-label">Floor:</label>
                                                    <input type="text" class="form-control" id="new_floor" name="new_floor" />
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" class="form-control" id="new_equipment" name="new_equipment" />
                                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="outsourceForm" method="post" class="row g-3">
                                                ...
                                                <div class="footer">
                                                    <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#ForOutsources" onclick="showOutsourceConfirmation()">
                                                        Save
                                                    </button>
                                                </div>
                                        </div>
