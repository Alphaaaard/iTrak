...
if (isset($_SESSION['accountId']) && isset($_SESSION['email']) && isset($_SESSION['role']) && isset($_SESSION['userLevel'])) {
    ...
    $sql = "SELECT * FROM request WHERE campus = 'San Francisco' AND status IN ('Pending', 'Done', 'For Approval') AND category != 'Outsource'";
    $result = $conn->query($sql) or die($conn->error);


    $sql2 = "SELECT * FROM request WHERE campus = 'San Francisco' AND category = 'Outsource'";
