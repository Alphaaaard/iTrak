                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" class="row g-3">
                            ...
                            <div class="col-4">
                                <input type="hidden" class="form-label" value="<?php echo $user['rfidNumber'] ?>"/>
                    ...
                    <div class="modal-body ">
                        ...
                        <form class="row g-3 userUpdateFormSelf" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-4">
                                ...
                                <input type="date" class="form-control birthdayEdit" id="birthdayEditSelf" name="birthday" max="2006-01-01" value="<?php echo $user['birthday'] ?>" />
                            </div>
