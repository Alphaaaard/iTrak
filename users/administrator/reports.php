                                ...
                                <form id="assignPersonnelForm" method="post" class="row g-3">
                                    ...
                                    <div class="col-6">
                                        <select class="form-select assignedName2" id="assignedName2" name="assignedName" style="color: black;">
                                            <option value="" selected disabled>Select Personnel</option> <!-- Placeholder option -->
                                            <?php
                                        ...
                                        <label for="os_identity" class="form-label" style="display:none;">Outsource Name:</label>
