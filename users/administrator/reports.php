...
if (isset($_POST['complete'])) {
    ...
    $sqlUpdate = "UPDATE asset SET status = 'Complete' WHERE assetId = '$assetId'";
            ...
            <div class="modal modal-xl fade" id="exampleModal5" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content assingee-container">
                        ...
                        <div class="footer">
                            <button type="button" class="btn btn-primary view-btn archive-btn" data-bs-toggle="modal"
                                data-bs-target="#LezgoApproval">
                                Save
                            </button>
