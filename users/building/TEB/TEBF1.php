...
// SQL = 910        // SQL906 = 906     // SQL930 = 930     // SQL943 = 943     // SQL956 = 956
// SQL2 = 911       // SQL907 = 907     // SQL931 = 931     // SQL944 = 944     // SQL957 = 957
// SQL3 = 912       // SQL908 = 908     // SQL932 = 932     // SQL945 = 945     // SQL958 = 958
// SQL4 = 913       // SQL909 = 909     // SQL933 = 933     // SQL946 = 946     // SQL959 = 959
// SQL5 = 914       // SQL920 = 920     // SQL934 = 934     // SQL947 = 947     // SQL960 = 960
// SQL6 = 915       // SQL921 = 921     // SQL935 = 935     // SQL948 = 948     // SQL961 = 961   
// SQL7 = 916       // SQL922 = 922     // SQL936 = 936     // SQL949 = 949     // SQL962 = 962
// SQL8 = 917       // SQL923 = 922     // SQL937 = 937     // SQL950 = 950     // SQL963 = 963
// SQL9 = 918       // SQL924 = 923     // SQL938 = 938     // SQL951 = 951     // SQL964 = 964
...
// SQL6886 = 905    // SQL929 = 929     // SQL942 = 942     // SQL955 = 955
...
if (isset($_SESSION['accountId']) && isset($_SESSION['email']) && isset($_SESSION['role']) && isset($_SESSION['userLevel'])) {
    ...
    //FOR ID 955 lights
    $sql955 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 955";
    $stmt955 = $conn->prepare($sql955);
    $stmt955->execute();
    $result955 = $stmt955->get_result();
    $row955 = $result955->fetch_assoc();
    $assetId955 = $row955['assetId'];
    $category955 = $row955['category'];
    $date955 = $row955['date'];
    $building955 = $row955['building'];
    $floor955 = $row955['floor'];
    $room955 = $row955['room'];
    $status955 = $row955['status'];
    $assignedName955 = $row955['assignedName'];
    $assignedBy955 = $row955['assignedBy'];
    $upload_img955 = $row955['upload_img'];
    $description955 = $row955['description'];

    //FOR ID 956 lights
    $sql956 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 956";
    $stmt956 = $conn->prepare($sql956);
    $stmt956->execute();
    $result956 = $stmt956->get_result();
    $row956 = $result956->fetch_assoc();
    $assetId956 = $row956['assetId'];
    $category956 = $row956['category'];
    $date956 = $row956['date'];
    $building956 = $row956['building'];
    $floor956 = $row956['floor'];
    $room956 = $row956['room'];
    $status956 = $row956['status'];
    $assignedName956 = $row956['assignedName'];
    $assignedBy956 = $row956['assignedBy'];
    $upload_img956 = $row956['upload_img'];
    $description956 = $row956['description'];

    //FOR ID 957 lights
    $sql957 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 957";
    $stmt957 = $conn->prepare($sql957);
    $stmt957->execute();
    $result957 = $stmt957->get_result();
    $row957 = $result957->fetch_assoc();
    $assetId957 = $row957['assetId'];
    $category957 = $row957['category'];
    $date957 = $row957['date'];
    $building957 = $row957['building'];
    $floor957 = $row957['floor'];
    $room957 = $row957['room'];
    $status957 = $row957['status'];
    $assignedName957 = $row957['assignedName'];
    $assignedBy957 = $row957['assignedBy'];
    $upload_img957 = $row957['upload_img'];
    $description957 = $row957['description'];

    //FOR ID 958 lights
    $sql958 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 958";
    $stmt958 = $conn->prepare($sql958);
    $stmt958->execute();
    $result958 = $stmt958->get_result();
    $row958 = $result958->fetch_assoc();
    $assetId958 = $row958['assetId'];
    $category958 = $row958['category'];
    $date958 = $row958['date'];
    $building958 = $row958['building'];
    $floor958 = $row958['floor'];
    $room958 = $row958['room'];
    $status958 = $row958['status'];
    $assignedName958 = $row958['assignedName'];
    $assignedBy958 = $row958['assignedBy'];
    $upload_img958 = $row958['upload_img'];
    $description958 = $row958['description'];

    //FOR ID 959 lights
    $sql959 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 959";
    $stmt959 = $conn->prepare($sql959);
    $stmt959->execute();
    $result959 = $stmt959->get_result();
    $row959 = $result959->fetch_assoc();
    $assetId959 = $row959['assetId'];
    $category959 = $row959['category'];
    $date959 = $row959['date'];
    $building959 = $row959['building'];
    $floor959 = $row959['floor'];
    $room959 = $row959['room'];
    $status959 = $row959['status'];
    $assignedName959 = $row959['assignedName'];
    $assignedBy959 = $row959['assignedBy'];
    $upload_img959 = $row959['upload_img'];
    $description959 = $row959['description'];

    //FOR ID 960 lights
    $sql960 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 960";
    $stmt960 = $conn->prepare($sql960);
    $stmt960->execute();
    $result960 = $stmt960->get_result();
    $row960 = $result960->fetch_assoc();
    $assetId960 = $row960['assetId'];
    $category960 = $row960['category'];
    $date960 = $row960['date'];
    $building960 = $row960['building'];
    $floor960 = $row960['floor'];
    $room960 = $row960['room'];
    $status960 = $row960['status'];
    $assignedName960 = $row960['assignedName'];
    $assignedBy960 = $row960['assignedBy'];
    $upload_img960 = $row960['upload_img'];
    $description960 = $row960['description'];
    

    //FOR ID 961 lights
    $sql961 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 961";
    $stmt961 = $conn->prepare($sql961);
    $stmt961->execute();
    $result961 = $stmt961->get_result();
    $row961 = $result961->fetch_assoc();
    $assetId961 = $row961['assetId'];
    $category961 = $row961['category'];
    $date961 = $row961['date'];
    $building961 = $row961['building'];
    $floor961 = $row961['floor'];
    $room961 = $row961['room'];
    $status961 = $row961['status'];
    $assignedName961 = $row961['assignedName'];
    $assignedBy961 = $row961['assignedBy'];
    $upload_img961 = $row961['upload_img'];
    $description961 = $row961['description'];

    //FOR ID 962 lights
    $sql962 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 962";
    $stmt962 = $conn->prepare($sql962);
    $stmt962->execute();
    $result962 = $stmt962->get_result();
    $row962 = $result962->fetch_assoc();
    $assetId962 = $row962['assetId'];
    $category962 = $row962['category'];
    $date962 = $row962['date'];
    $building962 = $row962['building'];
    $floor962 = $row962['floor'];
    $room962 = $row962['room'];
    $status962 = $row962['status'];
    $assignedName962 = $row962['assignedName'];
    $assignedBy962 = $row962['assignedBy'];
    $upload_img962 = $row962['upload_img'];
    $description962 = $row962['description'];

    //FOR ID 963 lights
    $sql963 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 963";
    $stmt963 = $conn->prepare($sql963);
    $stmt963->execute();
    $result963 = $stmt963->get_result();
    $row963 = $result963->fetch_assoc();
    $assetId963 = $row963['assetId'];
    $category963 = $row963['category'];
    $date963 = $row963['date'];
    $building963 = $row963['building'];
    $floor963 = $row963['floor'];
    $room963 = $row963['room'];
    $status963 = $row963['status'];
    $assignedName963 = $row963['assignedName'];
    $assignedBy963 = $row963['assignedBy'];
    $upload_img963 = $row963['upload_img'];
    $description963 = $row963['description'];

    //FOR ID 964 lights
    $sql964 = "SELECT assetId, category, building, floor, room, images, assignedName, assignedBy, status, date,upload_img, description FROM asset WHERE assetId = 964";
    $stmt964 = $conn->prepare($sql964);
    $stmt964->execute();
    $result964 = $stmt964->get_result();
    $row964 = $result964->fetch_assoc();
    $assetId964 = $row964['assetId'];
    $category964 = $row964['category'];
    $date964 = $row964['date'];
    $building964 = $row964['building'];
    $floor964 = $row964['floor'];
    $room964 = $row964['room'];
    $status964 = $row964['status'];
    $assignedName964 = $row964['assignedName'];
    $assignedBy964 = $row964['assignedBy'];
    $upload_img964 = $row964['upload_img'];
    $description964 = $row964['description'];
...
//FOR ID 955
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit955'])) {
    // Get form data
    $assetId955 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status955 = $_POST['status']; // Get the status from the form
    $description955 = $_POST['description']; // Get the description from the form
    $room955 = $_POST['room']; // Get the room from the form
    $assignedBy955 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName955 = $status955 === 'Need Repair' ? '' : $assignedName955;

    // Prepare SQL query to update the asset
    $sql955 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt955 = $conn->prepare($sql955);
    $stmt955->bind_param('sssssi', $status955, $assignedName955, $assignedBy955, $description955, $room955, $assetId955);

    if ($stmt955->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId955 to $status955.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 956
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit956'])) {
    // Get form data
    $assetId956 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status956 = $_POST['status']; // Get the status from the form
    $description956 = $_POST['description']; // Get the description from the form
    $room956 = $_POST['room']; // Get the room from the form
    $assignedBy956 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName956 = $status956 === 'Need Repair' ? '' : $assignedName956;

    // Prepare SQL query to update the asset
    $sql956 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt956 = $conn->prepare($sql956);
    $stmt956->bind_param('sssssi', $status956, $assignedName956, $assignedBy956, $description956, $room956, $assetId956);

    if ($stmt956->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId956 to $status956.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 957
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit957'])) {
    // Get form data
    $assetId957 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status957 = $_POST['status']; // Get the status from the form
    $description957 = $_POST['description']; // Get the description from the form
    $room957 = $_POST['room']; // Get the room from the form
    $assignedBy957 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName957 = $status957 === 'Need Repair' ? '' : $assignedName957;

    // Prepare SQL query to update the asset
    $sql957 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt957 = $conn->prepare($sql957);
    $stmt957->bind_param('sssssi', $status957, $assignedName957, $assignedBy957, $description957, $room957, $assetId957);

    if ($stmt957->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId957 to $status957.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 958
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit958'])) {
    // Get form data
    $assetId958 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status958 = $_POST['status']; // Get the status from the form
    $description958 = $_POST['description']; // Get the description from the form
    $room958 = $_POST['room']; // Get the room from the form
    $assignedBy958 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName958 = $status958 === 'Need Repair' ? '' : $assignedName958;

    // Prepare SQL query to update the asset
    $sql958 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt958 = $conn->prepare($sql958);
    $stmt958->bind_param('sssssi', $status958, $assignedName958, $assignedBy958, $description958, $room958, $assetId958);

    if ($stmt958->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId958 to $status958.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 959
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit959'])) {
    // Get form data
    $assetId959 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status959 = $_POST['status']; // Get the status from the form
    $description959 = $_POST['description']; // Get the description from the form
    $room959 = $_POST['room']; // Get the room from the form
    $assignedBy959 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName959 = $status959 === 'Need Repair' ? '' : $assignedName959;

    // Prepare SQL query to update the asset
    $sql959 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt959 = $conn->prepare($sql959);
    $stmt959->bind_param('sssssi', $status959, $assignedName959, $assignedBy959, $description959, $room959, $assetId959);

    if ($stmt959->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId959 to $status959.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 960
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit960'])) {
    // Get form data
    $assetId960 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status960 = $_POST['status']; // Get the status from the form
    $description960 = $_POST['description']; // Get the description from the form
    $room960 = $_POST['room']; // Get the room from the form
    $assignedBy960 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName960 = $status960 === 'Need Repair' ? '' : $assignedName960;

    // Prepare SQL query to update the asset
    $sql960 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt960 = $conn->prepare($sql960);
    $stmt960->bind_param('sssssi', $status960, $assignedName960, $assignedBy960, $description960, $room960, $assetId960);

    if ($stmt960->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId960 to $status960.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 961
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit961'])) {
    // Get form data
    $assetId961 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status961 = $_POST['status']; // Get the status from the form
    $description961 = $_POST['description']; // Get the description from the form
    $room961 = $_POST['room']; // Get the room from the form
    $assignedBy961 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName961 = $status961 === 'Need Repair' ? '' : $assignedName961;

    // Prepare SQL query to update the asset
    $sql961 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt961 = $conn->prepare($sql961);
    $stmt961->bind_param('sssssi', $status961, $assignedName961, $assignedBy961, $description961, $room961, $assetId961);

    if ($stmt961->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId961 to $status961.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 962
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit962'])) {
    // Get form data
    $assetId962 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status962 = $_POST['status']; // Get the status from the form
    $description962 = $_POST['description']; // Get the description from the form
    $room962 = $_POST['room']; // Get the room from the form
    $assignedBy962 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName962 = $status962 === 'Need Repair' ? '' : $assignedName962;

    // Prepare SQL query to update the asset
    $sql962 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt962 = $conn->prepare($sql962);
    $stmt962->bind_param('sssssi', $status962, $assignedName962, $assignedBy962, $description962, $room962, $assetId962);

    if ($stmt962->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId962 to $status962.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 963
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit963'])) {
    // Get form data
    $assetId963 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status963 = $_POST['status']; // Get the status from the form
    $description963 = $_POST['description']; // Get the description from the form
    $room963 = $_POST['room']; // Get the room from the form
    $assignedBy963 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName963 = $status963 === 'Need Repair' ? '' : $assignedName963;

    // Prepare SQL query to update the asset
    $sql963 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt963 = $conn->prepare($sql963);
    $stmt963->bind_param('sssssi', $status963, $assignedName963, $assignedBy963, $description963, $room963, $assetId963);

    if ($stmt963->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId963 to $status963.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
...
//FOR ID 964
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit964'])) {
    // Get form data
    $assetId964 = $_POST['assetId']; // Assuming assetId is passed as a hidden input in your form
    $status964 = $_POST['status']; // Get the status from the form
    $description964 = $_POST['description']; // Get the description from the form
    $room964 = $_POST['room']; // Get the room from the form
    $assignedBy964 = $_POST['assignedBy'];
    // Check if status is "Need Repair" and set "Assigned Name" to none
    $assignedName964 = $status964 === 'Need Repair' ? '' : $assignedName964;

    // Prepare SQL query to update the asset
    $sql964 = "UPDATE asset SET status = ?, assignedName = ?, assignedBy = ?, description = ?, room = ?, date = NOW() WHERE assetId = ?";
    $stmt964 = $conn->prepare($sql964);
    $stmt964->bind_param('sssssi', $status964, $assignedName964, $assignedBy964, $description964, $room964, $assetId964);

    if ($stmt964->execute()) {
        // Update success
        logActivity($conn, $_SESSION['accountId'], "Changed status of asset ID $assetId964 to $status964.", 'Report');
        echo "<script>alert('Asset updated successfully!');</script>";
        header("Location: TEBF1.php");
    } else {
        // Update failed
            ...
            <main>
                <div class="content-container" id="content-container">
                    <div id="belmonte-F1" class="content">
                       ...
                       <!-- ASSET 910 -->
<img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId; ?>" style="width:15px; cursor:pointer; position:absolute; top:60px; left:590px;" alt="Asset Image 910" data-bs-toggle="modal" data-bs-target="#imageModal910" onclick="fetchAssetData(910);" data-room="<?php echo htmlspecialchars($room); ?>" data-floor="<?php echo htmlspecialchars($floor910); ?>" data-image="<?php echo base64_encode($upload_img); ?>" data-category="<?php echo htmlspecialchars($category); ?>" data-status="<?php echo htmlspecialchars($status); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status); ?>; position:absolute; top:60px; left:600px;'>
                        </div>

                        <!-- ASSET 911 -->
                        <img src="../image.php?id=911" class="asset-image" data-id="<?php echo $assetId2; ?>" style="width:15px; cursor:pointer; position:absolute; top:85px; left:590px;" alt="Asset Image 2" data-bs-toggle="modal" data-bs-target="#imageModal2" onclick="fetchAssetData(2);" data-room="<?php echo htmlspecialchars($room2); ?>" data-floor="<?php echo htmlspecialchars($floor2); ?>" data-image="<?php echo base64_encode($upload_img2); ?>" data-category="<?php echo htmlspecialchars($category2); ?>" data-status="<?php echo htmlspecialchars($status2); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName2); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status2); ?>; position:absolute; top:85px; left:600px;'>
                        </div>

                        <!-- ASSET 912 -->
                        <img src="../image.php?id=912" class="asset-image" data-id="<?php echo $assetId3; ?>" style="width:15px; cursor:pointer; position:absolute; top:80px; left:700px;" alt="Asset Image 3" data-bs-toggle="modal" data-bs-target="#imageModal3" onclick="fetchAssetData(3);" data-room="<?php echo htmlspecialchars($room3); ?>" data-floor="<?php echo htmlspecialchars($floor3); ?>" data-image="<?php echo base64_encode($upload_img3); ?>" data-status="<?php echo htmlspecialchars($status3); ?>" data-category="<?php echo htmlspecialchars($category3); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName3); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status3); ?>; position:absolute; top:80px; left:710px;'>
                        </div>

                        <!-- ASSET 913 -->
                        <img src="../image.php?id=913" class="asset-image" data-id="<?php echo $assetId4; ?>" style="width:15px; cursor:pointer; position:absolute; top:60px; left:785px;" alt="Asset Image 4" data-bs-toggle="modal" data-bs-target="#imageModal4" onclick="fetchAssetData(4);" data-room="<?php echo htmlspecialchars($room4); ?>" data-floor="<?php echo htmlspecialchars($floor4); ?>" data-image="<?php echo base64_encode($upload_img4); ?>" data-category="<?php echo htmlspecialchars($category4); ?>" data-status="<?php echo htmlspecialchars($status4); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName4); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status4); ?>; position:absolute; top:60px; left:795px;'>
                        </div>


                        <!-- ASSET 914 -->
                        <img src="../image.php?id=914" class="asset-image" data-id="<?php echo $assetId5; ?>" style="width:15px; cursor:pointer; position:absolute; top:105px; left:785px;" alt="Asset Image 5" data-bs-toggle="modal" data-bs-target="#imageModal5" onclick="fetchAssetData(5);" data-room="<?php echo htmlspecialchars($room5); ?>" data-floor="<?php echo htmlspecialchars($floor5); ?>" data-image="<?php echo base64_encode($upload_img5); ?>" data-category="<?php echo htmlspecialchars($category5); ?>" data-status="<?php echo htmlspecialchars($status5); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName5); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status5); ?>; position:absolute; top:105px; left:795px;'>
                        </div>

                        <!-- ASSET 915 -->
                        <img src="../image.php?id=915" class="asset-image" data-id="<?php echo $assetId6; ?>" style="width:15px; cursor:pointer; position:absolute; top:130px; left:625px;" alt="Asset Image 6" data-bs-toggle="modal" data-bs-target="#imageModal6" onclick="fetchAssetData(6);" data-room="<?php echo htmlspecialchars($room6); ?>" data-floor="<?php echo htmlspecialchars($floor6); ?>" data-image="<?php echo base64_encode($upload_img6); ?>" data-category="<?php echo htmlspecialchars($category6); ?>" data-status="<?php echo htmlspecialchars($status6); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName6); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status6); ?>; position:absolute; top:130px; left:635px;'>
                        </div>

                        <!-- ASSET 916 -->
                        <img src="../image.php?id=916" class="asset-image" data-id="<?php echo $assetId7; ?>" style="width:15px; cursor:pointer; position:absolute; top:130px; left:742px;" alt="Asset Image 7" data-bs-toggle="modal" data-bs-target="#imageModal7" onclick="fetchAssetData(7);" data-room="<?php echo htmlspecialchars($room7); ?>" data-floor="<?php echo htmlspecialchars($floor7); ?>" data-image="<?php echo base64_encode($upload_img7); ?>" data-category="<?php echo htmlspecialchars($category7); ?>" data-status="<?php echo htmlspecialchars($status7); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName7); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status7); ?>; position:absolute; top:130px; left:752px;'>
                        </div>

                        <!-- ASSET 917 -->
                        <img src="../image.php?id=917" class="asset-image" data-id="<?php echo $assetId8; ?>" style="width:35px; cursor:pointer; position:absolute; top:70px; left:630px;" alt="Asset Image 8" data-bs-toggle="modal" data-bs-target="#imageModal8" onclick="fetchAssetData(8);" data-room="<?php echo htmlspecialchars($room8); ?>" data-floor="<?php echo htmlspecialchars($floor8); ?>" data-image="<?php echo base64_encode($upload_img8); ?>" data-status="<?php echo htmlspecialchars($status8); ?>" data-category="<?php echo htmlspecialchars($category8); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName8); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status8); ?>; position:absolute; top:73px; left:652px;'>
                        </div>


                        <!-- ASSET 918 -->
                        <img src="../image.php?id=918" class="asset-image" data-id="<?php echo $assetId9; ?>" style="width:35px; cursor:pointer; position:absolute; top:70px; left:750px;" alt="Asset Image 9" data-bs-toggle="modal" data-bs-target="#imageModal9" onclick="fetchAssetData(9);" data-room="<?php echo htmlspecialchars($room9); ?>" data-floor="<?php echo htmlspecialchars($floor9); ?>" data-image="<?php echo base64_encode($upload_img9); ?>" data-category="<?php echo htmlspecialchars($category9); ?>" data-status="<?php echo htmlspecialchars($status9); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName9); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status9); ?>; position:absolute; top:73px; left:772px;'>
                        </div>

                        <!-- ASSET 919 -->
                        <img src="../image.php?id=919" class="asset-image" data-id="<?php echo $assetId10; ?>" style="width:35px; cursor:pointer; position:absolute; top:120px; left:690px;" alt="Asset Image 10" data-bs-toggle="modal" data-bs-target="#imageModal10" onclick="fetchAssetData(10);" data-room="<?php echo htmlspecialchars($room10); ?>" data-floor="<?php echo htmlspecialchars($floor10); ?>" data-image="<?php echo base64_encode($upload_img10); ?>" data-category="<?php echo htmlspecialchars($category10); ?>" data-status="<?php echo htmlspecialchars($status10); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName10); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status10); ?>; position:absolute; top:123px; left:712px;'>
                        </div>

                        <!-- ASSET 903 -->
                        <img src="../image.php?id=903" class="asset-image" data-id="<?php echo $assetId11; ?>" style="width:15px; cursor:pointer; position:absolute; top:55px; left:840px;" alt="Asset Image 11" data-bs-toggle="modal" data-bs-target="#imageModal11" onclick="fetchAssetData(11);" data-room="<?php echo htmlspecialchars($room11); ?>" data-floor="<?php echo htmlspecialchars($floor11); ?>" data-image="<?php echo base64_encode($upload_img11); ?>" data-category="<?php echo htmlspecialchars($category11); ?>" data-status="<?php echo htmlspecialchars($status11); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName11); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status11); ?>; position:absolute; top:55px; left:850px;'> </div>

                        <!-- ASSET 904 -->
                        <img src="../image.php?id=904" class="asset-image" data-id="<?php echo $assetId12; ?>" style="width:15px; cursor:pointer; position:absolute; top:55px; left:1060px;" alt="Asset Image 904" data-bs-toggle="modal" data-bs-target="#imageModal904" onclick="fetchAssetData(904);" data-room="<?php echo htmlspecialchars($room12); ?>" data-floor="<?php echo htmlspecialchars($floor12); ?>" data-image="<?php echo base64_encode($upload_img12); ?>" data-category="<?php echo htmlspecialchars($category12); ?>" data-status="<?php echo htmlspecialchars($status12); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName12); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status12); ?>; position:absolute; top:55px; left:1070px;'>
                        </div>


                        <!-- ASSET 905 -->
                        <img src="../image.php?id=905" class="asset-image" data-id="<?php echo $assetId6866; ?>" style="width:15px; cursor:pointer; position:absolute; top:95px; left:900px;" alt="Asset Image 905" data-bs-toggle="modal" data-bs-target="#imageModal905" onclick="fetchAssetData(905);" data-room="<?php echo htmlspecialchars($room6866); ?>" data-floor="<?php echo htmlspecialchars($floor6866); ?>" data-image="<?php echo base64_encode($upload_img6866); ?>" data-category="<?php echo htmlspecialchars($category6866); ?>" data-status="<?php echo htmlspecialchars($status6866); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName6866); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status6866); ?>; position:absolute; top:95px; left:910px;'>
                        </div>

                        <!-- ASSET 906 -->
                        <img src="../image.php?id=906" class="asset-image" data-id="<?php echo $assetId906; ?>" style="width:15px; cursor:pointer; position:absolute; top:95px; left:1000px;" alt="Asset Image 906" data-bs-toggle="modal" data-bs-target="#imageModal906" onclick="fetchAssetData(906);" data-room="<?php echo htmlspecialchars($room906); ?>" data-floor="<?php echo htmlspecialchars($floor906); ?>" data-image="<?php echo base64_encode($upload_img906); ?>" data-category="<?php echo htmlspecialchars($category906); ?>" data-status="<?php echo htmlspecialchars($status906); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName906); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status906); ?>; position:absolute; top:95px; left:1010px;'>
                        </div>

                        <!-- ASSET 907 -->
                        <img src="../image.php?id=907" class="asset-image" data-id="<?php echo $assetId907; ?>" style="width:15px; cursor:pointer; position:absolute; top:135px; left:840px;" alt="Asset Image 907" data-bs-toggle="modal" data-bs-target="#imageModal907" onclick="fetchAssetData(907);" data-room="<?php echo htmlspecialchars($room907); ?>" data-floor="<?php echo htmlspecialchars($floor907); ?>" data-image="<?php echo base64_encode($upload_img907); ?>" data-category="<?php echo htmlspecialchars($category907); ?>" data-status="<?php echo htmlspecialchars($status907); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName907); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status907); ?>; position:absolute; top:135px; left:850px;'>
                        </div>

                        <!-- ASSET 908 -->
                        <img src="../image.php?id=908" class="asset-image" data-id="<?php echo $assetId908; ?>" style="width:15px; cursor:pointer; position:absolute; top:135px; left:949px;" alt="Asset Image 908" data-bs-toggle="modal" data-bs-target="#imageModal908" onclick="fetchAssetData(908);" data-room="<?php echo htmlspecialchars($room908); ?>" data-floor="<?php echo htmlspecialchars($floor908); ?>" data-image="<?php echo base64_encode($upload_img908); ?>" data-category="<?php echo htmlspecialchars($category908); ?>" data-status="<?php echo htmlspecialchars($status908); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName908); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status908); ?>; position:absolute; top:135px; left:959px;'>
                        </div>
                        ...
                        <!-- ASSET 909 -->
                        <img src="../image.php?id=909" class="asset-image" data-id="<?php echo $assetId909; ?>" style="width:15px; cursor:pointer; position:absolute; top:135px; left:1060px;" alt="Asset Image 909" data-bs-toggle="modal" data-bs-target="#imageModal909" onclick="fetchAssetData(909);" data-room="<?php echo htmlspecialchars($room909); ?>" data-floor="<?php echo htmlspecialchars($floor909); ?>" data-image="<?php echo base64_encode($upload_img909); ?>" data-category="<?php echo htmlspecialchars($category909); ?>" data-status="<?php echo htmlspecialchars($status909); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName909); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status909); ?>; position:absolute; top:135px; left:1070px;'>
                        </div>

                        <!-- ASSET 920 -->
                        <img src="../image.php?id=920" class="asset-image" data-id="<?php echo $assetId920; ?>" style="width:35px; cursor:pointer; position:absolute; top:70px; left:376px;" alt="Asset Image 920" data-bs-toggle="modal" data-bs-target="#imageModal920" onclick="fetchAssetData(920);" data-room="<?php echo htmlspecialchars($room920); ?>" data-floor="<?php echo htmlspecialchars($floor920); ?>" data-image="<?php echo base64_encode($upload_img920); ?>" data-category="<?php echo htmlspecialchars($category920); ?>" data-status="<?php echo htmlspecialchars($status920); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName920); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status920); ?>; position:absolute; top:70px; left:398px;'>
                        </div>

                        <!-- ASSET 921 -->
                        <img src="../image.php?id=921" class="asset-image" data-id="<?php echo $assetId921; ?>" style="width:35px; cursor:pointer; position:absolute; top:120px; left:475px;" alt="Asset Image 921" data-bs-toggle="modal" data-bs-target="#imageModal921" onclick="fetchAssetData(921);" data-room="<?php echo htmlspecialchars($room921); ?>" data-floor="<?php echo htmlspecialchars($floor921); ?>" data-image="<?php echo base64_encode($upload_img921); ?>" data-category="<?php echo htmlspecialchars($category921); ?>" data-status="<?php echo htmlspecialchars($status921); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName921); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status921); ?>; position:absolute; top:120px; left:497px;'>
                        </div>

                        <!-- ASSET 922 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId922; ?>" style="width:15px; cursor:pointer; position:absolute; top:63px; left:340px;" alt="Asset Image 922" data-bs-toggle="modal" data-bs-target="#imageModal922" onclick="fetchAssetData(922);" data-room="<?php echo htmlspecialchars($room922); ?>" data-floor="<?php echo htmlspecialchars($floor922); ?>" data-image="<?php echo base64_encode($upload_img922); ?>" data-category="<?php echo htmlspecialchars($category922); ?>" data-status="<?php echo htmlspecialchars($status922); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName922); ?>">
    ...
    position:absolute; top:63px; left:350px;'>
                        ...
                        <!-- ASSET 923 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId923; ?>" style="width:15px; cursor:pointer; position:absolute; top:63px; left:420px;" alt="Asset Image 923" data-bs-toggle="modal" data-bs-target="#imageModal923" onclick="fetchAssetData(923);" data-room="<?php echo htmlspecialchars($room923); ?>" data-floor="<?php echo htmlspecialchars($floor923); ?>" data-image="<?php echo base64_encode($upload_img923); ?>" data-category="<?php echo htmlspecialchars($category923); ?>" data-status="<?php echo htmlspecialchars($status923); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName923); ?>">
    ...
    position:absolute; top:63px; left:430px;'>
                        ...
                        <!-- ASSET 924 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId924; ?>" style="width:15px; cursor:pointer; position:absolute; top:100px; left:340px;" alt="Asset Image 924" data-bs-toggle="modal" data-bs-target="#imageModal924" onclick="fetchAssetData(924);" data-room="<?php echo htmlspecialchars($room924); ?>" data-floor="<?php echo htmlspecialchars($floor924); ?>" data-image="<?php echo base64_encode($upload_img924); ?>" data-category="<?php echo htmlspecialchars($category924); ?>" data-status="<?php echo htmlspecialchars($status924); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName924); ?>">
    ...
    position:absolute; top:100px; left:350px;'>
                        ...
                        <!-- ASSET 925 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId925; ?>" style="width:15px; cursor:pointer; position:absolute; top:100px; left:420px;" alt="Asset Image 925" data-bs-toggle="modal" data-bs-target="#imageModal925" onclick="fetchAssetData(925);" data-room="<?php echo htmlspecialchars($room925); ?>" data-floor="<?php echo htmlspecialchars($floor925); ?>" data-image="<?php echo base64_encode($upload_img925); ?>" data-category="<?php echo htmlspecialchars($category925); ?>" data-status="<?php echo htmlspecialchars($status925); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName925); ?>">
    ...
    position:absolute; top:100px; left:430px;'>
                        ...
                        <!-- ASSET 926 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId926; ?>" style="width:15px; cursor:pointer; position:absolute; top:63px; left:460px;" alt="Asset Image 926" data-bs-toggle="modal" data-bs-target="#imageModal926" onclick="fetchAssetData(926);" data-room="<?php echo htmlspecialchars($room926); ?>" data-floor="<?php echo htmlspecialchars($floor926); ?>" data-image="<?php echo base64_encode($upload_img926); ?>" data-category="<?php echo htmlspecialchars($category926); ?>" data-status="<?php echo htmlspecialchars($status926); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName926); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status926); ?>; position:absolute; top:63px; left:470px;'>
                        </div>

                        <!-- ASSET 927 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId927; ?>" style="width:15px; cursor:pointer; position:absolute; top:63px; left:545px;" alt="Asset Image 927" data-bs-toggle="modal" data-bs-target="#imageModal927" onclick="fetchAssetData(927);" data-room="<?php echo htmlspecialchars($room927); ?>" data-floor="<?php echo htmlspecialchars($floor927); ?>" data-image="<?php echo base64_encode($upload_img927); ?>" data-category="<?php echo htmlspecialchars($category927); ?>" data-status="<?php echo htmlspecialchars($status927); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName927); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status927); ?>; position:absolute; top:63px; left:555px;'>
                        </div>

                        <!-- ASSET 928 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId928; ?>" style="width:15px; cursor:pointer; position:absolute; top:107px; left:504px;" alt="Asset Image 928" data-bs-toggle="modal" data-bs-target="#imageModal928" onclick="fetchAssetData(928);" data-room="<?php echo htmlspecialchars($room928); ?>" data-floor="<?php echo htmlspecialchars($floor928); ?>" data-image="<?php echo base64_encode($upload_img928); ?>" data-category="<?php echo htmlspecialchars($category928); ?>" data-status="<?php echo htmlspecialchars($status928); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName928); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status928); ?>; position:absolute; top:107px; left:514px;'>
                        </div>

                        <!-- ASSET 929 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId929; ?>" style="width:15px; cursor:pointer; position:absolute; top:139px; left:504px;" alt="Asset Image 929" data-bs-toggle="modal" data-bs-target="#imageModal929" onclick="fetchAssetData(929);" data-room="<?php echo htmlspecialchars($room929); ?>" data-floor="<?php echo htmlspecialchars($floor929); ?>" data-image="<?php echo base64_encode($upload_img929); ?>" data-category="<?php echo htmlspecialchars($category929); ?>" data-status="<?php echo htmlspecialchars($status929); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName929); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status929); ?>; position:absolute; top:139px; left:514px;'>
                        </div>



                        <!-- ASSET 930 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId930; ?>" style="width:15px; cursor:pointer; position:absolute; top:63px; left:200px;" alt="Asset Image 930" data-bs-toggle="modal" data-bs-target="#imageModal930" onclick="fetchAssetData(930);" data-room="<?php echo htmlspecialchars($room930); ?>" data-floor="<?php echo htmlspecialchars($floor930); ?>" data-image="<?php echo base64_encode($upload_img930); ?>" data-category="<?php echo htmlspecialchars($category930); ?>" data-status="<?php echo htmlspecialchars($status930); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName930); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status930); ?>; position:absolute; top:63px; left:210px;'>
                        </div>

                        <!-- ASSET 931 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId931; ?>" style="width:15px; cursor:pointer; position:absolute; top:63px; left:250px;" alt="Asset Image 931" data-bs-toggle="modal" data-bs-target="#imageModal931" onclick="fetchAssetData(931);" data-room="<?php echo htmlspecialchars($room931); ?>" data-floor="<?php echo htmlspecialchars($floor931); ?>" data-image="<?php echo base64_encode($upload_img931); ?>" data-category="<?php echo htmlspecialchars($category931); ?>" data-status="<?php echo htmlspecialchars($status931); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName931); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status931); ?>; position:absolute; top:63px; left:260px;'>
                        </div>

                        <!-- ASSET 932 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId932; ?>" style="width:15px; cursor:pointer; position:absolute; top:63px; left:298px;" alt="Asset Image 932" data-bs-toggle="modal" data-bs-target="#imageModal932" onclick="fetchAssetData(932);" data-room="<?php echo htmlspecialchars($room932); ?>" data-floor="<?php echo htmlspecialchars($floor932); ?>" data-image="<?php echo base64_encode($upload_img932); ?>" data-category="<?php echo htmlspecialchars($category932); ?>" data-status="<?php echo htmlspecialchars($status932); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName932); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status932); ?>; position:absolute; top:63px; left:308px;'>
                        </div>

                        <!-- ASSET 933 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId933; ?>" style="width:15px; cursor:pointer; position:absolute; top:105px; left:200px;" alt="Asset Image 933" data-bs-toggle="modal" data-bs-target="#imageModal933" onclick="fetchAssetData(933);" data-room="<?php echo htmlspecialchars($room933); ?>" data-floor="<?php echo htmlspecialchars($floor933); ?>" data-image="<?php echo base64_encode($upload_img933); ?>" data-category="<?php echo htmlspecialchars($category933); ?>" data-status="<?php echo htmlspecialchars($status933); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName933); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status933); ?>; position:absolute; top:105px; left:210px;'>
                        </div>



                        <!-- ASSET 934 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId934; ?>" style="width:15px; cursor:pointer; position:absolute; top:105px; left:250px;" alt="Asset Image 934" data-bs-toggle="modal" data-bs-target="#imageModal934" onclick="fetchAssetData(934);" data-room="<?php echo htmlspecialchars($room934); ?>" data-floor="<?php echo htmlspecialchars($floor934); ?>" data-image="<?php echo base64_encode($upload_img934); ?>" data-category="<?php echo htmlspecialchars($category934); ?>" data-status="<?php echo htmlspecialchars($status934); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName934); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status934); ?>; position:absolute; top:105px; left:260px;'>
                        </div>

                        <!-- ASSET 935 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId935; ?>" style="width:15px; cursor:pointer; position:absolute; top:105px; left:298px;" alt="Asset Image 935" data-bs-toggle="modal" data-bs-target="#imageModal935" onclick="fetchAssetData(935);" data-room="<?php echo htmlspecialchars($room935); ?>" data-floor="<?php echo htmlspecialchars($floor935); ?>" data-image="<?php echo base64_encode($upload_img935); ?>" data-status="<?php echo htmlspecialchars($status935); ?>" data-category="<?php echo htmlspecialchars($category935); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName935); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status935); ?>; position:absolute; top:105px; left:308px;'>
                        </div>

                        <!-- ASSET 936 -->
                        <img src="../image.php?id=936" class="asset-image" data-id="<?php echo $assetId936; ?>" style="width:30px; cursor:pointer; position:absolute; top:78px; left:243px;" alt="Asset Image 936" data-bs-toggle="modal" data-bs-target="#imageModal936" onclick="fetchAssetData(936);" data-room="<?php echo htmlspecialchars($room936); ?>" data-floor="<?php echo htmlspecialchars($floor936); ?>" data-image="<?php echo base64_encode($upload_img936); ?>" data-category="<?php echo htmlspecialchars($category936); ?>" data-status="<?php echo htmlspecialchars($status936); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName936); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status936); ?>; position:absolute; top:78px; left:265px;'>
                        </div>

                        <!-- ASSET 937 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId937; ?>" style="width:15px; cursor:pointer; position:absolute; top:132px; left:298px;" alt="Asset Image 937" data-bs-toggle="modal" data-bs-target="#imageModal937" onclick="fetchAssetData(937);" data-room="<?php echo htmlspecialchars($room937); ?>" data-floor="<?php echo htmlspecialchars($floor937); ?>" data-image="<?php echo base64_encode($upload_img937); ?>" data-category="<?php echo htmlspecialchars($category937); ?>" data-status="<?php echo htmlspecialchars($status937); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName937); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status937); ?>; position:absolute; top:132px; left:308px;'>
                        </div>

                        <!-- ASSET 938 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId938; ?>" style="width:15px; cursor:pointer; position:absolute; top:132px; left:235px;" alt="Asset Image 938" data-bs-toggle="modal" data-bs-target="#imageModal938" onclick="fetchAssetData(938);" data-room="<?php echo htmlspecialchars($room938); ?>" data-floor="<?php echo htmlspecialchars($floor938); ?>" data-image="<?php echo base64_encode($upload_img938); ?>" data-status="<?php echo htmlspecialchars($status938); ?>" data-category="<?php echo htmlspecialchars($category938); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName938); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status938); ?>; position:absolute; top:132px; left:245px;'>
                        </div>

                        <!-- ASSET 939 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId939; ?>" style="width:15px; cursor:pointer; position:absolute; top:132px; left:175px;" alt="Asset Image 939" data-bs-toggle="modal" data-bs-target="#imageModal939" onclick="fetchAssetData(939);" data-room="<?php echo htmlspecialchars($room939); ?>" data-floor="<?php echo htmlspecialchars($floor939); ?>" data-image="<?php echo base64_encode($upload_img939); ?>" data-category="<?php echo htmlspecialchars($category939); ?>" data-status="<?php echo htmlspecialchars($status939); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName939); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status939); ?>; position:absolute; top:132px; left:185px;'>
                        </div>

                        <!-- ASSET 940 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId940; ?>" style="width:15px; cursor:pointer; position:absolute; top:120px; left:106px;" alt="Asset Image 940" data-bs-toggle="modal" data-bs-target="#imageModal940" onclick="fetchAssetData(940);" data-room="<?php echo htmlspecialchars($room940); ?>" data-floor="<?php echo htmlspecialchars($floor940); ?>" data-image="<?php echo base64_encode($upload_img940); ?>" data-category="<?php echo htmlspecialchars($category940); ?>" data-status="<?php echo htmlspecialchars($status940); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName940); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status940); ?>; position:absolute; top:120px; left:116px;'>
                        </div>

                        <!-- ASSET 941 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId941; ?>" style="width:15px; cursor:pointer; position:absolute; top:165px; left:106px;" alt="Asset Image 941" data-bs-toggle="modal" data-bs-target="#imageModal941" onclick="fetchAssetData(941);" data-room="<?php echo htmlspecialchars($room941); ?>" data-floor="<?php echo htmlspecialchars($floor941); ?>" data-image="<?php echo base64_encode($upload_img941); ?>" data-category="<?php echo htmlspecialchars($category941); ?>" data-status="<?php echo htmlspecialchars($status941); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName941); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status941); ?>; position:absolute; top:165px; left:116px;'>
                        </div>


                        <!-- ASSET 942 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId942; ?>" style="width:15px; cursor:pointer; position:absolute; top:215px; left:106px;" alt="Asset Image 942" data-bs-toggle="modal" data-bs-target="#imageModal942" onclick="fetchAssetData(942);" data-room="<?php echo htmlspecialchars($room942); ?>" data-floor="<?php echo htmlspecialchars($floor942); ?>" data-image="<?php echo base64_encode($upload_img942); ?>" data-category="<?php echo htmlspecialchars($category942); ?>" data-status="<?php echo htmlspecialchars($status942); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName942); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status942); ?>; position:absolute; top:215px; left:116px;'>
                        </div>

                        <!-- ASSET 943 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId943; ?>" style="width:15px; cursor:pointer; position:absolute; top:255px; left:133px;" alt="Asset Image 943" data-bs-toggle="modal" data-bs-target="#imageModal943" onclick="fetchAssetData(943);" data-room="<?php echo htmlspecialchars($room943); ?>" data-floor="<?php echo htmlspecialchars($floor943); ?>" data-image="<?php echo base64_encode($upload_img943); ?>" data-category="<?php echo htmlspecialchars($category943); ?>" data-status="<?php echo htmlspecialchars($status943); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName943); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status943); ?>; position:absolute; top:255px; left:143px;'>
                        </div>

                        <!-- ASSET 944 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId944; ?>" style="width:15px; cursor:pointer; position:absolute; top:290px; left:133px;" alt="Asset Image 944" data-bs-toggle="modal" data-bs-target="#imageModal944" onclick="fetchAssetData(944);" data-room="<?php echo htmlspecialchars($room944); ?>" data-floor="<?php echo htmlspecialchars($floor944); ?>" data-image="<?php echo base64_encode($upload_img944); ?>" data-category="<?php echo htmlspecialchars($category944); ?>" data-status="<?php echo htmlspecialchars($status944); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName944); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status944); ?>; position:absolute; top:290px; left:143px;'>
                        </div>

                        <!-- ASSET 945 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId945; ?>" style="width:15px; cursor:pointer; position:absolute; top:322px; left:133px;" alt="Asset Image 945" data-bs-toggle="modal" data-bs-target="#imageModal945" onclick="fetchAssetData(945);" data-room="<?php echo htmlspecialchars($room945); ?>" data-floor="<?php echo htmlspecialchars($floor945); ?>" data-image="<?php echo base64_encode($upload_img945); ?>" data-category="<?php echo htmlspecialchars($category945); ?>" data-status="<?php echo htmlspecialchars($status945); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName945); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status945); ?>; position:absolute; top:322px; left:143px;'>
                        </div>

                        <!-- ASSET 946 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId946; ?>" style="width:15px; cursor:pointer; position:absolute; top:365px; left:110px;" alt="Asset Image 946" data-bs-toggle="modal" data-bs-target="#imageModal946" onclick="fetchAssetData(946);" data-room="<?php echo htmlspecialchars($room946); ?>" data-floor="<?php echo htmlspecialchars($floor946); ?>" data-image="<?php echo base64_encode($upload_img946); ?>" data-category="<?php echo htmlspecialchars($category946); ?>" data-status="<?php echo htmlspecialchars($status946); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName946); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status946); ?>; position:absolute; top:365px; left:120px;'>
                        </div>

                        <!-- ASSET 947 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId947; ?>" style="width:15px; cursor:pointer; position:absolute; top:415px; left:110px;" alt="Asset Image 947" data-bs-toggle="modal" data-bs-target="#imageModal947" onclick="fetchAssetData(947);" data-room="<?php echo htmlspecialchars($room947); ?>" data-floor="<?php echo htmlspecialchars($floor947); ?>" data-image="<?php echo base64_encode($upload_img947); ?>" data-category="<?php echo htmlspecialchars($category947); ?>" data-status="<?php echo htmlspecialchars($status947); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName947); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status947); ?>; position:absolute; top:415px; left:120px;'>
                        </div>

                        <!-- ASSET 948 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId948; ?>" style="width:15px; cursor:pointer; position:absolute; top:465px; left:110px;" alt="Asset Image 948" data-bs-toggle="modal" data-bs-target="#imageModal948" onclick="fetchAssetData(948);" data-room="<?php echo htmlspecialchars($room948); ?>" data-floor="<?php echo htmlspecialchars($floor948); ?>" data-image="<?php echo base64_encode($upload_img948); ?>" data-category="<?php echo htmlspecialchars($category948); ?>" data-status="<?php echo htmlspecialchars($status948); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName948); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status948); ?>; position:absolute; top:465px; left:120px;'>
                        </div>

                        <!-- ASSET 949 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId949; ?>" style="width:15px; cursor:pointer; position:absolute; top:165px; left:185px;" alt="Asset Image 949" data-bs-toggle="modal" data-bs-target="#imageModal949" onclick="fetchAssetData(949);" data-room="<?php echo htmlspecialchars($room949); ?>" data-floor="<?php echo htmlspecialchars($floor949); ?>" data-image="<?php echo base64_encode($upload_img949); ?>" data-category="<?php echo htmlspecialchars($category949); ?>" data-status="<?php echo htmlspecialchars($status949); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName949); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status949); ?>; position:absolute; top:165px; left:195px;'>
                        </div>



                        <!-- ASSET 950 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId950; ?>" style="width:15px; cursor:pointer; position:absolute; top:165px; left:295px;" alt="Asset Image 950" data-bs-toggle="modal" data-bs-target="#imageModal950" onclick="fetchAssetData(950);" data-room="<?php echo htmlspecialchars($room950); ?>" data-floor="<?php echo htmlspecialchars($floor950); ?>" data-image="<?php echo base64_encode($upload_img950); ?>" data-category="<?php echo htmlspecialchars($category950); ?>" data-status="<?php echo htmlspecialchars($status950); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName950); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status950); ?>; position:absolute; top:165px; left:305px;'>
                        </div>

                        <!-- ASSET 951 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId951; ?>" style="width:15px; cursor:pointer; position:absolute; top:240px; left:185px;" alt="Asset Image 951" data-bs-toggle="modal" data-bs-target="#imageModal951" onclick="fetchAssetData(951);" data-room="<?php echo htmlspecialchars($room951); ?>" data-floor="<?php echo htmlspecialchars($floor951); ?>" data-image="<?php echo base64_encode($upload_img951); ?>" data-category="<?php echo htmlspecialchars($category951); ?>" data-status="<?php echo htmlspecialchars($status951); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName951); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status951); ?>; position:absolute; top:240px; left:195px;'>
                        </div>

                        <!-- ASSET 952 -->
                        <img src="../image.php?id=910" class="asset-image" data-id="<?php echo $assetId952; ?>" style="width:15px; cursor:pointer; position:absolute; top:240px; left:295px;" alt="Asset Image 952" data-bs-toggle="modal" data-bs-target="#imageModal952" onclick="fetchAssetData(952);" data-room="<?php echo htmlspecialchars($room952); ?>" data-floor="<?php echo htmlspecialchars($floor952); ?>" data-image="<?php echo base64_encode($upload_img952); ?>" data-category="<?php echo htmlspecialchars($category952); ?>" data-status="<?php echo htmlspecialchars($status952); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName952); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status952); ?>; position:absolute; top:240px; left:305px;'>
                        </div>

                        <!-- ASSET 953 -->
                        <img src="../image.php?id=953" class="asset-image" data-id="<?php echo $assetId953; ?>" style="width:30px; cursor:pointer; position:absolute; top:205px; left:185px;" alt="Asset Image 953" data-bs-toggle="modal" data-bs-target="#imageModal953" onclick="fetchAssetData(953);" data-room="<?php echo htmlspecialchars($room953); ?>" data-floor="<?php echo htmlspecialchars($floor953); ?>" data-image="<?php echo base64_encode($upload_img953); ?>" data-category="<?php echo htmlspecialchars($category953); ?>" data-status="<?php echo htmlspecialchars($status953); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName953); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status953); ?>; position:absolute; top:205px; left:207px;'>
                        </div>



                        <!-- ASSET 954 -->
                        <img src="../image.php?id=954" class="asset-image" data-id="<?php echo $assetId954; ?>" style="width:30px; cursor:pointer; position:absolute; top:205px; left:275px;" alt="Asset Image 954" data-bs-toggle="modal" data-bs-target="#imageModal954" onclick="fetchAssetData(954);" data-room="<?php echo htmlspecialchars($room954); ?>" data-floor="<?php echo htmlspecialchars($floor954); ?>" data-image="<?php echo base64_encode($upload_img954); ?>" data-category="<?php echo htmlspecialchars($category954); ?>" data-status="<?php echo htmlspecialchars($status954); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName954); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status954); ?>; position:absolute; top:205px; left:297px;'>
                        </div>


                        <!-- ASSET 955 -->
                        <img src="../image.php?id=955" class="asset-image" data-id="<?php echo $assetId955; ?>" style="width:15px; cursor:pointer; position:absolute; top:275px; left:185px;" alt="Asset Image 955" data-bs-toggle="modal" data-bs-target="#imageModal955" onclick="fetchAssetData(955);" data-room="<?php echo htmlspecialchars($room955); ?>" data-floor="<?php echo htmlspecialchars($floor955); ?>" data-image="<?php echo base64_encode($upload_img955); ?>" data-category="<?php echo htmlspecialchars($category955); ?>" data-status="<?php echo htmlspecialchars($status955); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName955); ?>">
                         <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status955); ?>; position:absolute; top:275px; left:195px;'>
                        </div>

                        <!-- ASSET 956 -->
                        <img src="../image.php?id=956" class="asset-image" data-id="<?php echo $assetId956; ?>" style="width:15px; cursor:pointer; position:absolute; top:275px; left:295px;" alt="Asset Image 956" data-bs-toggle="modal" data-bs-target="#imageModal956" onclick="fetchAssetData(956);" data-room="<?php echo htmlspecialchars($room956); ?>" data-floor="<?php echo htmlspecialchars($floor956); ?>" data-image="<?php echo base64_encode($upload_img956); ?>" data-category="<?php echo htmlspecialchars($category956); ?>" data-status="<?php echo htmlspecialchars($status956); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName956); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status956); ?>; position:absolute; top:275px; left:305px;'>
                        </div>



                        <!-- ASSET 957 -->
                        <img src="../image.php?id=957" class="asset-image" data-id="<?php echo $assetId957; ?>" style="width:15px; cursor:pointer; position:absolute; top:315px; left:185px;" alt="Asset Image 957" data-bs-toggle="modal" data-bs-target="#imageModal957" onclick="fetchAssetData(957);" data-room="<?php echo htmlspecialchars($room957); ?>" data-floor="<?php echo htmlspecialchars($floor957); ?>" data-image="<?php echo base64_encode($upload_img957); ?>" data-category="<?php echo htmlspecialchars($category957); ?>" data-status="<?php echo htmlspecialchars($status957); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName957); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status957); ?>; position:absolute; top:315px; left:195px;'>
                        </div>


                    
                        <!-- ASSET 958 -->
                    <img src="../image.php?id=958" class="asset-image" data-id="<?php echo $assetId958; ?>" style="width:15px; cursor:pointer; position:absolute; top:315px; left:295px;" alt="Asset Image 958" data-bs-toggle="modal" data-bs-target="#imageModal958" onclick="fetchAssetData(958);" data-room="<?php echo htmlspecialchars($room958); ?>" data-floor="<?php echo htmlspecialchars($floor958); ?>" data-image="<?php echo base64_encode($upload_img958); ?>" data-category="<?php echo htmlspecialchars($category958); ?>" data-status="<?php echo htmlspecialchars($status958); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName958); ?>">
                         <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status958); ?>; position:absolute; top:315px; left:305px;'>
                     </div>

                      <!-- ASSET 959 -->
 <img src="../image.php?id=959" class="asset-image" data-id="<?php echo $assetId959; ?>" style="width:30px; cursor:pointer; position:absolute; top:285px; left:237px;" alt="Asset Image 959" data-bs-toggle="modal" data-bs-target="#imageModal959" onclick="fetchAssetData(959);" data-room="<?php echo htmlspecialchars($room959); ?>" data-floor="<?php echo htmlspecialchars($floor959); ?>" data-image="<?php echo base64_encode($upload_img959); ?>" data-category="<?php echo htmlspecialchars($category959); ?>" data-status="<?php echo htmlspecialchars($status959); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName959); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status959); ?>; position:absolute; top:285px; left:259px;'>
                        </div>

                            <!-- ASSET 960 -->
    <img src="../image.php?id=960" class="asset-image" data-id="<?php echo $assetId960; ?>" style="width:30px; cursor:pointer; position:absolute; top:355px; left:237px;" alt="Asset Image 960" data-bs-toggle="modal" data-bs-target="#imageModal960" onclick="fetchAssetData(960);" data-room="<?php echo htmlspecialchars($room960); ?>" data-floor="<?php echo htmlspecialchars($floor960); ?>" data-image="<?php echo base64_encode($upload_img960); ?>" data-category="<?php echo htmlspecialchars($category960); ?>" data-status="<?php echo htmlspecialchars($status960); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName960); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status960); ?>; position:absolute; top:355px; left:259px;'>
                        </div>


                    <!-- ASSET 961 -->
                    <img src="../image.php?id=961" class="asset-image" data-id="<?php echo $assetId961; ?>" style="width:15px; cursor:pointer; position:absolute; top:345px; left:295px;" alt="Asset Image 961" data-bs-toggle="modal" data-bs-target="#imageModal961" onclick="fetchAssetData(961);" data-room="<?php echo htmlspecialchars($room961); ?>" data-floor="<?php echo htmlspecialchars($floor961); ?>" data-image="<?php echo base64_encode($upload_img961); ?>" data-category="<?php echo htmlspecialchars($category961); ?>" data-status="<?php echo htmlspecialchars($status961); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName961); ?>">
                         <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status961); ?>; position:absolute; top:345px; left:305px;'>
                     </div>

                          <!-- ASSET 962 -->
                    <img src="../image.php?id=962" class="asset-image" data-id="<?php echo $assetId962; ?>" style="width:15px; cursor:pointer; position:absolute; top:345px; left:185px;" alt="Asset Image 962" data-bs-toggle="modal" data-bs-target="#imageModal962" onclick="fetchAssetData(962);" data-room="<?php echo htmlspecialchars($room962); ?>" data-floor="<?php echo htmlspecialchars($floor962); ?>" data-image="<?php echo base64_encode($upload_img962); ?>" data-category="<?php echo htmlspecialchars($category962); ?>" data-status="<?php echo htmlspecialchars($status962); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName962); ?>">
                         <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status962); ?>; position:absolute; top:345px; left:195px;'>
                     </div>

                          <!-- ASSET 963 -->
                    <img src="../image.php?id=963" class="asset-image" data-id="<?php echo $assetId963; ?>" style="width:15px; cursor:pointer; position:absolute; top:380px; left:185px;" alt="Asset Image 963" data-bs-toggle="modal" data-bs-target="#imageModal963" onclick="fetchAssetData(963);" data-room="<?php echo htmlspecialchars($room963); ?>" data-floor="<?php echo htmlspecialchars($floor963); ?>" data-image="<?php echo base64_encode($upload_img963); ?>" data-category="<?php echo htmlspecialchars($category963); ?>" data-status="<?php echo htmlspecialchars($status963); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName963); ?>">
                         <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status963); ?>; position:absolute; top:380px; left:195px;'>
                     </div>

                          <!-- ASSET 964 -->
                    <img src="../image.php?id=964" class="asset-image" data-id="<?php echo $assetId964; ?>" style="width:15px; cursor:pointer; position:absolute; top:380px; left:295px;" alt="Asset Image 964" data-bs-toggle="modal" data-bs-target="#imageModal964" onclick="fetchAssetData(964);" data-room="<?php echo htmlspecialchars($room964); ?>" data-floor="<?php echo htmlspecialchars($floor964); ?>" data-image="<?php echo base64_encode($upload_img964); ?>" data-category="<?php echo htmlspecialchars($category964); ?>" data-status="<?php echo htmlspecialchars($status964); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName964); ?>">
                         <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status964); ?>; position:absolute; top:380px; left:305px;'>
                     </div>
                ...
                <div class='modal fade' id='imageModal926' tabindex='-1' aria-labelledby='imageModalLabel926' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId926); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img926); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId926); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date926); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room926); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building926); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor926); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category926); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName926); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy926); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description926); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop926">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 926-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop926" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal927' tabindex='-1' aria-labelledby='imageModalLabel927' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId927); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img927); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId927); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date927); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room927); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building927); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor927); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category927); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName927); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy927); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description927); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop927">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 927-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop927" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal928' tabindex='-1' aria-labelledby='imageModalLabel928' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId928); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img928); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId928); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date928); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room928); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building928); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor928); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category928); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName928); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy928); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description928); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop928">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 928-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop928" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal929' tabindex='-1' aria-labelledby='imageModalLabel929' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId929); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img929); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId929); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date929); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room929); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building929); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor929); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category929); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName929); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy929); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description929); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop929">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 929-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop929" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal930' tabindex='-1' aria-labelledby='imageModalLabel930' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId930); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img930); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId930); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date930); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room930); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building930); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor930); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category930); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName930); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy930); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description930); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop930">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 930-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop930" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal931' tabindex='-1' aria-labelledby='imageModalLabel931' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId931); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img931); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId931); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date931); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room931); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building931); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor931); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category931); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName931); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy931); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description931); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop931">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 931-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop931" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal932' tabindex='-1' aria-labelledby='imageModalLabel932' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId932); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img932); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId932); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date932); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room932); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building932); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor932); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category932); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName932); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy932); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description932); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop932">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 932-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop932" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal933' tabindex='-1' aria-labelledby='imageModalLabel933' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId933); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img933); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId933); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date933); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room933); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building933); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor933); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category933); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName933); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy933); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description933); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop933">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 933-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop933" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal934' tabindex='-1' aria-labelledby='imageModalLabel934' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId934); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img934); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId934); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date934); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room934); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building934); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor934); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category934); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName934); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy934); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description934); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop934">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 934-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop934" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal935' tabindex='-1' aria-labelledby='imageModalLabel935' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId935); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img935); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId935); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date935); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room935); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building935); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor935); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category935); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName935); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy935); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description935); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop935">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 935-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop935" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal936' tabindex='-1' aria-labelledby='imageModalLabel936' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId936); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img936); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId936); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date936); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room936); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building936); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor936); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category936); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName936); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy936); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description936); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop936">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 936-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop936" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal937' tabindex='-1' aria-labelledby='imageModalLabel937' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId937); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img937); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId937); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date937); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room937); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building937); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor937); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category937); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName937); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy937); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description937); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop937">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 937-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop937" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal938' tabindex='-1' aria-labelledby='imageModalLabel938' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId938); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img938); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId938); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date938); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room938); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building938); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor938); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category938); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName938); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy938); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description938); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop938">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 938-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop938" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal939' tabindex='-1' aria-labelledby='imageModalLabel939' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId939); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img939); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId939); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date939); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room939); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building939); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor939); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category939); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName939); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy939); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description939); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop939">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 939-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop939" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal940' tabindex='-1' aria-labelledby='imageModalLabel940' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId940); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img940); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId940); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date940); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room940); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building940); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor940); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category940); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName940); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy940); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description940); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop940">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 940-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop940" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal941' tabindex='-1' aria-labelledby='imageModalLabel941' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId941); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img941); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId941); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date941); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room941); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building941); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor941); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category941); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName941); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy941); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description941); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop941">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 941-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop941" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal942' tabindex='-1' aria-labelledby='imageModalLabel942' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId942); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img942); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId942); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date942); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room942); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building942); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor942); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category942); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName942); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy942); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description942); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop942">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 942-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop942" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal943' tabindex='-1' aria-labelledby='imageModalLabel943' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId943); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img943); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId943); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date943); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room943); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building943); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor943); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category943); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName943); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy943); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description943); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop943">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 943-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop943" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal944' tabindex='-1' aria-labelledby='imageModalLabel944' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId944); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img944); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId944); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date944); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room944); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building944); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor944); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category944); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName944); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy944); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description944); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop944">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 944-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop944" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal945' tabindex='-1' aria-labelledby='imageModalLabel945' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId945); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img945); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId945); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date945); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room945); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building945); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor945); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category945); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName945); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy945); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description945); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop945">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 945-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop945" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal946' tabindex='-1' aria-labelledby='imageModalLabel946' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId946); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img946); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId946); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date946); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room946); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building946); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor946); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category946); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName946); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy946); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description946); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop946">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 946-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop946" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal947' tabindex='-1' aria-labelledby='imageModalLabel947' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId947); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img947); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId947); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date947); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room947); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building947); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor947); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category947); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName947); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy947); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description947); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop947">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 947-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop947" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal948' tabindex='-1' aria-labelledby='imageModalLabel948' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId948); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img948); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId948); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date948); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room948); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building948); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor948); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category948); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName948); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy948); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description948); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop948">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 948-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop948" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal949' tabindex='-1' aria-labelledby='imageModalLabel949' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId949); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img949); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId949); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date949); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room949); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building949); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor949); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category949); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName949); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy949); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description949); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop949">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 949-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop949" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal950' tabindex='-1' aria-labelledby='imageModalLabel950' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId950); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img950); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId950); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date950); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room950); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building950); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor950); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category950); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName950); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy950); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description950); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop950">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 950-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop950" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal951' tabindex='-1' aria-labelledby='imageModalLabel951' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId951); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img951); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId951); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date951); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room951); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building951); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor951); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category951); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName951); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy951); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description951); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop951">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 951-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop951" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal952' tabindex='-1' aria-labelledby='imageModalLabel952' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId952); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img952); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId952); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date952); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room952); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building952); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor952); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category952); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName952); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy952); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description952); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop952">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 952-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop952" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal953' tabindex='-1' aria-labelledby='imageModalLabel953' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId953); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img953); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId953); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date953); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room953); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building953); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor953); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category953); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName953); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy953); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description953); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop953">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 953-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop953" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                <div class='modal fade' id='imageModal954' tabindex='-1' aria-labelledby='imageModalLabel954' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId954); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img954); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId954); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date954); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room954); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building954); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor954); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category954); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName954); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy954); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description954); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop954">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 954-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop954" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                ...
                </div> <!-- Modal structure for id 955-->
                <div class='modal fade' id='imageModal955' tabindex='-1' aria-labelledby='imageModalLabel955' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId955); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img955); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId955); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date955); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room955); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building955); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor955); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category955); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status955 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status955 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status955 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status955 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName955); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy955); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description955); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop955">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 955-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop955" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit955">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 956-->
                <div class='modal fade' id='imageModal956' tabindex='-1' aria-labelledby='imageModalLabel956' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId956); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img956); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId956); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date956); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room956); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building956); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor956); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category956); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status956 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status956 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status956 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status956 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName956); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy956); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description956); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop956">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 956-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop956" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit956">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 957-->
                <div class='modal fade' id='imageModal957' tabindex='-1' aria-labelledby='imageModalLabel957' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId957); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img957); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId957); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date957); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room957); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building957); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor957); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category957); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status957 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status957 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status957 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status957 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName957); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy957); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description957); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop957">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 957-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop957" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit957">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 958-->
                <div class='modal fade' id='imageModal958' tabindex='-1' aria-labelledby='imageModalLabel958' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId958); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img958); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId958); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date958); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room958); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building958); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor958); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category958); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status958 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status958 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status958 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status958 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName958); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy958); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description958); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop958">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 958-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop958" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit958">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 959-->
                <div class='modal fade' id='imageModal959' tabindex='-1' aria-labelledby='imageModalLabel959' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId959); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img959); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId959); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date959); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room959); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building959); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor959); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category959); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status959 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status959 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status959 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status959 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName959); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy959); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description959); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop959">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 959-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop959" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit959">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 960-->
                <div class='modal fade' id='imageModal960' tabindex='-1' aria-labelledby='imageModalLabel960' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId960); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img960); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId960); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date960); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room960); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building960); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor960); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category960); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status960 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status960 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status960 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status960 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName960); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy960); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description960); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop960">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 960-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop960" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit960">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 961-->
                <div class='modal fade' id='imageModal961' tabindex='-1' aria-labelledby='imageModalLabel961' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId961); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img961); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId961); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date961); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room961); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building961); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor961); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category961); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status961 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status961 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status961 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status961 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName961); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy961); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description961); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop961">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 961-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop961" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit961">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 962-->
                <div class='modal fade' id='imageModal962' tabindex='-1' aria-labelledby='imageModalLabel962' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId962); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img962); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId962); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date962); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room962); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building962); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor962); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category962); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status962 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status962 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status962 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status962 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName962); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy962); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description962); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop962">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 962-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop962" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit962">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 963-->
                <div class='modal fade' id='imageModal963' tabindex='-1' aria-labelledby='imageModalLabel963' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId963); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img963); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId963); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date963); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room963); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building963); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor963); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category963); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status963 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status963 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status963 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status963 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName963); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy963); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description963); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop963">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 963-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop963" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit963">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
                ...
                </div> <!-- Modal structure for id 964-->
                <div class='modal fade' id='imageModal964' tabindex='-1' aria-labelledby='imageModalLabel964' aria-hidden='true'>
                    <div class='modal-dialog modal-xl modal-dialog-centered'>
                        <div class='modal-content'>
                            <!-- Modal header -->
                            <div class='modal-header'>
                            ...
                            <div class='modal-body'>
                                <form method="post" class="row g-3" enctype="multipart/form-data">
                                    <input type="hidden" name="assetId" value="<?php echo htmlspecialchars($assetId964); ?>">
                                    <!--START DIV FOR IMAGE -->

                                    <!--First Row-->
                                    <!--IMAGE HERE-->
                                    <div class="col-12 center-content">
                                        <img src="data:image/jpeg;base64,<?php echo base64_encode($upload_img964); ?>" alt="No Image" style="width: 100%; max-width: 50px; height: 50px;">
                                    </div>
                                    <!--END DIV FOR IMAGE -->

                                    <div class="col-4" style="display:none">
                                        <label for="assetId" class="form-label">Tracking #:</label>
                                        <input type="text" class="form-control" id="assetId" name="assetId" value="<?php echo htmlspecialchars($assetId964); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="date" class="form-label">Date:</label>
                                        <input type="text" class="form-control" id="date" name="date" value="<?php echo htmlspecialchars($date964); ?>" readonly />
                                    </div>

                                    <!--Second Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="room" name="room" value="<?php echo htmlspecialchars($room964); ?>" readonly />
                                    </div>


                                    <div class="col-6" style="display:none">
                                        <input type="text" class="form-control  center-content" id="building" name="building" value="<?php echo htmlspecialchars($building964); ?>" readonly />
                                    </div>
                                    ...
                                    <!--Third Row-->
                                    <div class="col-6">
                                        <input type="text" class="form-control" id="floor" name="floor" value="<?php echo htmlspecialchars($floor964); ?>" readonly />
                                    </div>

                                    <div class="col-12 center-content">
                                        <input type="text" class="form-control  center-content" id="category" name="category" value="<?php echo htmlspecialchars($category964); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <select class="form-select" id="status" name="status">
                                            <option value="Working" <?php echo ($status964 == 'Working')
                                                                        ? 'selected="selected"' : ''; ?>>Working</option>
                                            <option value="Under Maintenance" <?php echo ($status964 == 'Under Maintenance')
                                                                                    ? 'selected="selected"' : ''; ?>>Under Maintenance</option>
                                            <option value="For Replacement" <?php echo ($status964 == 'For Replacement')
                                                                                ? 'selected="selected"' : ''; ?>>For Replacement</option>
                                            <option value="Need Repair" <?php echo ($status964 == 'Need Repair')
                                                                            ? 'selected="selected"' : ''; ?>>Need Repair</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4" style="display:none">
                                        <label for="assignedName" class="form-label">Assigned Name:</label>
                                        <input type="text" class="form-control" id="assignedName" name="assignedName" value="<?php echo htmlspecialchars($assignedName964); ?>" readonly />
                                    </div>

                                    <div class="col-4" style="display:none">
                                        <label for="assignedBy" class="form-label">Assigned By:</label>
                                        <input type="text" class="form-control" id="assignedBy" name="assignedBy" value="<?php echo htmlspecialchars($assignedBy964); ?>" readonly />
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <input type="text" class="form-control" id="description" name="description" value="<?php echo htmlspecialchars($description964); ?>" />
                                    </div>
                                    <!--End of Fifth Row-->
                                    ...
                                    <!-- Modal footer -->
                                    <div class="button-submit-container">
                                        <button type="button" class="btn add-modal-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop964">
                                            Save
                                        </button>
                                    </div>
                            </div>
                ...
                <!--Edit for table 964-->
                <div class="map-alert">
                    <div class="modal fade" id="staticBackdrop964" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-footer">
                                    <p>Are you sure you want to save changes?</p>
                                    <div class="modal-popups">
                                        <button type="submit" class="btn add-modal-btn" name="edit964">Yes</button>
                                        <button type="button" class="btn close-popups" data-bs-dismiss="modal">No</button>
                                    </div>
                                </div>
                            </div>
