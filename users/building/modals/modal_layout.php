                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" class="row g-3">
                            ...
                            <div class="col-4">
                                ...
                                <input type="password" id="passwordDisplay" value="<?php echo htmlspecialchars($user['password']) ?>" readonly>
                            </div>
                    ...
                    <div class="modal-body ">
                        ...
                        <form class="row g-3 userUpdateFormSelf" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-4">
                                ...
                                <input type="date" class="form-control birthdayEdit" id="birthdayEditSelf" name="birthday" value="<?php echo $user['birthday'] ?>" readonly />
                            </div>
