            ...
            <main>
                <div class="content-container" id="content-container">
                    <div id="belmonte-F1" class="content">
                        ...
                        <!-- ASSET 16228 -->
                        <img src='../image.php?id=16228' style='width:20px; cursor:pointer; position:absolute; top:170px; left:120px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16228' onclick='fetchAssetData(16228);' class="asset-image" data-id="<?php echo $assetId16228; ?>" data-room="<?php echo htmlspecialchars($room16228); ?>" data-floor="<?php echo htmlspecialchars($floor16228); ?>" data-image="<?php echo base64_encode($upload_img16228); ?>" data-status="<?php echo htmlspecialchars($status16228); ?>" data-category="<?php echo htmlspecialchars($category16228); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16228); ?>">
                        ...
                        <!-- ASSET 16229 -->
                        <img src='../image.php?id=16229' style='width:20px; cursor:pointer; position:absolute; top:190px; left:120px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16229' onclick='fetchAssetData(16229);' class="asset-image" data-id="<?php echo $assetId16229; ?>" data-room="<?php echo htmlspecialchars($room16229); ?>" data-floor="<?php echo htmlspecialchars($floor16229); ?>" data-image="<?php echo base64_encode($upload_img16229); ?>" data-status="<?php echo htmlspecialchars($status16229); ?>" data-category="<?php echo htmlspecialchars($category16229); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16229); ?>">
                        ...
                        <!-- ASSET 16230 -->
                        <img src='../image.php?id=16230' style='width:20px; cursor:pointer; position:absolute; top:210px; left:120px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16230' onclick='fetchAssetData(16230);' class="asset-image" data-id="<?php echo $assetId16230; ?>" data-room="<?php echo htmlspecialchars($room16230); ?>" data-floor="<?php echo htmlspecialchars($floor16230); ?>" data-image="<?php echo base64_encode($upload_img16230); ?>" data-status="<?php echo htmlspecialchars($status16230); ?>" data-category="<?php echo htmlspecialchars($category16230); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16230); ?>">
                        ...
                        <!-- ASSET 16231 -->
                        <img src='../image.php?id=16231' style='width:20px; cursor:pointer; position:absolute; top:170px; left:175px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16231' onclick='fetchAssetData(16231);' class="asset-image" data-id="<?php echo $assetId16231; ?>" data-room="<?php echo htmlspecialchars($room16231); ?>" data-floor="<?php echo htmlspecialchars($floor16231); ?>" data-image="<?php echo base64_encode($upload_img16231); ?>" data-category="<?php echo htmlspecialchars($category16231); ?>" data-status="<?php echo htmlspecialchars($status16231); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16231); ?>">
                        ...
                        <!-- ASSET 16232 -->
                        <img src='../image.php?id=16232' style='width:20px; cursor:pointer; position:absolute; top:207px; left:175px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16232' onclick='fetchAssetData(16232);' class="asset-image" data-id="<?php echo $assetId16232; ?>" data-room="<?php echo htmlspecialchars($room16232); ?>" data-floor="<?php echo htmlspecialchars($floor16232); ?>" data-image="<?php echo base64_encode($upload_img16232); ?>" data-status="<?php echo htmlspecialchars($status16232); ?>" data-category="<?php echo htmlspecialchars($category16232); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16232); ?>">
                        ...
                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:390px; left:175px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        ...
                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:390px; left:95px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status16233); ?>; 
                        position:absolute; top:390px; left:105px;'>
                        </div>

                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:490px; left:175px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status16233); ?>; 
                        position:absolute; top:490px; left:185px;'>
                        </div>

                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:490px; left:95px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status16233); ?>; 
                        ...
                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:390px; left:1040px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status16233); ?>; 
                        position:absolute; top:390px; left:1050px;'>
                        </div>

                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:390px; left:1120px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status16233); ?>; 
                        position:absolute; top:390px; left:1130px;'>
                        </div>

                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:490px; left:1040px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status16233); ?>; 
                        position:absolute; top:490px; left:1050px;'>
                        </div>

                        <!-- ASSET 16233 -->
                        <img src='../image.php?id=16233' style='width:20px; cursor:pointer; position:absolute; top:490px; left:1120px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16233' onclick='fetchAssetData(16233);' class="asset-image" data-id="<?php echo $assetId16233; ?>" data-room="<?php echo htmlspecialchars($room16233); ?>" data-floor="<?php echo htmlspecialchars($floor16233); ?>" data-image="<?php echo base64_encode($upload_img16233); ?>" data-status="<?php echo htmlspecialchars($status16233); ?>" data-category="<?php echo htmlspecialchars($category16233); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16233); ?>">
                        <div style='width:8px; height:8px; border-radius:50%; background-color: <?php echo getStatusColor($status16233); ?>; 
                        position:absolute; top:490px; left:1130px;'>
                        </div>

                        <!-- ASSET 16234 -->
                        <img src='../image.php?id=16234' style='width:20px; cursor:pointer; position:absolute; top:252px; left:220px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16234' onclick='fetchAssetData(16234);' class="asset-image" data-id="<?php echo $assetId16234; ?>" data-room="<?php echo htmlspecialchars($room16234); ?>" data-floor="<?php echo htmlspecialchars($floor16234); ?>" data-image="<?php echo base64_encode($upload_img16234); ?>" data-status="<?php echo htmlspecialchars($status16234); ?>" data-category="<?php echo htmlspecialchars($category16234); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16234); ?>">
                        ...
                        <!-- ASSET 16235 -->
                        <img src='../image.php?id=16235' style='width:20px; cursor:pointer; position:absolute; top:320px; left:220px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16235' onclick='fetchAssetData(16235);' class="asset-image" data-id="<?php echo $assetId16235; ?>" data-room="<?php echo htmlspecialchars($room16235); ?>" data-floor="<?php echo htmlspecialchars($floor16235); ?>" data-status="<?php echo htmlspecialchars($status16235); ?>" data-image="<?php echo base64_encode($upload_img16235); ?>" data-category="<?php echo htmlspecialchars($category16235); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16235); ?>">
                        ...
                        <!-- ASSET 16236 -->
                        <img src='../image.php?id=16236' style='width:20px; cursor:pointer; position:absolute; top:320px; left:305px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16236' onclick='fetchAssetData(16236);' class="asset-image" data-id="<?php echo $assetId16236; ?>" data-room="<?php echo htmlspecialchars($room16236); ?>" data-floor="<?php echo htmlspecialchars($floor16236); ?>" data-image="<?php echo base64_encode($upload_img16236); ?>" data-category="<?php echo htmlspecialchars($category16236); ?>" data-status="<?php echo htmlspecialchars($status16236); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16236); ?>">
                        ...
                        <!-- ASSET 16237 -->
                        <img src='../image.php?id=16237' style='width:20px; cursor:pointer; position:absolute; top:252px; left:305px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16237' onclick='fetchAssetData(16237);' class="asset-image" data-id="<?php echo $assetId16237; ?>" data-room="<?php echo htmlspecialchars($room16237); ?>" data-floor="<?php echo htmlspecialchars($floor16237); ?>" data-image="<?php echo base64_encode($upload_img16237); ?>" data-status="<?php echo htmlspecialchars($status16237); ?>" data-category="<?php echo htmlspecialchars($category16237); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16237); ?>">
                        ...
                        <!-- ASSET 16238 -->
                        <img src='../image.php?id=16238' style='width:20px; cursor:pointer; position:absolute; top:252px; left:380px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16238' onclick='fetchAssetData(16238);' class="asset-image" data-id="<?php echo $assetId16238; ?>" data-room="<?php echo htmlspecialchars($room16238); ?>" data-floor="<?php echo htmlspecialchars($floor16238); ?>" data-image="<?php echo base64_encode($upload_img16238); ?>" data-status="<?php echo htmlspecialchars($status16238); ?>" data-category="<?php echo htmlspecialchars($category16238); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16238); ?>">
                        ...
                        <!-- ASSET 16239 -->
                        <img src='../image.php?id=16239' style='width:20px; cursor:pointer; position:absolute; top:320px; left:380px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16239' onclick='fetchAssetData(16239);' class="asset-image" data-id="<?php echo $assetId16239; ?>" data-room="<?php echo htmlspecialchars($room16239); ?>" data-floor="<?php echo htmlspecialchars($floor16239); ?>" data-image="<?php echo base64_encode($upload_img16239); ?>" data-category="<?php echo htmlspecialchars($category16239); ?>" data-status="<?php echo htmlspecialchars($status16239); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16239); ?>">
                        ...
                        <!-- ASSET 16240 -->
                        <img src='../image.php?id=16240' style='width:20px; cursor:pointer; position:absolute; top:320px; left:480px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16240' onclick='fetchAssetData(16240);' class="asset-image" data-id="<?php echo $assetId16240; ?>" data-room="<?php echo htmlspecialchars($room16240); ?>" data-floor="<?php echo htmlspecialchars($floor16240); ?>" data-image="<?php echo base64_encode($upload_img16240); ?>" data-category="<?php echo htmlspecialchars($category16240); ?>" data-status="<?php echo htmlspecialchars($status16240); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16240); ?>">
                        ...
                        <!-- ASSET 16241 -->
                        <img src='../image.php?id=16241' style='width:20px; cursor:pointer; position:absolute; top:252px; left:480px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16241' onclick='fetchAssetData(16241);' class="asset-image" data-id="<?php echo $assetId16241; ?>" data-room="<?php echo htmlspecialchars($room16241); ?>" data-floor="<?php echo htmlspecialchars($floor16241); ?>" data-image="<?php echo base64_encode($upload_img16241); ?>" data-category="<?php echo htmlspecialchars($category16241); ?>" data-status="<?php echo htmlspecialchars($status16241); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16241); ?>">
                        ...
                        <!-- ASSET 16242 -->
                        <img src='../image.php?id=16242' style='width:20px; cursor:pointer; position:absolute; top:252px; left:560px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16242' onclick='fetchAssetData(16242);' class="asset-image" data-id="<?php echo $assetId16242; ?>" data-room="<?php echo htmlspecialchars($room16242); ?>" data-floor="<?php echo htmlspecialchars($floor16242); ?>" data-image="<?php echo base64_encode($upload_img16242); ?>" data-category="<?php echo htmlspecialchars($category16242); ?>" data-status="<?php echo htmlspecialchars($status16242); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16242); ?>">
                        ...
                        <!-- ASSET 16243 -->
                        <img src='../image.php?id=16243' style='width:20px; cursor:pointer; position:absolute; top:320px; left:560px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16243' onclick='fetchAssetData(16243);' class="asset-image" data-id="<?php echo $assetId16243; ?>" data-room="<?php echo htmlspecialchars($room16243); ?>" data-floor="<?php echo htmlspecialchars($floor16243); ?>" data-image="<?php echo base64_encode($upload_img16243); ?>" data-category="<?php echo htmlspecialchars($category16243); ?>" data-status="<?php echo htmlspecialchars($status16243); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16243); ?>">
                        ...
                        <!-- ASSET 16244 -->
                        <img src='../image.php?id=16244' style='width:20px; cursor:pointer; position:absolute; top:320px; left:640px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16244' onclick='fetchAssetData(16244);' class="asset-image" data-id="<?php echo $assetId16244; ?>" data-room="<?php echo htmlspecialchars($room16244); ?>" data-floor="<?php echo htmlspecialchars($floor16244); ?>" data-image="<?php echo base64_encode($upload_img16244); ?>" data-status="<?php echo htmlspecialchars($status16244); ?>" data-category="<?php echo htmlspecialchars($category16244); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16244); ?>">
                        ...
                        <!-- ASSET 16245 -->
                        <img src='../image.php?id=16245' style='width:20px; cursor:pointer; position:absolute; top:252px; left:640px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16245' onclick='fetchAssetData(16245);' class="asset-image" data-id="<?php echo $assetId16245; ?>" data-room="<?php echo htmlspecialchars($room16245); ?>" data-floor="<?php echo htmlspecialchars($floor16245); ?>" data-image="<?php echo base64_encode($upload_img16245); ?>" data-category="<?php echo htmlspecialchars($category16245); ?>" data-status="<?php echo htmlspecialchars($status16245); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16245); ?>">
                        ...
                        <!-- ASSET 16246 -->
                        <img src='../image.php?id=16246' style='width:20px; cursor:pointer; position:absolute; top:252px; left:725px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16246' onclick='fetchAssetData(16246);' class="asset-image" data-id="<?php echo $assetId16246; ?>" data-room="<?php echo htmlspecialchars($room16246); ?>" data-floor="<?php echo htmlspecialchars($floor16246); ?>" data-image="<?php echo base64_encode($upload_img16246); ?>" data-status="<?php echo htmlspecialchars($status16246); ?>" data-category="<?php echo htmlspecialchars($category16246); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16246); ?>">
                        ...
                        <!-- ASSET 16247 -->
                        <img src='../image.php?id=16247' style='width:20px; cursor:pointer; position:absolute; top:320px; left:725px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16247' onclick='fetchAssetData(16247);' class="asset-image" data-id="<?php echo $assetId16247; ?>" data-room="<?php echo htmlspecialchars($room16247); ?>" data-floor="<?php echo htmlspecialchars($floor16247); ?>" data-image="<?php echo base64_encode($upload_img16247); ?>" data-status="<?php echo htmlspecialchars($status16247); ?>" data-category="<?php echo htmlspecialchars($category16247); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16247); ?>">
                        ...
                        <!-- ASSET 16248 -->
                        <img src='../image.php?id=16248' style='width:20px; cursor:pointer; position:absolute; top:320px; left:815px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16248' onclick='fetchAssetData(16248);' class="asset-image" data-id="<?php echo $assetId16248; ?>" data-room="<?php echo htmlspecialchars($room16248); ?>" data-floor="<?php echo htmlspecialchars($floor16248); ?>" data-image="<?php echo base64_encode($upload_img16248); ?>" data-status="<?php echo htmlspecialchars($status16248); ?>" data-category="<?php echo htmlspecialchars($category16248); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16248); ?>">
                        ...
                        <!-- ASSET 16249 -->
                        <img src='../image.php?id=16249' style='width:20px; cursor:pointer; position:absolute; top:252px; left:815px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16249' onclick='fetchAssetData(16249);' class="asset-image" data-id="<?php echo $assetId16249; ?>" data-room="<?php echo htmlspecialchars($room16249); ?>" data-floor="<?php echo htmlspecialchars($floor16249); ?>" data-image="<?php echo base64_encode($upload_img16249); ?>" data-category="<?php echo htmlspecialchars($category16249); ?>" data-status="<?php echo htmlspecialchars($status16249); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16249); ?>">
                        ...
                        <!-- ASSET 16250 -->
                        <img src='../image.php?id=16250' style='width:20px; cursor:pointer; position:absolute; top:252px; left:890px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16250' onclick='fetchAssetData(16250);' class="asset-image" data-id="<?php echo $assetId16250; ?>" data-room="<?php echo htmlspecialchars($room16250); ?>" data-floor="<?php echo htmlspecialchars($floor16250); ?>" data-image="<?php echo base64_encode($upload_img16250); ?>" data-category="<?php echo htmlspecialchars($category16250); ?>" data-status="<?php echo htmlspecialchars($status16250); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16250); ?>">
                        ...
                        <!-- ASSET 16251 -->
                        <img src='../image.php?id=16251' style='width:20px; cursor:pointer; position:absolute; top:320px; left:890px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16251' onclick='fetchAssetData(16251);' class="asset-image" data-id="<?php echo $assetId16251; ?>" data-room="<?php echo htmlspecialchars($room16251); ?>" data-floor="<?php echo htmlspecialchars($floor16251); ?>" data-image="<?php echo base64_encode($upload_img16251); ?>" data-category="<?php echo htmlspecialchars($category16251); ?>" data-status="<?php echo htmlspecialchars($status16251); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16251); ?>">
                        ...
                        <!-- ASSET 16252 -->
                        <img src='../image.php?id=16252' style='width:20px; cursor:pointer; position:absolute; top:320px; left:970px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16252' onclick='fetchAssetData(16252);' class="asset-image" data-id="<?php echo $assetId16252; ?>" data-room="<?php echo htmlspecialchars($room16252); ?>" data-floor="<?php echo htmlspecialchars($floor16252); ?>" data-image="<?php echo base64_encode($upload_img16252); ?>" data-category="<?php echo htmlspecialchars($category16252); ?>" data-status="<?php echo htmlspecialchars($status16252); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16252); ?>">
                        ...
                        <!-- ASSET 16253 -->
                        <img src='../image.php?id=16253' style='width:20px; cursor:pointer; position:absolute; top:252px; left:970px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16253' onclick='fetchAssetData(16253);' class="asset-image" data-id="<?php echo $assetId16253; ?>" data-room="<?php echo htmlspecialchars($room16253); ?>" data-floor="<?php echo htmlspecialchars($floor16253); ?>" data-image="<?php echo base64_encode($upload_img16253); ?>" data-category="<?php echo htmlspecialchars($category16253); ?>" data-status="<?php echo htmlspecialchars($status16253); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16253); ?>">
                        ...
                        <!-- ASSET 16254 -->
                        <img src='../image.php?id=16254' style='width:20px; cursor:pointer; position:absolute; top:252px; left:1050px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16254' onclick='fetchAssetData(16254);' class="asset-image" data-id="<?php echo $assetId16254; ?>" data-room="<?php echo htmlspecialchars($room16254); ?>" data-floor="<?php echo htmlspecialchars($floor16254); ?>" data-image="<?php echo base64_encode($upload_img16254); ?>" data-category="<?php echo htmlspecialchars($category16254); ?>" data-status="<?php echo htmlspecialchars($status16254); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16254); ?>">
                        ...
                        <!-- ASSET 16255 -->
                        <img src='../image.php?id=16255' style='width:20px; cursor:pointer; position:absolute; top:320px; left:1050px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16255' onclick='fetchAssetData(16255);' class="asset-image" data-id="<?php echo $assetId16255; ?>" data-room="<?php echo htmlspecialchars($room16255); ?>" data-floor="<?php echo htmlspecialchars($floor16255); ?>" data-image="<?php echo base64_encode($upload_img16255); ?>" data-category="<?php echo htmlspecialchars($category16255); ?>" data-status="<?php echo htmlspecialchars($status16255); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16255); ?>">
                        ...
                        <!-- ASSET 16268 -->
                        <img src='../image.php?id=16268' style='width:15px; cursor:pointer; position:absolute; top:70px; left:220px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16268' onclick='fetchAssetData(16268);' class="asset-image" data-id="<?php echo $assetId16268; ?>" data-room="<?php echo htmlspecialchars($room16268); ?>" data-floor="<?php echo htmlspecialchars($floor16268); ?>" data-image="<?php echo base64_encode($upload_img16268); ?>" data-category="<?php echo htmlspecialchars($category16268); ?>" data-status="<?php echo htmlspecialchars($status16268); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16268); ?>">
                        ...
                        <!-- ASSET 16269 -->
                        <img src='../image.php?id=16269' style='width:15px; cursor:pointer; position:absolute; top:145px; left:220px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16269' onclick='fetchAssetData(16269);' class="asset-image" data-id="<?php echo $assetId16269; ?>" data-room="<?php echo htmlspecialchars($room16269); ?>" data-floor="<?php echo htmlspecialchars($floor16269); ?>" data-image="<?php echo base64_encode($upload_img16269); ?>" data-status="<?php echo htmlspecialchars($status16269); ?>" data-category="<?php echo htmlspecialchars($category16269); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16269); ?>">
                        ...
                        <!-- ASSET 16270 -->
                        <img src='../image.php?id=16270' style='width:15px; cursor:pointer; position:absolute; top:70px; left:347px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16270' onclick='fetchAssetData(16270);' class="asset-image" data-id="<?php echo $assetId16270; ?>" data-room="<?php echo htmlspecialchars($room16270); ?>" data-floor="<?php echo htmlspecialchars($floor16270); ?>" data-image="<?php echo base64_encode($upload_img16270); ?>" data-status="<?php echo htmlspecialchars($status16270); ?>" data-category="<?php echo htmlspecialchars($category16270); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16270); ?>">
                        ...
                        <!-- ASSET 16271 -->
                        <img src='../image.php?id=16271' style='width:15px; cursor:pointer; position:absolute; top:145px; left:347px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16271' onclick='fetchAssetData(16271);' class="asset-image" data-id="<?php echo $assetId16271; ?>" data-room="<?php echo htmlspecialchars($room16271); ?>" data-floor="<?php echo htmlspecialchars($floor16271); ?>" data-image="<?php echo base64_encode($upload_img16271); ?>" data-category="<?php echo htmlspecialchars($category16271); ?>" data-status="<?php echo htmlspecialchars($status16271); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16271); ?>">
                        ...
                        <!-- ASSET 16272 -->
                        <img src='../image.php?id=16272' style='width:15px; cursor:pointer; position:absolute; top:145px; left:460px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16272' onclick='fetchAssetData(16272);' class="asset-image" data-id="<?php echo $assetId16272; ?>" data-room="<?php echo htmlspecialchars($room16272); ?>" data-floor="<?php echo htmlspecialchars($floor16272); ?>" data-image="<?php echo base64_encode($upload_img16272); ?>" data-status="<?php echo htmlspecialchars($status16272); ?>" data-category="<?php echo htmlspecialchars($category16272); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16272); ?>">
                        ...
                        <!-- ASSET 16273 -->
                        <img src='../image.php?id=16273' style='width:15px; cursor:pointer; position:absolute; top:70px; left:460px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16273' onclick='fetchAssetData(16273);' class="asset-image" data-id="<?php echo $assetId16273; ?>" data-room="<?php echo htmlspecialchars($room16273); ?>" data-floor="<?php echo htmlspecialchars($floor16273); ?>" data-image="<?php echo base64_encode($upload_img16273); ?>" data-status="<?php echo htmlspecialchars($status16273); ?>" data-category="<?php echo htmlspecialchars($category16273); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16273); ?>">
                        ...
                        <!-- ASSET 16328 asd -->
                        <img src='../image.php?id=16328' style='width:15px; cursor:pointer; position:absolute; top:143px; left:430px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16328' onclick='fetchAssetData(16328);' class="asset-image" data-id="<?php echo $assetId16328; ?>" data-room="<?php echo htmlspecialchars($room16328); ?>" data-floor="<?php echo htmlspecialchars($floor16328); ?>" data-image="<?php echo base64_encode($upload_img16328); ?>" data-status="<?php echo htmlspecialchars($status16328); ?>" data-category="<?php echo htmlspecialchars($category16328); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16328); ?>">
                        ...
                        <!-- ASSET 16277 -->
                        <img src='../image.php?id=16277' style='width:18px; cursor:pointer; position:absolute; top:144px; left:446px; transform: rotate(180deg);' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16277' onclick='fetchAssetData(16277);' class="asset-image" data-id="<?php echo $assetId16277; ?>" data-room="<?php echo htmlspecialchars($room16277); ?>" data-floor="<?php echo htmlspecialchars($floor16277); ?>" data-image="<?php echo base64_encode($upload_img16277); ?>" data-category="<?php echo htmlspecialchars($category16277); ?>" data-status="<?php echo htmlspecialchars($status16277); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16277); ?>">
                        ...
                        <!-- ASSET 16275 -->
                        <img src='../image.php?id=16275' style='width:15px; cursor:pointer; position:absolute; top:225px; left:220px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16275' onclick='fetchAssetData(16275);' class="asset-image" data-id="<?php echo $assetId16275; ?>" data-room="<?php echo htmlspecialchars($room16275); ?>" data-floor="<?php echo htmlspecialchars($floor16275); ?>" data-image="<?php echo base64_encode($upload_img16275); ?>" data-category="<?php echo htmlspecialchars($category16275); ?>" data-status="<?php echo htmlspecialchars($status16275); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16275); ?>">
                        ...
                        <!-- ASSET 16276 -->
                        <img src='../image.php?id=16276' style='width:15px; cursor:pointer; position:absolute; top:225px; left:347px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16276' onclick='fetchAssetData(16276);' class="asset-image" data-id="<?php echo $assetId16276; ?>" data-room="<?php echo htmlspecialchars($room16276); ?>" data-floor="<?php echo htmlspecialchars($floor16276); ?>" data-image="<?php echo base64_encode($upload_img16276); ?>" data-status="<?php echo htmlspecialchars($status16276); ?>" data-category="<?php echo htmlspecialchars($category16276); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16276); ?>">
                        ...
                        <!-- ASSET 16274 -->
                        <img src='../image.php?id=16274' style='width:15px; cursor:pointer; position:absolute; top:225px; left:460px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16274' onclick='fetchAssetData(16274);' class="asset-image" data-id="<?php echo $assetId16274; ?>" data-room="<?php echo htmlspecialchars($room16274); ?>" data-floor="<?php echo htmlspecialchars($floor16274); ?>" data-image="<?php echo base64_encode($upload_img16274); ?>" data-status="<?php echo htmlspecialchars($status16274); ?>" data-category="<?php echo htmlspecialchars($category16274); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16274); ?>">
                        ...
                        <!-- ASSET 16278 -->
                        <img src='../image.php?id=16278' style='width:18px; cursor:pointer; position:absolute; top:76px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16278' onclick='fetchAssetData(16278);' class="asset-image" data-id="<?php echo $assetId16278; ?>" data-room="<?php echo htmlspecialchars($room16278); ?>" data-floor="<?php echo htmlspecialchars($floor16278); ?>" data-status="<?php echo htmlspecialchars($status16278); ?>" data-image="<?php echo base64_encode($upload_img16278); ?>" data-category="<?php echo htmlspecialchars($category16278); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16278); ?>">
                        ...
                        <!-- ASSET 16279 -->
                        <img src='../image.php?id=16279' style='width:18px; cursor:pointer; position:absolute; top:89px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16279' onclick='fetchAssetData(16279);' class="asset-image" data-id="<?php echo $assetId16279; ?>" data-room="<?php echo htmlspecialchars($room16279); ?>" data-floor="<?php echo htmlspecialchars($floor16279); ?>" data-image="<?php echo base64_encode($upload_img16279); ?>" data-status="<?php echo htmlspecialchars($status16279); ?>" data-category="<?php echo htmlspecialchars($category16279); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16279); ?>">
                        ...
                        <!-- ASSET 16280 -->
                        <img src='../image.php?id=16280' style='width:18px; cursor:pointer; position:absolute; top:102px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16280' onclick='fetchAssetData(16280);' class="asset-image" data-id="<?php echo $assetId16280; ?>" data-room="<?php echo htmlspecialchars($room16280); ?>" data-floor="<?php echo htmlspecialchars($floor16280); ?>" data-image="<?php echo base64_encode($upload_img16280); ?>" data-status="<?php echo htmlspecialchars($status16280); ?>" data-category="<?php echo htmlspecialchars($category16280); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16280); ?>">
                        ...
                        <!-- ASSET 16281 -->
                        <img src='../image.php?id=16281' style='width:18px; cursor:pointer; position:absolute; top:115px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16281' onclick='fetchAssetData(16281);' class="asset-image" data-id="<?php echo $assetId16281; ?>" data-room="<?php echo htmlspecialchars($room16281); ?>" data-floor="<?php echo htmlspecialchars($floor16281); ?>" data-image="<?php echo base64_encode($upload_img16281); ?>" data-status="<?php echo htmlspecialchars($status16281); ?>" data-category="<?php echo htmlspecialchars($category16281); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16281); ?>">
                        ...
                        <!-- ASSET 16282 -->
                        <img src='../image.php?id=16282' style='width:18px; cursor:pointer; position:absolute; top:129px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16282' onclick='fetchAssetData(16282);' class="asset-image" data-id="<?php echo $assetId16282; ?>" data-room="<?php echo htmlspecialchars($room16282); ?>" data-floor="<?php echo htmlspecialchars($floor16282); ?>" data-image="<?php echo base64_encode($upload_img16282); ?>" data-status="<?php echo htmlspecialchars($status16282); ?>" data-category="<?php echo htmlspecialchars($category16282); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16282); ?>">
                        ...
                        <!-- ASSET 16283 -->
                        <img src='../image.php?id=16283' style='width:18px; cursor:pointer; position:absolute; top:75px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16283' onclick='fetchAssetData(16283);' class="asset-image" data-id="<?php echo $assetId16283; ?>" data-room="<?php echo htmlspecialchars($room16283); ?>" data-floor="<?php echo htmlspecialchars($floor16283); ?>" data-image="<?php echo base64_encode($upload_img16283); ?>" data-status="<?php echo htmlspecialchars($status16283); ?>" data-category="<?php echo htmlspecialchars($category16283); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16283); ?>">
                        ...
                        <!-- ASSET 16284 -->
                        <img src='../image.php?id=16284' style='width:18px; cursor:pointer; position:absolute; top:87px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16284' onclick='fetchAssetData(16284);' class="asset-image" data-id="<?php echo $assetId16284; ?>" data-room="<?php echo htmlspecialchars($room16284); ?>" data-floor="<?php echo htmlspecialchars($floor16284); ?>" data-image="<?php echo base64_encode($upload_img16284); ?>" data-status="<?php echo htmlspecialchars($status16284); ?>" data-category="<?php echo htmlspecialchars($category16284); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16284); ?>">
                        ...
                        <!-- ASSET 16285 -->
                        <img src='../image.php?id=16285' style='width:18px; cursor:pointer; position:absolute; top:100px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16285' onclick='fetchAssetData(16285);' class="asset-image" data-id="<?php echo $assetId16285; ?>" data-room="<?php echo htmlspecialchars($room16285); ?>" data-floor="<?php echo htmlspecialchars($floor16285); ?>" data-image="<?php echo base64_encode($upload_img16285); ?>" data-status="<?php echo htmlspecialchars($status16285); ?>" data-category="<?php echo htmlspecialchars($category16285); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16285); ?>">
                        ...
                        <!-- ASSET 16286 -->
                        <img src='../image.php?id=16286' style='width:18px; cursor:pointer; position:absolute; top:113px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16286' onclick='fetchAssetData(16286);' class="asset-image" data-id="<?php echo $assetId16286; ?>" data-room="<?php echo htmlspecialchars($room16286); ?>" data-floor="<?php echo htmlspecialchars($floor16286); ?>" data-status="<?php echo htmlspecialchars($status16286); ?>" data-image="<?php echo base64_encode($upload_img16286); ?>" data-category="<?php echo htmlspecialchars($category16286); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16286); ?>">
                        ...
                        <!-- ASSET 16287 -->
                        <img src='../image.php?id=16287' style='width:18px; cursor:pointer; position:absolute; top:126px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16287' onclick='fetchAssetData(16287);' class="asset-image" data-id="<?php echo $assetId16287; ?>" data-room="<?php echo htmlspecialchars($room16287); ?>" data-status="<?php echo htmlspecialchars($status16287); ?>" data-floor="<?php echo htmlspecialchars($floor16287); ?>" data-image="<?php echo base64_encode($upload_img16287); ?>" data-category="<?php echo htmlspecialchars($category16287); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16287); ?>">
                        ...
                        <!-- ASSET 16288 -->
                        <img src='../image.php?id=16288' style='width:18px; cursor:pointer; position:absolute; top:74px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16288' onclick='fetchAssetData(16288);' class="asset-image" data-id="<?php echo $assetId16288; ?>" data-room="<?php echo htmlspecialchars($room16288); ?>" data-floor="<?php echo htmlspecialchars($floor16288); ?>" data-image="<?php echo base64_encode($upload_img16288); ?>" data-status="<?php echo htmlspecialchars($status16288); ?>" data-category="<?php echo htmlspecialchars($category16288); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16288); ?>">
                        ...
                        <!-- ASSET 16289 -->
                        <img src='../image.php?id=16289' style='width:18px; cursor:pointer; position:absolute; top:87px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16289' onclick='fetchAssetData(16289);' class="asset-image" data-id="<?php echo $assetId16289; ?>" data-room="<?php echo htmlspecialchars($room16289); ?>" data-floor="<?php echo htmlspecialchars($floor16289); ?>" data-image="<?php echo base64_encode($upload_img16289); ?>" data-status="<?php echo htmlspecialchars($status16289); ?>" data-category="<?php echo htmlspecialchars($category16289); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16289); ?>">
                        ...
                        <!-- ASSET 16290 -->
                        <img src='../image.php?id=16290' style='width:18px; cursor:pointer; position:absolute; top:100px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16290' onclick='fetchAssetData(16290);' class="asset-image" data-id="<?php echo $assetId16290; ?>" data-room="<?php echo htmlspecialchars($room16290); ?>" data-floor="<?php echo htmlspecialchars($floor16290); ?>" data-status="<?php echo htmlspecialchars($status16290); ?>" data-image="<?php echo base64_encode($upload_img16290); ?>" data-category="<?php echo htmlspecialchars($category16290); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16290); ?>">
                        ...
                        <!-- ASSET 16291 -->
                        <img src='../image.php?id=16291' style='width:18px; cursor:pointer; position:absolute; top:113px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16291' onclick='fetchAssetData(16291);' class="asset-image" data-id="<?php echo $assetId16291; ?>" data-room="<?php echo htmlspecialchars($room16291); ?>" data-floor="<?php echo htmlspecialchars($floor16291); ?>" data-image="<?php echo base64_encode($upload_img16291); ?>" data-status="<?php echo htmlspecialchars($status16291); ?>" data-category="<?php echo htmlspecialchars($category16291); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16291); ?>">
                        ...
                        <!-- ASSET 16292 -->
                        <img src='../image.php?id=16292' style='width:18px; cursor:pointer; position:absolute; top:126px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16292' onclick='fetchAssetData(16292);' class="asset-image" data-id="<?php echo $assetId16292; ?>" data-room="<?php echo htmlspecialchars($room16292); ?>" data-floor="<?php echo htmlspecialchars($floor16292); ?>" data-image="<?php echo base64_encode($upload_img16292); ?>" data-status="<?php echo htmlspecialchars($status16292); ?>" data-category="<?php echo htmlspecialchars($category16292); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16292); ?>">
                        ...
                        <!-- ASSET 16293 -->
                        <img src='../image.php?id=16293' style='width:18px; cursor:pointer; position:absolute; top:74px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16293' onclick='fetchAssetData(16293);' class="asset-image" data-id="<?php echo $assetId16293; ?>" data-room="<?php echo htmlspecialchars($room16293); ?>" data-floor="<?php echo htmlspecialchars($floor16293); ?>" data-status="<?php echo htmlspecialchars($status16293); ?>" data-image="<?php echo base64_encode($upload_img16293); ?>" data-category="<?php echo htmlspecialchars($category16293); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16293); ?>">
                        ...
                        <!-- ASSET 16294 -->
                        <img src='../image.php?id=16294' style='width:18px; cursor:pointer; position:absolute; top:87px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16294' onclick='fetchAssetData(16294);' class="asset-image" data-id="<?php echo $assetId16294; ?>" data-room="<?php echo htmlspecialchars($room16294); ?>" data-floor="<?php echo htmlspecialchars($floor16294); ?>" data-image="<?php echo base64_encode($upload_img16294); ?>" data-status="<?php echo htmlspecialchars($status16294); ?>" data-category="<?php echo htmlspecialchars($category16294); ?>">
                        ...
                        <!-- ASSET 16295 -->
                        <img src='../image.php?id=16295' style='width:18px; cursor:pointer; position:absolute; top:100px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16295' onclick='fetchAssetData(16295);' class="asset-image" data-id="<?php echo $assetId16295; ?>" data-room="<?php echo htmlspecialchars($room16295); ?>" data-floor="<?php echo htmlspecialchars($floor16295); ?>" data-status="<?php echo htmlspecialchars($status16295); ?>" data-image="<?php echo base64_encode($upload_img16295); ?>" data-category="<?php echo htmlspecialchars($category16295); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16295); ?>">
                        ...
                        <!-- ASSET 16296 -->
                        <img src='../image.php?id=16296' style='width:18px; cursor:pointer; position:absolute; top:113px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16296' onclick='fetchAssetData(16296);' class="asset-image" data-id="<?php echo $assetId16296; ?>" data-room="<?php echo htmlspecialchars($room16296); ?>" data-floor="<?php echo htmlspecialchars($floor16296); ?>" data-image="<?php echo base64_encode($upload_img16296); ?>" data-status="<?php echo htmlspecialchars($status16296); ?>" data-category="<?php echo htmlspecialchars($category16296); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16296); ?>">
                        ...
                        <!-- ASSET 16297 -->
                        <img src='../image.php?id=16297' style='width:18px; cursor:pointer; position:absolute; top:126px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16297' onclick='fetchAssetData(16297);' class="asset-image" data-id="<?php echo $assetId16297; ?>" data-room="<?php echo htmlspecialchars($room16297); ?>" data-floor="<?php echo htmlspecialchars($floor16297); ?>" data-status="<?php echo htmlspecialchars($status16297); ?>" data-image="<?php echo base64_encode($upload_img16297); ?>" data-category="<?php echo htmlspecialchars($category16297); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16297); ?>">
                        ...
                        <!-- ASSET 16298 -->
                        <img src='../image.php?id=16298' style='width:18px; cursor:pointer; position:absolute; top:74px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16298' onclick='fetchAssetData(16298);' class="asset-image" data-id="<?php echo $assetId16298; ?>" data-room="<?php echo htmlspecialchars($room16298); ?>" data-floor="<?php echo htmlspecialchars($floor16298); ?>" data-image="<?php echo base64_encode($upload_img16298); ?>" data-status="<?php echo htmlspecialchars($status16298); ?>" data-category="<?php echo htmlspecialchars($category16298); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16298); ?>">
                        ...
                        <!-- ASSET 16299 -->
                        <img src='../image.php?id=16299' style='width:18px; cursor:pointer; position:absolute; top:87px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16299' onclick='fetchAssetData(16299);' class="asset-image" data-id="<?php echo $assetId16299; ?>" data-room="<?php echo htmlspecialchars($room16299); ?>" data-floor="<?php echo htmlspecialchars($floor16299); ?>" data-image="<?php echo base64_encode($upload_img16299); ?>" data-status="<?php echo htmlspecialchars($status16299); ?>" data-category="<?php echo htmlspecialchars($category16299); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16299); ?>">
                        ...
                        <!-- ASSET 16300 -->
                        <img src='../image.php?id=16300' style='width:18px; cursor:pointer; position:absolute; top:100px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16300' onclick='fetchAssetData(16300);' class="asset-image" data-id="<?php echo $assetId16300; ?>" data-room="<?php echo htmlspecialchars($room16300); ?>" data-floor="<?php echo htmlspecialchars($floor16300); ?>" data-image="<?php echo base64_encode($upload_img16300); ?>" data-status="<?php echo htmlspecialchars($status16300); ?>" data-category="<?php echo htmlspecialchars($category16300); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16300); ?>">
                        ...
                        <!-- ASSET 16301 -->
                        <img src='../image.php?id=16301' style='width:18px; cursor:pointer; position:absolute; top:113px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16301' onclick='fetchAssetData(16301);' class="asset-image" data-id="<?php echo $assetId16301; ?>" data-room="<?php echo htmlspecialchars($room16301); ?>" data-floor="<?php echo htmlspecialchars($floor16301); ?>" data-image="<?php echo base64_encode($upload_img16301); ?>" data-status="<?php echo htmlspecialchars($status16301); ?>" data-category="<?php echo htmlspecialchars($category16301); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16301); ?>">
                        ...
                        <!-- ASSET 16302 -->
                        <img src='../image.php?id=16302' style='width:18px; cursor:pointer; position:absolute; top:126px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16302' onclick='fetchAssetData(16302);' class="asset-image" data-id="<?php echo $assetId16302; ?>" data-room="<?php echo htmlspecialchars($room16302); ?>" data-floor="<?php echo htmlspecialchars($floor16302); ?>" data-image="<?php echo base64_encode($upload_img16302); ?>" data-status="<?php echo htmlspecialchars($status16302); ?>" data-category="<?php echo htmlspecialchars($category16302); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16302); ?>">
                        ...
                        <!-- ASSET 16303 -->
                        <img src='../image.php?id=16303' style='width:18px; cursor:pointer; position:absolute; top:155px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16303' onclick='fetchAssetData(16303);' class="asset-image" data-id="<?php echo $assetId16303; ?>" data-room="<?php echo htmlspecialchars($room16303); ?>" data-floor="<?php echo htmlspecialchars($floor16303); ?>" data-image="<?php echo base64_encode($upload_img16303); ?>" data-status="<?php echo htmlspecialchars($status16303); ?>" data-category="<?php echo htmlspecialchars($category16303); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16303); ?>">
                        ...
                        <!-- ASSET 16304 -->
                        <img src='../image.php?id=16304' style='width:18px; cursor:pointer; position:absolute; top:167px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16304' onclick='fetchAssetData(16304);' class="asset-image" data-id="<?php echo $assetId16304; ?>" data-room="<?php echo htmlspecialchars($room16304); ?>" data-floor="<?php echo htmlspecialchars($floor16304); ?>" data-image="<?php echo base64_encode($upload_img16304); ?>" data-status="<?php echo htmlspecialchars($status16304); ?>" data-category="<?php echo htmlspecialchars($category16304); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16304); ?>">
                        ...
                        <!-- ASSET 16305 -->
                        <img src='../image.php?id=16305' style='width:18px; cursor:pointer; position:absolute; top:179px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16305' onclick='fetchAssetData(16305);' class="asset-image" data-id="<?php echo $assetId16305; ?>" data-room="<?php echo htmlspecialchars($room16305); ?>" data-floor="<?php echo htmlspecialchars($floor16305); ?>" data-image="<?php echo base64_encode($upload_img16305); ?>" data-status="<?php echo htmlspecialchars($status16305); ?>" data-category="<?php echo htmlspecialchars($category16305); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16305); ?>">
                        ...
                        <!-- ASSET 16306 -->
                        <img src='../image.php?id=16306' style='width:18px; cursor:pointer; position:absolute; top:191px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16306' onclick='fetchAssetData(16306);' class="asset-image" data-id="<?php echo $assetId16306; ?>" data-room="<?php echo htmlspecialchars($room16306); ?>" data-floor="<?php echo htmlspecialchars($floor16306); ?>" data-image="<?php echo base64_encode($upload_img16306); ?>" data-category="<?php echo htmlspecialchars($category16306); ?>" data-status="<?php echo htmlspecialchars($status16306); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16306); ?>">
                        ...
                        <!-- ASSET 16307 -->
                        <img src='../image.php?id=16307' style='width:18px; cursor:pointer; position:absolute; top:203px; left:233px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16307' onclick='fetchAssetData(16307);' class="asset-image" data-id="<?php echo $assetId16307; ?>" data-room="<?php echo htmlspecialchars($room16307); ?>" data-floor="<?php echo htmlspecialchars($floor16307); ?>" data-image="<?php echo base64_encode($upload_img16307); ?>" data-status="<?php echo htmlspecialchars($status16307); ?>" data-category="<?php echo htmlspecialchars($category16307); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16307); ?>">
                        ...
                        <!-- ASSET 16308 -->
                        <img src='../image.php?id=16308' style='width:18px; cursor:pointer; position:absolute; top:155px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16308' onclick='fetchAssetData(16308);' class="asset-image" data-id="<?php echo $assetId16308; ?>" data-room="<?php echo htmlspecialchars($room16308); ?>" data-floor="<?php echo htmlspecialchars($floor16308); ?>" data-status="<?php echo htmlspecialchars($status16308); ?>" data-image="<?php echo base64_encode($upload_img16308); ?>" data-category="<?php echo htmlspecialchars($category16308); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16308); ?>">
                        ...
                        <!-- ASSET 16309 -->
                        <img src='../image.php?id=16309' style='width:18px; cursor:pointer; position:absolute; top:167px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16309' onclick='fetchAssetData(16309);' class="asset-image" data-id="<?php echo $assetId16309; ?>" data-room="<?php echo htmlspecialchars($room16309); ?>" data-floor="<?php echo htmlspecialchars($floor16309); ?>" data-image="<?php echo base64_encode($upload_img16309); ?>" data-status="<?php echo htmlspecialchars($status16309); ?>" data-category="<?php echo htmlspecialchars($category16309); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16309); ?>">
                        ...
                        <!-- ASSET 16310 -->
                        <img src='../image.php?id=16310' style='width:18px; cursor:pointer; position:absolute; top:179px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16310' onclick='fetchAssetData(16310);' class="asset-image" data-id="<?php echo $assetId16310; ?>" data-room="<?php echo htmlspecialchars($room16310); ?>" data-floor="<?php echo htmlspecialchars($floor16310); ?>" data-image="<?php echo base64_encode($upload_img16310); ?>" data-status="<?php echo htmlspecialchars($status16310); ?>" data-category="<?php echo htmlspecialchars($category16310); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16310); ?>">
                        ...
                        <!-- ASSET 16311 -->
                        <img src='../image.php?id=16311' style='width:18px; cursor:pointer; position:absolute; top:191px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16311' onclick='fetchAssetData(16311);' class="asset-image" data-id="<?php echo $assetId16311; ?>" data-room="<?php echo htmlspecialchars($room16311); ?>" data-floor="<?php echo htmlspecialchars($floor16311); ?>" data-status="<?php echo htmlspecialchars($status16311); ?>" data-image="<?php echo base64_encode($upload_img16311); ?>" data-category="<?php echo htmlspecialchars($category16311); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16311); ?>">
                        ...
                        <!-- ASSET 16312 -->
                        <img src='../image.php?id=16312' style='width:18px; cursor:pointer; position:absolute; top:203px; left:256px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16312' onclick='fetchAssetData(16312);' class="asset-image" data-id="<?php echo $assetId16312; ?>" data-room="<?php echo htmlspecialchars($room16312); ?>" data-floor="<?php echo htmlspecialchars($floor16312); ?>" data-image="<?php echo base64_encode($upload_img16312); ?>" data-category="<?php echo htmlspecialchars($category16312); ?>" data-status="<?php echo htmlspecialchars($status16312); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16312); ?>">
                        ...
                        <!-- ASSET 16313 -->
                        <img src='../image.php?id=16313' style='width:18px; cursor:pointer; position:absolute; top:155px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16313' onclick='fetchAssetData(16313);' class="asset-image" data-id="<?php echo $assetId16313; ?>" data-room="<?php echo htmlspecialchars($room16313); ?>" data-floor="<?php echo htmlspecialchars($floor16313); ?>" data-image="<?php echo base64_encode($upload_img16313); ?>" data-category="<?php echo htmlspecialchars($category16313); ?>" data-status="<?php echo htmlspecialchars($status16313); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16313); ?>">
                        ...
                        <!-- ASSET 16314 -->
                        <img src='../image.php?id=16314' style='width:18px; cursor:pointer; position:absolute; top:167px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16314' onclick='fetchAssetData(16314);' class="asset-image" data-id="<?php echo $assetId16314; ?>" data-room="<?php echo htmlspecialchars($room16314); ?>" data-floor="<?php echo htmlspecialchars($floor16314); ?>" data-image="<?php echo base64_encode($upload_img16314); ?>" data-status="<?php echo htmlspecialchars($status16314); ?>" data-category="<?php echo htmlspecialchars($category16314); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16314); ?>">
                        ...
                        <!-- ASSET 16315 -->
                        <img src='../image.php?id=16315' style='width:18px; cursor:pointer; position:absolute; top:179px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16315' onclick='fetchAssetData(16315);' class="asset-image" data-id="<?php echo $assetId16315; ?>" data-room="<?php echo htmlspecialchars($room16315); ?>" data-floor="<?php echo htmlspecialchars($floor16315); ?>" data-image="<?php echo base64_encode($upload_img16315); ?>" data-category="<?php echo htmlspecialchars($category16315); ?>" data-status="<?php echo htmlspecialchars($status16315); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16315); ?>">
                        ...
                        <!-- ASSET 16316 -->
                        <img src='../image.php?id=16316' style='width:18px; cursor:pointer; position:absolute; top:191px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16316' onclick='fetchAssetData(16316);' class="asset-image" data-id="<?php echo $assetId16316; ?>" data-room="<?php echo htmlspecialchars($room16316); ?>" data-floor="<?php echo htmlspecialchars($floor16316); ?>" data-status="<?php echo htmlspecialchars($status16316); ?>" data-image="<?php echo base64_encode($upload_img16316); ?>" data-category="<?php echo htmlspecialchars($category16316); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16316); ?>">
                        ...
                        <!-- ASSET 16317 -->
                        <img src='../image.php?id=16317' style='width:18px; cursor:pointer; position:absolute; top:203px; left:279px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16317' onclick='fetchAssetData(16317);' class="asset-image" data-id="<?php echo $assetId16317; ?>" data-room="<?php echo htmlspecialchars($room16317); ?>" data-floor="<?php echo htmlspecialchars($floor16317); ?>" data-image="<?php echo base64_encode($upload_img16317); ?>" data-status="<?php echo htmlspecialchars($status16317); ?>" data-category="<?php echo htmlspecialchars($category16317); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16317); ?>">
                        ...
                        <!-- ASSET 16318 -->
                        <img src='../image.php?id=16318' style='width:18px; cursor:pointer; position:absolute; top:155px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16318' onclick='fetchAssetData(16318);' class="asset-image" data-id="<?php echo $assetId16318; ?>" data-room="<?php echo htmlspecialchars($room16318); ?>" data-floor="<?php echo htmlspecialchars($floor16318); ?>" data-image="<?php echo base64_encode($upload_img16318); ?>" data-status="<?php echo htmlspecialchars($status16318); ?>" data-category="<?php echo htmlspecialchars($category16318); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16318); ?>">
                        ...
                        <!-- ASSET 16319 -->
                        <img src='../image.php?id=16319' style='width:18px; cursor:pointer; position:absolute; top:167px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16319' onclick='fetchAssetData(16319);' class="asset-image" data-id="<?php echo $assetId16319; ?>" data-room="<?php echo htmlspecialchars($room16319); ?>" data-floor="<?php echo htmlspecialchars($floor16319); ?>" data-image="<?php echo base64_encode($upload_img16319); ?>" data-status="<?php echo htmlspecialchars($status16319); ?>" data-category="<?php echo htmlspecialchars($category16319); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16319); ?>">
                        ...
                        <!-- ASSET 16320 -->
                        <img src='../image.php?id=16320' style='width:18px; cursor:pointer; position:absolute; top:179px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16320' onclick='fetchAssetData(16320);' class="asset-image" data-id="<?php echo $assetId16320; ?>" data-room="<?php echo htmlspecialchars($room16320); ?>" data-floor="<?php echo htmlspecialchars($floor16320); ?>" data-image="<?php echo base64_encode($upload_img16320); ?>" data-category="<?php echo htmlspecialchars($category16320); ?>" data-status="<?php echo htmlspecialchars($status16320); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16320); ?>">
                        ...
                        <!-- ASSET 16321 -->
                        <img src='../image.php?id=16321' style='width:18px; cursor:pointer; position:absolute; top:191px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16321' onclick='fetchAssetData(16321);' class="asset-image" data-id="<?php echo $assetId16321; ?>" data-room="<?php echo htmlspecialchars($room16321); ?>" data-floor="<?php echo htmlspecialchars($floor16321); ?>" data-image="<?php echo base64_encode($upload_img16321); ?>" data-status="<?php echo htmlspecialchars($status16321); ?>" data-category="<?php echo htmlspecialchars($category16321); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16321); ?>">
                        ...
                        <!-- ASSET 16322 -->
                        <img src='../image.php?id=16322' style='width:18px; cursor:pointer; position:absolute; top:203px; left:302px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16322' onclick='fetchAssetData(16322);' class="asset-image" data-id="<?php echo $assetId16322; ?>" data-room="<?php echo htmlspecialchars($room16322); ?>" data-floor="<?php echo htmlspecialchars($floor16322); ?>" data-image="<?php echo base64_encode($upload_img16322); ?>" data-status="<?php echo htmlspecialchars($status16322); ?>" data-category="<?php echo htmlspecialchars($category16322); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16322); ?>">
                        ...
                        <!-- ASSET 16323 -->
                        <img src='../image.php?id=16323' style='width:18px; cursor:pointer; position:absolute; top:155px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16323' onclick='fetchAssetData(16323);' class="asset-image" data-id="<?php echo $assetId16323; ?>" data-room="<?php echo htmlspecialchars($room16323); ?>" data-floor="<?php echo htmlspecialchars($floor16323); ?>" data-image="<?php echo base64_encode($upload_img16323); ?>" data-category="<?php echo htmlspecialchars($category16323); ?>" data-status="<?php echo htmlspecialchars($status16323); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16323); ?>">
                        ...
                        <!-- ASSET 16324 -->
                        <img src='../image.php?id=16324' style='width:18px; cursor:pointer; position:absolute; top:167px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16324' onclick='fetchAssetData(16324);' class="asset-image" data-id="<?php echo $assetId16324; ?>" data-room="<?php echo htmlspecialchars($room16324); ?>" data-floor="<?php echo htmlspecialchars($floor16324); ?>" data-image="<?php echo base64_encode($upload_img16324); ?>" data-status="<?php echo htmlspecialchars($status16324); ?>" data-category="<?php echo htmlspecialchars($category16324); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16324); ?>">
                        ...
                        <!-- ASSET 16325 -->
                        <img src='../image.php?id=16325' style='width:18px; cursor:pointer; position:absolute; top:179px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16325' onclick='fetchAssetData(16325);' class="asset-image" data-id="<?php echo $assetId16325; ?>" data-room="<?php echo htmlspecialchars($room16325); ?>" data-floor="<?php echo htmlspecialchars($floor16325); ?>" data-image="<?php echo base64_encode($upload_img16325); ?>" data-category="<?php echo htmlspecialchars($category16325); ?>" data-status="<?php echo htmlspecialchars($status16325); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16325); ?>">
                        ...
                        <!-- ASSET 16326 -->
                        <img src='../image.php?id=16326' style='width:18px; cursor:pointer; position:absolute; top:191px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16326' onclick='fetchAssetData(16326);' class="asset-image" data-id="<?php echo $assetId16326; ?>" data-room="<?php echo htmlspecialchars($room16326); ?>" data-floor="<?php echo htmlspecialchars($floor16326); ?>" data-image="<?php echo base64_encode($upload_img16326); ?>" data-status="<?php echo htmlspecialchars($status16326); ?>" data-category="<?php echo htmlspecialchars($category16326); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16326); ?>">
                        ...
                        <!-- ASSET 16327 -->
                        <img src='../image.php?id=16327' style='width:18px; cursor:pointer; position:absolute; top:203px; left:325px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16327' onclick='fetchAssetData(16327);' class="asset-image" data-id="<?php echo $assetId16327; ?>" data-room="<?php echo htmlspecialchars($room16327); ?>" data-floor="<?php echo htmlspecialchars($floor16327); ?>" data-status="<?php echo htmlspecialchars($status16327); ?>" data-image="<?php echo base64_encode($upload_img16327); ?>" data-category="<?php echo htmlspecialchars($category16327); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16327); ?>">
                        ...
                        <!-- ASSET 16329 -->
                        <img src='../image.php?id=16329' style='width:15px; cursor:pointer; position:absolute; top:70px; left:490px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16329' onclick='fetchAssetData(16329);' class="asset-image" data-id="<?php echo $assetId16329; ?>" data-room="<?php echo htmlspecialchars($room16329); ?>" data-floor="<?php echo htmlspecialchars($floor16329); ?>" data-image="<?php echo base64_encode($upload_img16329); ?>" data-category="<?php echo htmlspecialchars($category16329); ?>" data-status="<?php echo htmlspecialchars($status16329); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16329); ?>">
                        ...
                        <!-- ASSET 16330 -->
                        <img src='../image.php?id=16330' style='width:15px; cursor:pointer; position:absolute; top:145px; left:490px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16330' onclick='fetchAssetData(16330);' class="asset-image" data-id="<?php echo $assetId16330; ?>" data-room="<?php echo htmlspecialchars($room16330); ?>" data-floor="<?php echo htmlspecialchars($floor16330); ?>" data-image="<?php echo base64_encode($upload_img16330); ?>" data-category="<?php echo htmlspecialchars($category16330); ?>" data-status="<?php echo htmlspecialchars($status16330); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16330); ?>">
                        ...
                        <!-- ASSET 16331 -->
                        <img src='../image.php?id=16331' style='width:15px; cursor:pointer; position:absolute; top:70px; left:615px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16331' onclick='fetchAssetData(16331);' class="asset-image" data-id="<?php echo $assetId16331; ?>" data-room="<?php echo htmlspecialchars($room16331); ?>" data-floor="<?php echo htmlspecialchars($floor16331); ?>" data-image="<?php echo base64_encode($upload_img16331); ?>" data-category="<?php echo htmlspecialchars($category16331); ?>" data-status="<?php echo htmlspecialchars($status16331); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16331); ?>">
                        ...
                        <!-- ASSET 16332 -->
                        <img src='../image.php?id=16332' style='width:15px; cursor:pointer; position:absolute; top:145px; left:615px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16332' onclick='fetchAssetData(16332);' class="asset-image" data-id="<?php echo $assetId16332; ?>" data-room="<?php echo htmlspecialchars($room16332); ?>" data-floor="<?php echo htmlspecialchars($floor16332); ?>" data-image="<?php echo base64_encode($upload_img16332); ?>" data-category="<?php echo htmlspecialchars($category16332); ?>" data-status="<?php echo htmlspecialchars($status16332); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16332); ?>">
                        ...
                        <!-- ASSET 16333 -->
                        <img src='../image.php?id=16333' style='width:15px; cursor:pointer; position:absolute; top:145px; left:729px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16333' onclick='fetchAssetData(16333);' class="asset-image" data-id="<?php echo $assetId16333; ?>" data-room="<?php echo htmlspecialchars($room16333); ?>" data-floor="<?php echo htmlspecialchars($floor16333); ?>" data-image="<?php echo base64_encode($upload_img16333); ?>" data-category="<?php echo htmlspecialchars($category16333); ?>" data-status="<?php echo htmlspecialchars($status16333); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16333); ?>">
                        ...
                        <!-- ASSET 16334 -->
                        <img src='../image.php?id=16334' style='width:15px; cursor:pointer; position:absolute; top:70px; left:729px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16334' onclick='fetchAssetData(16334);' class="asset-image" data-id="<?php echo $assetId16334; ?>" data-room="<?php echo htmlspecialchars($room16334); ?>" data-floor="<?php echo htmlspecialchars($floor16334); ?>" data-image="<?php echo base64_encode($upload_img16334); ?>" data-category="<?php echo htmlspecialchars($category16334); ?>" data-status="<?php echo htmlspecialchars($status16334); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16334); ?>">
                        ...
                        <!-- ASSET 16335 -->
                        <img src='../image.php?id=16335' style='width:15px; cursor:pointer; position:absolute; top:225px; left:490px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16335' onclick='fetchAssetData(16335);' class="asset-image" data-id="<?php echo $assetId16335; ?>" data-room="<?php echo htmlspecialchars($room16335); ?>" data-floor="<?php echo htmlspecialchars($floor16335); ?>" data-image="<?php echo base64_encode($upload_img16335); ?>" data-status="<?php echo htmlspecialchars($status16335); ?>" data-category="<?php echo htmlspecialchars($category16335); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16335); ?>">
                        ...
                        <!-- ASSET 16336 -->
                        <img src='../image.php?id=16336' style='width:15px; cursor:pointer; position:absolute; top:225px; left:615px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16336' onclick='fetchAssetData(16336);' class="asset-image" data-id="<?php echo $assetId16336; ?>" data-room="<?php echo htmlspecialchars($room16336); ?>" data-floor="<?php echo htmlspecialchars($floor16336); ?>" data-image="<?php echo base64_encode($upload_img16336); ?>" data-status="<?php echo htmlspecialchars($status16336); ?>" data-category="<?php echo htmlspecialchars($category16336); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16336); ?>">
                        ...
                        <!-- ASSET 16337 -->
                        <img src='../image.php?id=16337' style='width:15px; cursor:pointer; position:absolute; top:225px; left:729px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16337' onclick='fetchAssetData(16337);' class="asset-image" data-id="<?php echo $assetId16337; ?>" data-room="<?php echo htmlspecialchars($room16337); ?>" data-floor="<?php echo htmlspecialchars($floor16337); ?>" data-image="<?php echo base64_encode($upload_img16337); ?>" data-status="<?php echo htmlspecialchars($status16337); ?>" data-category="<?php echo htmlspecialchars($category16337); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16337); ?>">
                        ...
                        <!-- ASSET 16356 -->
                        <img src='../image.php?id=16356' style='width:18px; cursor:pointer; position:absolute; top:74px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16356' onclick='fetchAssetData(16356);' class="asset-image" data-id="<?php echo $assetId16356; ?>" data-room="<?php echo htmlspecialchars($room16356); ?>" data-floor="<?php echo htmlspecialchars($floor16356); ?>" data-image="<?php echo base64_encode($upload_img16356); ?>" data-status="<?php echo htmlspecialchars($status16356); ?>" data-category="<?php echo htmlspecialchars($category16356); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16356); ?>">
                        ...
                        <!-- ASSET 16357 -->
                        <img src='../image.php?id=16357' style='width:18px; cursor:pointer; position:absolute; top:87px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16357' onclick='fetchAssetData(16357);' class="asset-image" data-id="<?php echo $assetId16357; ?>" data-room="<?php echo htmlspecialchars($room16357); ?>" data-floor="<?php echo htmlspecialchars($floor16357); ?>" data-image="<?php echo base64_encode($upload_img16357); ?>" data-status="<?php echo htmlspecialchars($status16357); ?>" data-category="<?php echo htmlspecialchars($category16357); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16357); ?>">
                        ...
                        <!-- ASSET 16358 -->
                        <img src='../image.php?id=16358' style='width:18px; cursor:pointer; position:absolute; top:100px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16358' onclick='fetchAssetData(16358);' class="asset-image" data-id="<?php echo $assetId16358; ?>" data-room="<?php echo htmlspecialchars($room16358); ?>" data-floor="<?php echo htmlspecialchars($floor16358); ?>" data-image="<?php echo base64_encode($upload_img16358); ?>" data-status="<?php echo htmlspecialchars($status16358); ?>" data-category="<?php echo htmlspecialchars($category16358); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16358); ?>">
                        ...
                        <!-- ASSET 16359 -->
                        <img src='../image.php?id=16359' style='width:18px; cursor:pointer; position:absolute; top:113px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16359' onclick='fetchAssetData(16359);' class="asset-image" data-id="<?php echo $assetId16359; ?>" data-room="<?php echo htmlspecialchars($room16359); ?>" data-floor="<?php echo htmlspecialchars($floor16359); ?>" data-image="<?php echo base64_encode($upload_img16359); ?>" data-status="<?php echo htmlspecialchars($status16359); ?>" data-category="<?php echo htmlspecialchars($category16359); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16359); ?>">
                        ...
                        <!-- ASSET 16360 -->
                        <img src='../image.php?id=16360' style='width:18px; cursor:pointer; position:absolute; top:126px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16360' onclick='fetchAssetData(16360);' class="asset-image" data-id="<?php echo $assetId16360; ?>" data-room="<?php echo htmlspecialchars($room16360); ?>" data-floor="<?php echo htmlspecialchars($floor16360); ?>" data-image="<?php echo base64_encode($upload_img16360); ?>" data-status="<?php echo htmlspecialchars($status16360); ?>" data-category="<?php echo htmlspecialchars($category16360); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16360); ?>">
                        ...
                        <!-- ASSET 16361 -->
                        <img src='../image.php?id=16361' style='width:18px; cursor:pointer; position:absolute; top:74px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16361' onclick='fetchAssetData(16361);' class="asset-image" data-id="<?php echo $assetId16361; ?>" data-room="<?php echo htmlspecialchars($room16361); ?>" data-floor="<?php echo htmlspecialchars($floor16361); ?>" data-image="<?php echo base64_encode($upload_img16361); ?>" data-status="<?php echo htmlspecialchars($status16361); ?>" data-category="<?php echo htmlspecialchars($category16361); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16361); ?>">
                        ...
                        <!-- ASSET 16362 -->
                        <img src='../image.php?id=16362' style='width:18px; cursor:pointer; position:absolute; top:87px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16362' onclick='fetchAssetData(16362);' class="asset-image" data-id="<?php echo $assetId16362; ?>" data-room="<?php echo htmlspecialchars($room16362); ?>" data-floor="<?php echo htmlspecialchars($floor16362); ?>" data-image="<?php echo base64_encode($upload_img16362); ?>" data-category="<?php echo htmlspecialchars($category16362); ?>" data-status="<?php echo htmlspecialchars($status16362); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16362); ?>">
                        ...
                        <!-- ASSET 16363 -->
                        <img src='../image.php?id=16363' style='width:18px; cursor:pointer; position:absolute; top:100px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16363' onclick='fetchAssetData(16363);' class="asset-image" data-id="<?php echo $assetId16363; ?>" data-room="<?php echo htmlspecialchars($room16363); ?>" data-floor="<?php echo htmlspecialchars($floor16363); ?>" data-image="<?php echo base64_encode($upload_img16363); ?>" data-status="<?php echo htmlspecialchars($status16363); ?>" data-category="<?php echo htmlspecialchars($category16363); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16363); ?>">
                        ...
                        <!-- ASSET 16364 -->
                        <img src='../image.php?id=16364' style='width:18px; cursor:pointer; position:absolute; top:113px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16364' onclick='fetchAssetData(16364);' class="asset-image" data-id="<?php echo $assetId16364; ?>" data-room="<?php echo htmlspecialchars($room16364); ?>" data-floor="<?php echo htmlspecialchars($floor16364); ?>" data-image="<?php echo base64_encode($upload_img16364); ?>" data-status="<?php echo htmlspecialchars($status16364); ?>" data-category="<?php echo htmlspecialchars($category16364); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16364); ?>">
                        ...
                        <!-- ASSET 16365 -->
                        <img src='../image.php?id=16365' style='width:18px; cursor:pointer; position:absolute; top:126px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16365' onclick='fetchAssetData(16365);' class="asset-image" data-id="<?php echo $assetId16365; ?>" data-room="<?php echo htmlspecialchars($room16365); ?>" data-floor="<?php echo htmlspecialchars($floor16365); ?>" data-image="<?php echo base64_encode($upload_img16365); ?>" data-status="<?php echo htmlspecialchars($status16365); ?>" data-category="<?php echo htmlspecialchars($category16365); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16365); ?>">
                        ...
                        <!-- ASSET 16366 -->
                        <img src='../image.php?id=16366' style='width:18px; cursor:pointer; position:absolute; top:74px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16366' onclick='fetchAssetData(16366);' class="asset-image" data-id="<?php echo $assetId16366; ?>" data-room="<?php echo htmlspecialchars($room16366); ?>" data-floor="<?php echo htmlspecialchars($floor16366); ?>" data-image="<?php echo base64_encode($upload_img16366); ?>" data-status="<?php echo htmlspecialchars($status16366); ?>" data-category="<?php echo htmlspecialchars($category16366); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16366); ?>">
                        ...
                        <!-- ASSET 16367 -->
                        <img src='../image.php?id=16367' style='width:18px; cursor:pointer; position:absolute; top:87px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16367' onclick='fetchAssetData(16367);' class="asset-image" data-id="<?php echo $assetId16367; ?>" data-room="<?php echo htmlspecialchars($room16367); ?>" data-floor="<?php echo htmlspecialchars($floor16367); ?>" data-image="<?php echo base64_encode($upload_img16367); ?>" data-status="<?php echo htmlspecialchars($status16367); ?>" data-category="<?php echo htmlspecialchars($category16367); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16367); ?>">
                        ...
                        <!-- ASSET 16368 -->
                        <img src='../image.php?id=16368' style='width:18px; cursor:pointer; position:absolute; top:100px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16368' onclick='fetchAssetData(16368);' class="asset-image" data-id="<?php echo $assetId16368; ?>" data-room="<?php echo htmlspecialchars($room16368); ?>" data-floor="<?php echo htmlspecialchars($floor16368); ?>" data-image="<?php echo base64_encode($upload_img16368); ?>" data-status="<?php echo htmlspecialchars($status16368); ?>" data-category="<?php echo htmlspecialchars($category16368); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16368); ?>">
                        ...
                        <!-- ASSET 16369 -->
                        <img src='../image.php?id=16369' style='width:18px; cursor:pointer; position:absolute; top:113px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16369' onclick='fetchAssetData(16369);' class="asset-image" data-id="<?php echo $assetId16369; ?>" data-room="<?php echo htmlspecialchars($room16369); ?>" data-floor="<?php echo htmlspecialchars($floor16369); ?>" data-image="<?php echo base64_encode($upload_img16369); ?>" data-status="<?php echo htmlspecialchars($status16369); ?>" data-category="<?php echo htmlspecialchars($category16369); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16369); ?>">
                        ...
                        <!-- ASSET 16370 -->
                        <img src='../image.php?id=16370' style='width:18px; cursor:pointer; position:absolute; top:126px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16370' onclick='fetchAssetData(16370);' class="asset-image" data-id="<?php echo $assetId16370; ?>" data-room="<?php echo htmlspecialchars($room16370); ?>" data-floor="<?php echo htmlspecialchars($floor16370); ?>" data-image="<?php echo base64_encode($upload_img16370); ?>" data-status="<?php echo htmlspecialchars($status16370); ?>" data-category="<?php echo htmlspecialchars($category16370); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16370); ?>">
                        ...
                        <!-- ASSET 16371 -->
                        <img src='../image.php?id=16371' style='width:18px; cursor:pointer; position:absolute; top:74px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16371' onclick='fetchAssetData(16371);' class="asset-image" data-id="<?php echo $assetId16371; ?>" data-room="<?php echo htmlspecialchars($room16371); ?>" data-floor="<?php echo htmlspecialchars($floor16371); ?>" data-image="<?php echo base64_encode($upload_img16371); ?>" data-status="<?php echo htmlspecialchars($status16371); ?>" data-category="<?php echo htmlspecialchars($category16371); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16371); ?>">
                        ...
                        <!-- ASSET 16372 -->
                        <img src='../image.php?id=16372' style='width:18px; cursor:pointer; position:absolute; top:87px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16372' onclick='fetchAssetData(16372);' class="asset-image" data-id="<?php echo $assetId16372; ?>" data-room="<?php echo htmlspecialchars($room16372); ?>" data-floor="<?php echo htmlspecialchars($floor16372); ?>" data-status="<?php echo htmlspecialchars($status16372); ?>" data-image="<?php echo base64_encode($upload_img16372); ?>" data-category="<?php echo htmlspecialchars($category16372); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16372); ?>">
                        ...
                        <!-- ASSET 16373 -->
                        <img src='../image.php?id=16373' style='width:18px; cursor:pointer; position:absolute; top:100px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16373' onclick='fetchAssetData(16373);' class="asset-image" data-id="<?php echo $assetId16373; ?>" data-room="<?php echo htmlspecialchars($room16373); ?>" data-floor="<?php echo htmlspecialchars($floor16373); ?>" data-image="<?php echo base64_encode($upload_img16373); ?>" data-status="<?php echo htmlspecialchars($status16373); ?>" data-category="<?php echo htmlspecialchars($category16373); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16373); ?>">
                        ...
                        <!-- ASSET 16374 -->
                        <img src='../image.php?id=16374' style='width:18px; cursor:pointer; position:absolute; top:113px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16374' onclick='fetchAssetData(16374);' class="asset-image" data-id="<?php echo $assetId16374; ?>" data-room="<?php echo htmlspecialchars($room16374); ?>" data-floor="<?php echo htmlspecialchars($floor16374); ?>" data-image="<?php echo base64_encode($upload_img16374); ?>" data-status="<?php echo htmlspecialchars($status16374); ?>" data-category="<?php echo htmlspecialchars($category16374); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16374); ?>">
                        ...
                        <!-- ASSET 16375 -->
                        <img src='../image.php?id=16375' style='width:18px; cursor:pointer; position:absolute; top:127px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16375' onclick='fetchAssetData(16375);' class="asset-image" data-id="<?php echo $assetId16375; ?>" data-room="<?php echo htmlspecialchars($room16375); ?>" data-floor="<?php echo htmlspecialchars($floor16375); ?>" data-image="<?php echo base64_encode($upload_img16375); ?>" data-status="<?php echo htmlspecialchars($status16375); ?>" data-category="<?php echo htmlspecialchars($category16375); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16375); ?>">
                        ...
                        <!-- ASSET 16376 -->
                        <img src='../image.php?id=16376' style='width:18px; cursor:pointer; position:absolute; top:74px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16376' onclick='fetchAssetData(16376);' class="asset-image" data-id="<?php echo $assetId16376; ?>" data-room="<?php echo htmlspecialchars($room16376); ?>" data-floor="<?php echo htmlspecialchars($floor16376); ?>" data-image="<?php echo base64_encode($upload_img16376); ?>" data-status="<?php echo htmlspecialchars($status16376); ?>" data-category="<?php echo htmlspecialchars($category16376); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16376); ?>">
                        ...
                        <!-- ASSET 16377 -->
                        <img src='../image.php?id=16377' style='width:18px; cursor:pointer; position:absolute; top:87px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16377' onclick='fetchAssetData(16377);' class="asset-image" data-id="<?php echo $assetId16377; ?>" data-room="<?php echo htmlspecialchars($room16377); ?>" data-floor="<?php echo htmlspecialchars($floor16377); ?>" data-image="<?php echo base64_encode($upload_img16377); ?>" data-status="<?php echo htmlspecialchars($status16377); ?>" data-category="<?php echo htmlspecialchars($category16377); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16377); ?>">
                        ...
                        <!-- ASSET 16378 -->
                        <img src='../image.php?id=16378' style='width:18px; cursor:pointer; position:absolute; top:100px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16378' onclick='fetchAssetData(16378);' class="asset-image" data-id="<?php echo $assetId16378; ?>" data-room="<?php echo htmlspecialchars($room16378); ?>" data-floor="<?php echo htmlspecialchars($floor16378); ?>" data-image="<?php echo base64_encode($upload_img16378); ?>" data-status="<?php echo htmlspecialchars($status16378); ?>" data-category="<?php echo htmlspecialchars($category16378); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16378); ?>">
                        ...
                        <!-- ASSET 16379 -->
                        <img src='../image.php?id=16379' style='width:18px; cursor:pointer; position:absolute; top:113px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16379' onclick='fetchAssetData(16379);' class="asset-image" data-id="<?php echo $assetId16379; ?>" data-room="<?php echo htmlspecialchars($room16379); ?>" data-floor="<?php echo htmlspecialchars($floor16379); ?>" data-image="<?php echo base64_encode($upload_img16379); ?>" data-status="<?php echo htmlspecialchars($status16379); ?>" data-category="<?php echo htmlspecialchars($category16379); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16379); ?>">
                        ...
                        <!-- ASSET 16380 -->
                        <img src='../image.php?id=16380' style='width:18px; cursor:pointer; position:absolute; top:126px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16380' onclick='fetchAssetData(16380);' class="asset-image" data-id="<?php echo $assetId16380; ?>" data-room="<?php echo htmlspecialchars($room16380); ?>" data-floor="<?php echo htmlspecialchars($floor16380); ?>" data-image="<?php echo base64_encode($upload_img16380); ?>" data-status="<?php echo htmlspecialchars($status16380); ?>" data-category="<?php echo htmlspecialchars($category16380); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16380); ?>">
                        ...
                        <!-- ASSET 16381 -->
                        <img src='../image.php?id=16381' style='width:18px; cursor:pointer; position:absolute; top:155px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16381' onclick='fetchAssetData(16381);' class="asset-image" data-id="<?php echo $assetId16381; ?>" data-room="<?php echo htmlspecialchars($room16381); ?>" data-floor="<?php echo htmlspecialchars($floor16381); ?>" data-image="<?php echo base64_encode($upload_img16381); ?>" data-status="<?php echo htmlspecialchars($status16381); ?>" data-category="<?php echo htmlspecialchars($category16381); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16381); ?>">
                        ...
                        <!-- ASSET 16382 -->
                        <img src='../image.php?id=16382' style='width:18px; cursor:pointer; position:absolute; top:167px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16382' onclick='fetchAssetData(16382);' class="asset-image" data-id="<?php echo $assetId16382; ?>" data-room="<?php echo htmlspecialchars($room16382); ?>" data-floor="<?php echo htmlspecialchars($floor16382); ?>" data-image="<?php echo base64_encode($upload_img16382); ?>" data-status="<?php echo htmlspecialchars($status16382); ?>" data-category="<?php echo htmlspecialchars($category16382); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16382); ?>">
                        ...
                        <!-- ASSET 16383 -->
                        <img src='../image.php?id=16383' style='width:18px; cursor:pointer; position:absolute; top:179px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16383' onclick='fetchAssetData(16383);' class="asset-image" data-id="<?php echo $assetId16383; ?>" data-room="<?php echo htmlspecialchars($room16383); ?>" data-floor="<?php echo htmlspecialchars($floor16383); ?>" data-image="<?php echo base64_encode($upload_img16383); ?>" data-status="<?php echo htmlspecialchars($status16383); ?>" data-category="<?php echo htmlspecialchars($category16383); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16383); ?>">
                        ...
                        <!-- ASSET 16384 -->
                        <img src='../image.php?id=16384' style='width:18px; cursor:pointer; position:absolute; top:191px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16384' onclick='fetchAssetData(16384);' class="asset-image" data-id="<?php echo $assetId16384; ?>" data-room="<?php echo htmlspecialchars($room16384); ?>" data-floor="<?php echo htmlspecialchars($floor16384); ?>" data-image="<?php echo base64_encode($upload_img16384); ?>" data-category="<?php echo htmlspecialchars($category16384); ?>" data-status="<?php echo htmlspecialchars($status16384); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16384); ?>">
                        ...
                        <!-- ASSET 16385 -->
                        <img src='../image.php?id=16385' style='width:18px; cursor:pointer; position:absolute; top:203px; left:505px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16385' onclick='fetchAssetData(16385);' class="asset-image" data-id="<?php echo $assetId16385; ?>" data-room="<?php echo htmlspecialchars($room16385); ?>" data-floor="<?php echo htmlspecialchars($floor16385); ?>" data-image="<?php echo base64_encode($upload_img16385); ?>" data-status="<?php echo htmlspecialchars($status16385); ?>" data-category="<?php echo htmlspecialchars($category16385); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16385); ?>">
                        ...
                        <!-- ASSET 16386 -->
                        <img src='../image.php?id=16386' style='width:18px; cursor:pointer; position:absolute; top:155px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16386' onclick='fetchAssetData(16386);' class="asset-image" data-id="<?php echo $assetId16386; ?>" data-room="<?php echo htmlspecialchars($room16386); ?>" data-floor="<?php echo htmlspecialchars($floor16386); ?>" data-image="<?php echo base64_encode($upload_img16386); ?>" data-status="<?php echo htmlspecialchars($status16386); ?>" data-category="<?php echo htmlspecialchars($category16386); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16386); ?>">
                        ...
                        <!-- ASSET 16387 -->
                        <img src='../image.php?id=16387' style='width:18px; cursor:pointer; position:absolute; top:167px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16387' onclick='fetchAssetData(16387);' class="asset-image" data-id="<?php echo $assetId16387; ?>" data-room="<?php echo htmlspecialchars($room16387); ?>" data-floor="<?php echo htmlspecialchars($floor16387); ?>" data-image="<?php echo base64_encode($upload_img16387); ?>" data-category="<?php echo htmlspecialchars($category16387); ?>" data-status="<?php echo htmlspecialchars($status16387); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16387); ?>">
                        ...
                        <!-- ASSET 16388 -->
                        <img src='../image.php?id=16388' style='width:18px; cursor:pointer; position:absolute; top:179px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16388' onclick='fetchAssetData(16388);' class="asset-image" data-id="<?php echo $assetId16388; ?>" data-room="<?php echo htmlspecialchars($room16388); ?>" data-floor="<?php echo htmlspecialchars($floor16388); ?>" data-image="<?php echo base64_encode($upload_img16388); ?>" data-status="<?php echo htmlspecialchars($status16388); ?>" data-category="<?php echo htmlspecialchars($category16388); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16388); ?>">
                        ...
                        <!-- ASSET 16389 -->
                        <img src='../image.php?id=16389' style='width:18px; cursor:pointer; position:absolute; top:191px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16389' onclick='fetchAssetData(16389);' class="asset-image" data-id="<?php echo $assetId16389; ?>" data-room="<?php echo htmlspecialchars($room16389); ?>" data-floor="<?php echo htmlspecialchars($floor16389); ?>" data-image="<?php echo base64_encode($upload_img16389); ?>" data-category="<?php echo htmlspecialchars($category16389); ?>" data-status="<?php echo htmlspecialchars($status16389); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16389); ?>">
                        ...
                        <!-- ASSET 16390 -->
                        <img src='../image.php?id=16390' style='width:18px; cursor:pointer; position:absolute; top:203px; left:528px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16390' onclick='fetchAssetData(16390);' class="asset-image" data-id="<?php echo $assetId16390; ?>" data-room="<?php echo htmlspecialchars($room16390); ?>" data-floor="<?php echo htmlspecialchars($floor16390); ?>" data-image="<?php echo base64_encode($upload_img16390); ?>" data-category="<?php echo htmlspecialchars($category16390); ?>" data-status="<?php echo htmlspecialchars($status16390); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16390); ?>">
                        ...
                        <!-- ASSET 16391 -->
                        <img src='../image.php?id=16391' style='width:18px; cursor:pointer; position:absolute; top:155px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16391' onclick='fetchAssetData(16391);' class="asset-image" data-id="<?php echo $assetId16391; ?>" data-room="<?php echo htmlspecialchars($room16391); ?>" data-floor="<?php echo htmlspecialchars($floor16391); ?>" data-image="<?php echo base64_encode($upload_img16391); ?>" data-category="<?php echo htmlspecialchars($category16391); ?>" data-status="<?php echo htmlspecialchars($status16391); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16391); ?>">
                        ...
                        <!-- ASSET 16392 -->
                        <img src='../image.php?id=16392' style='width:18px; cursor:pointer; position:absolute; top:167px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16392' onclick='fetchAssetData(16392);' class="asset-image" data-id="<?php echo $assetId16392; ?>" data-room="<?php echo htmlspecialchars($room16392); ?>" data-floor="<?php echo htmlspecialchars($floor16392); ?>" data-image="<?php echo base64_encode($upload_img16392); ?>" data-category="<?php echo htmlspecialchars($category16392); ?>" data-status="<?php echo htmlspecialchars($status16392); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16392); ?>">
                        ...
                        <!-- ASSET 16393 -->
                        <img src='../image.php?id=16393' style='width:18px; cursor:pointer; position:absolute; top:179px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16393' onclick='fetchAssetData(16393);' class="asset-image" data-id="<?php echo $assetId16393; ?>" data-room="<?php echo htmlspecialchars($room16393); ?>" data-floor="<?php echo htmlspecialchars($floor16393); ?>" data-image="<?php echo base64_encode($upload_img16393); ?>" data-category="<?php echo htmlspecialchars($category16393); ?>" data-status="<?php echo htmlspecialchars($status16393); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16393); ?>">
                        ...
                        <!-- ASSET 16394 -->
                        <img src='../image.php?id=16394' style='width:18px; cursor:pointer; position:absolute; top:191px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16394' onclick='fetchAssetData(16394);' class="asset-image" data-id="<?php echo $assetId16394; ?>" data-room="<?php echo htmlspecialchars($room16394); ?>" data-floor="<?php echo htmlspecialchars($floor16394); ?>" data-image="<?php echo base64_encode($upload_img16394); ?>" data-category="<?php echo htmlspecialchars($category16394); ?>" data-status="<?php echo htmlspecialchars($status16394); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16394); ?>">
                        ...
                        <!-- ASSET 16395 -->
                        <img src='../image.php?id=16395' style='width:18px; cursor:pointer; position:absolute; top:203px; left:551px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16395' onclick='fetchAssetData(16395);' class="asset-image" data-id="<?php echo $assetId16395; ?>" data-room="<?php echo htmlspecialchars($room16395); ?>" data-floor="<?php echo htmlspecialchars($floor16395); ?>" data-image="<?php echo base64_encode($upload_img16395); ?>" data-status="<?php echo htmlspecialchars($status16395); ?>" data-category="<?php echo htmlspecialchars($category16395); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16395); ?>">
                        ...
                        <!-- ASSET 16396 -->
                        <img src='../image.php?id=16396' style='width:18px; cursor:pointer; position:absolute; top:155px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16396' onclick='fetchAssetData(16396);' class="asset-image" data-id="<?php echo $assetId16396; ?>" data-room="<?php echo htmlspecialchars($room16396); ?>" data-floor="<?php echo htmlspecialchars($floor16396); ?>" data-image="<?php echo base64_encode($upload_img16396); ?>" data-status="<?php echo htmlspecialchars($status16396); ?>" data-category="<?php echo htmlspecialchars($category16396); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16396); ?>">
                        ...
                        <!-- ASSET 16397 -->
                        <img src='../image.php?id=16397' style='width:18px; cursor:pointer; position:absolute; top:167px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16397' onclick='fetchAssetData(16397);' class="asset-image" data-id="<?php echo $assetId16397; ?>" data-room="<?php echo htmlspecialchars($room16397); ?>" data-floor="<?php echo htmlspecialchars($floor16397); ?>" data-image="<?php echo base64_encode($upload_img16397); ?>" data-category="<?php echo htmlspecialchars($category16397); ?>" data-status="<?php echo htmlspecialchars($status16397); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16397); ?>">
                        ...
                        <!-- ASSET 16398 -->
                        <img src='../image.php?id=16398' style='width:18px; cursor:pointer; position:absolute; top:179px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16398' onclick='fetchAssetData(16398);' class="asset-image" data-id="<?php echo $assetId16398; ?>" data-room="<?php echo htmlspecialchars($room16398); ?>" data-floor="<?php echo htmlspecialchars($floor16398); ?>" data-image="<?php echo base64_encode($upload_img16398); ?>" data-status="<?php echo htmlspecialchars($status16398); ?>" data-category="<?php echo htmlspecialchars($category16398); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16398); ?>">
                        ...
                        <!-- ASSET 16399 -->
                        <img src='../image.php?id=16399' style='width:18px; cursor:pointer; position:absolute; top:191px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16399' onclick='fetchAssetData(16399);' class="asset-image" data-id="<?php echo $assetId16399; ?>" data-room="<?php echo htmlspecialchars($room16399); ?>" data-floor="<?php echo htmlspecialchars($floor16399); ?>" data-image="<?php echo base64_encode($upload_img16399); ?>" data-status="<?php echo htmlspecialchars($status16399); ?>" data-category="<?php echo htmlspecialchars($category16399); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16399); ?>">
                        ...
                        <!-- ASSET 16400 -->
                        <img src='../image.php?id=16400' style='width:18px; cursor:pointer; position:absolute; top:203px; left:574px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16400' onclick='fetchAssetData(16400);' class="asset-image" data-id="<?php echo $assetId16400; ?>" data-room="<?php echo htmlspecialchars($room16400); ?>" data-floor="<?php echo htmlspecialchars($floor16400); ?>" data-status="<?php echo htmlspecialchars($status16400); ?>" data-image="<?php echo base64_encode($upload_img16400); ?>" data-category="<?php echo htmlspecialchars($category16400); ?>">
                        ...
                        <!-- ASSET 16401 -->
                        <img src='../image.php?id=16401' style='width:18px; cursor:pointer; position:absolute; top:155px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16401' onclick='fetchAssetData(16401);' class="asset-image" data-id="<?php echo $assetId16401; ?>" data-room="<?php echo htmlspecialchars($room16401); ?>" data-floor="<?php echo htmlspecialchars($floor16401); ?>" data-image="<?php echo base64_encode($upload_img16401); ?>" data-status="<?php echo htmlspecialchars($status16401); ?>" data-category="<?php echo htmlspecialchars($category16401); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16401); ?>">
                    ...
                    position:absolute; top:159px; left:610px;'>
                        ...
                        <!-- ASSET 16402 -->
                        <img src='../image.php?id=16402' style='width:18px; cursor:pointer; position:absolute; top:167px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16402' onclick='fetchAssetData(16402);' class="asset-image" data-id="<?php echo $assetId16402; ?>" data-room="<?php echo htmlspecialchars($room16402); ?>" data-floor="<?php echo htmlspecialchars($floor16402); ?>" data-image="<?php echo base64_encode($upload_img16402); ?>" data-status="<?php echo htmlspecialchars($status16402); ?>" data-category="<?php echo htmlspecialchars($category16402); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16402); ?>">
                        ...
                        <!-- ASSET 16403 -->
                        <img src='../image.php?id=16403' style='width:18px; cursor:pointer; position:absolute; top:179px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16403' onclick='fetchAssetData(16403);' class="asset-image" data-id="<?php echo $assetId16403; ?>" data-room="<?php echo htmlspecialchars($room16403); ?>" data-floor="<?php echo htmlspecialchars($floor16403); ?>" data-status="<?php echo htmlspecialchars($status16403); ?>" data-image="<?php echo base64_encode($upload_img16403); ?>" data-category="<?php echo htmlspecialchars($category16403); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16403); ?>">
                        ...
                        <!-- ASSET 16404 -->
                        <img src='../image.php?id=16404' style='width:18px; cursor:pointer; position:absolute; top:191px; left:597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16404' onclick='fetchAssetData(16404);' class="asset-image" data-id="<?php echo $assetId16404; ?>" data-room="<?php echo htmlspecialchars($room16404); ?>" data-floor="<?php echo htmlspecialchars($floor16404); ?>" data-image="<?php echo base64_encode($upload_img16404); ?>" data-category="<?php echo htmlspecialchars($category16404); ?>" data-status="<?php echo htmlspecialchars($status16404); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16404); ?>">
                        ...
                        <!-- ASSET 16405 -->
                        <img src='../image.php?id=16405' style='width:18px; cursor:pointer; position:absolute; top:203px; left: 597px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16405' onclick='fetchAssetData(16405);' class="asset-image" data-id="<?php echo $assetId16405; ?>" data-room="<?php echo htmlspecialchars($room16405); ?>" data-floor="<?php echo htmlspecialchars($floor16405); ?>" data-image="<?php echo base64_encode($upload_img16405); ?>" data-category="<?php echo htmlspecialchars($category16405); ?>" data-status="<?php echo htmlspecialchars($status16405); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16405); ?>">
...
position:absolute; top:142px; left:700px;'>
                        ...
                        <!-- ASSET 16407 -->
                        <img src='../image.php?id=16407' style='width:15px; cursor:pointer; position:absolute; top:143px; left: 698px;' alt='Asset Image' data-bs-toggle='modal' data-bs-target='#imageModal16407' onclick='fetchAssetData(16407);' class="asset-image" data-id="<?php echo $assetId16407; ?>" data-room="<?php echo htmlspecialchars($room16407); ?>" data-floor="<?php echo htmlspecialchars($floor16407); ?>" data-image="<?php echo base64_encode($upload_img16407); ?>" data-category="<?php echo htmlspecialchars($category16407); ?>" data-status="<?php echo htmlspecialchars($status16407); ?>" data-assignedname="<?php echo htmlspecialchars($assignedName16407); ?>">
