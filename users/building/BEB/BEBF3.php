            ...
            <div class="content-container" id="content-container">
                <div id="belmonte-F1" class="content">
                    ...
                    <img src='../image.php?id=15926'
                        style='width:18px; cursor:pointer; position:absolute; top:74px; left:505px;' alt='...'
                    ...
                    <img src='../image.php?id=15927'
                        style='width:18px; cursor:pointer; position:absolute; top:87px; left:505px;' alt='...'
                    ...
                    <img src='../image.php?id=15928'
                        style='width:18px; cursor:pointer; position:absolute; top:100px; left:505px;' alt='...'
                    ...
                    <!-- ASSET 15929 -->
                    <img src='../image.php?id=15929'
                        style='width:18px; cursor:pointer; position:absolute; top:113px; left:505px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15929' onclick='fetchAssetData(15929);'
                        class="asset-image" data-id="<?php echo $assetId15929; ?>"
                        data-room="<?php echo htmlspecialchars($room15929); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15929); ?>"
                        data-image="<?php echo base64_encode($upload_img15929); ?>"
                        data-status="<?php echo htmlspecialchars($status15929); ?>"
                        data-category="<?php echo htmlspecialchars($category15929); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15929); ?>">
                    ...
                    <!-- ASSET 15930 -->
                    <img src='../image.php?id=15930'
                        style='width:18px; cursor:pointer; position:absolute; top:126px; left:505px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15930' onclick='fetchAssetData(15930);'
                        class="asset-image" data-id="<?php echo $assetId15930; ?>"
                        data-room="<?php echo htmlspecialchars($room15930); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15930); ?>"
                        data-image="<?php echo base64_encode($upload_img15930); ?>"
                        data-status="<?php echo htmlspecialchars($status15930); ?>"
                        data-category="<?php echo htmlspecialchars($category15930); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15930); ?>">
                    ...
                    <!-- ASSET 15931 -->
                    <img src='../image.php?id=15931'
                        style='width:18px; cursor:pointer; position:absolute; top:74px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15931' onclick='fetchAssetData(15931);'
                        class="asset-image" data-id="<?php echo $assetId15931; ?>"
                        data-room="<?php echo htmlspecialchars($room15931); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15931); ?>"
                        data-image="<?php echo base64_encode($upload_img15931); ?>"
                        data-status="<?php echo htmlspecialchars($status15931); ?>"
                        data-category="<?php echo htmlspecialchars($category15931); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15931); ?>">
                    ...
                    <!-- ASSET 15932 -->
                    <img src='../image.php?id=15932'
                        style='width:18px; cursor:pointer; position:absolute; top:87px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15932' onclick='fetchAssetData(15932);'
                        class="asset-image" data-id="<?php echo $assetId15932; ?>"
                        data-room="<?php echo htmlspecialchars($room15932); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15932); ?>"
                        data-image="<?php echo base64_encode($upload_img15932); ?>"
                        data-category="<?php echo htmlspecialchars($category15932); ?>"
                        data-status="<?php echo htmlspecialchars($status15932); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15932); ?>">
                    ...
                    <img src='../image.php?id=15933'
                        style='width:18px; cursor:pointer; position:absolute; top:100px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15933' onclick='fetchAssetData(15933);'
                        class="asset-image" data-id="<?php echo $assetId15933; ?>"
                        data-room="<?php echo htmlspecialchars($room15933); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15933); ?>"
                        data-image="<?php echo base64_encode($upload_img15933); ?>"
                        data-status="<?php echo htmlspecialchars($status15933); ?>"
                        data-category="<?php echo htmlspecialchars($category15933); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15933); ?>">
                    ...
                    <!-- ASSET 15934 -->
                    <img src='../image.php?id=15934'
                        style='width:18px; cursor:pointer; position:absolute; top:113px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15934' onclick='fetchAssetData(15934);'
                        class="asset-image" data-id="<?php echo $assetId15934; ?>"
                        data-room="<?php echo htmlspecialchars($room15934); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15934); ?>"
                        data-image="<?php echo base64_encode($upload_img15934); ?>"
                        data-status="<?php echo htmlspecialchars($status15934); ?>"
                        data-category="<?php echo htmlspecialchars($category15934); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15934); ?>">
                    ...
                    <!-- ASSET 15935 -->
                    <img src='../image.php?id=15935'
                        style='width:18px; cursor:pointer; position:absolute; top:126px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15935' onclick='fetchAssetData(15935);'
                        class="asset-image" data-id="<?php echo $assetId15935; ?>"
                        data-room="<?php echo htmlspecialchars($room15935); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15935); ?>"
                        data-image="<?php echo base64_encode($upload_img15935); ?>"
                        data-status="<?php echo htmlspecialchars($status15935); ?>"
                        data-category="<?php echo htmlspecialchars($category15935); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15935); ?>">
                    ...
                    <!-- ASSET 15936 -->
                    <img src='../image.php?id=15936'
                        style='width:18px; cursor:pointer; position:absolute; top:74px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15936' onclick='fetchAssetData(15936);'
                        class="asset-image" data-id="<?php echo $assetId15936; ?>"
                        data-room="<?php echo htmlspecialchars($room15936); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15936); ?>"
                        data-image="<?php echo base64_encode($upload_img15936); ?>"
                        data-status="<?php echo htmlspecialchars($status15936); ?>"
                        data-category="<?php echo htmlspecialchars($category15936); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15936); ?>">
                    ...
                    <!-- ASSET 15937 -->
                    <img src='../image.php?id=15937'
                        style='width:18px; cursor:pointer; position:absolute; top:87px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15937' onclick='fetchAssetData(15937);'
                        class="asset-image" data-id="<?php echo $assetId15937; ?>"
                        data-room="<?php echo htmlspecialchars($room15937); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15937); ?>"
                        data-image="<?php echo base64_encode($upload_img15937); ?>"
                        data-status="<?php echo htmlspecialchars($status15937); ?>"
                        data-category="<?php echo htmlspecialchars($category15937); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15937); ?>">
                    ...
                    <!-- ASSET 15938 -->
                    <img src='../image.php?id=15938'
                        style='width:18px; cursor:pointer; position:absolute; top:100px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15938' onclick='fetchAssetData(15938);'
                        class="asset-image" data-id="<?php echo $assetId15938; ?>"
                        data-room="<?php echo htmlspecialchars($room15938); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15938); ?>"
                        data-image="<?php echo base64_encode($upload_img15938); ?>"
                        data-status="<?php echo htmlspecialchars($status15938); ?>"
                        data-category="<?php echo htmlspecialchars($category15938); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15938); ?>">
                    ...
                    <!-- ASSET 15939 -->
                    <img src='../image.php?id=15939'
                        style='width:18px; cursor:pointer; position:absolute; top:113px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15939' onclick='fetchAssetData(15939);'
                        class="asset-image" data-id="<?php echo $assetId15939; ?>"
                        data-room="<?php echo htmlspecialchars($room15939); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15939); ?>"
                        data-image="<?php echo base64_encode($upload_img15939); ?>"
                        data-status="<?php echo htmlspecialchars($status15939); ?>"
                        data-category="<?php echo htmlspecialchars($category15939); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15939); ?>">
                    ...
                    <!-- ASSET 15940 -->
                    <img src='../image.php?id=15940'
                        style='width:18px; cursor:pointer; position:absolute; top:126px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15940' onclick='fetchAssetData(15940);'
                        class="asset-image" data-id="<?php echo $assetId15940; ?>"
                        data-room="<?php echo htmlspecialchars($room15940); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15940); ?>"
                        data-image="<?php echo base64_encode($upload_img15940); ?>"
                        data-status="<?php echo htmlspecialchars($status15940); ?>"
                        data-category="<?php echo htmlspecialchars($category15940); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15940); ?>">
                    ...
                    <!-- ASSET 15941 -->
                    <img src='../image.php?id=15941'
                        style='width:18px; cursor:pointer; position:absolute; top:74px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15941' onclick='fetchAssetData(15941);'
                        class="asset-image" data-id="<?php echo $assetId15941; ?>"
                        data-room="<?php echo htmlspecialchars($room15941); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15941); ?>"
                        data-image="<?php echo base64_encode($upload_img15941); ?>"
                        data-status="<?php echo htmlspecialchars($status15941); ?>"
                        data-category="<?php echo htmlspecialchars($category15941); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15941); ?>">
                    ...
                    <!-- ASSET 15942 -->
                    <img src='../image.php?id=15942'
                        style='width:18px; cursor:pointer; position:absolute; top:87px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15942' onclick='fetchAssetData(15942);'
                        class="asset-image" data-id="<?php echo $assetId15942; ?>"
                        data-room="<?php echo htmlspecialchars($room15942); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15942); ?>"
                        data-status="<?php echo htmlspecialchars($status15942); ?>"
                        data-image="<?php echo base64_encode($upload_img15942); ?>"
                        data-category="<?php echo htmlspecialchars($category15942); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15942); ?>">
                    ...
                    <!-- ASSET 15943 -->
                    <img src='../image.php?id=15943'
                        style='width:18px; cursor:pointer; position:absolute; top:100px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15943' onclick='fetchAssetData(15943);'
                        class="asset-image" data-id="<?php echo $assetId15943; ?>"
                        data-room="<?php echo htmlspecialchars($room15943); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15943); ?>"
                        data-image="<?php echo base64_encode($upload_img15943); ?>"
                        data-status="<?php echo htmlspecialchars($status15943); ?>"
                        data-category="<?php echo htmlspecialchars($category15943); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15943); ?>">
                    ...
                    <img src='../image.php?id=15944'
                        style='width:18px; cursor:pointer; position:absolute; top:113px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15944' onclick='fetchAssetData(15944);'
                        class="asset-image" data-id="<?php echo $assetId15944; ?>"
                        data-room="<?php echo htmlspecialchars($room15944); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15944); ?>"
                        data-image="<?php echo base64_encode($upload_img15944); ?>"
                        data-status="<?php echo htmlspecialchars($status15944); ?>"
                        data-category="<?php echo htmlspecialchars($category15944); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15944); ?>">
                    ...
                    <!-- ASSET 15945 -->
                    <img src='../image.php?id=15945'
                        style='width:18px; cursor:pointer; position:absolute; top:127px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15945' onclick='fetchAssetData(15945);'
                        class="asset-image" data-id="<?php echo $assetId15945; ?>"
                        data-room="<?php echo htmlspecialchars($room15945); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15945); ?>"
                        data-image="<?php echo base64_encode($upload_img15945); ?>"
                        data-status="<?php echo htmlspecialchars($status15945); ?>"
                        data-category="<?php echo htmlspecialchars($category15945); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15945); ?>">
                    ...
                    <!-- ASSET 15946 -->
                    <img src='../image.php?id=15946'
                        style='width:18px; cursor:pointer; position:absolute; top:74px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15946' onclick='fetchAssetData(15946);'
                        class="asset-image" data-id="<?php echo $assetId15946; ?>"
                        data-room="<?php echo htmlspecialchars($room15946); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15946); ?>"
                        data-image="<?php echo base64_encode($upload_img15946); ?>"
                        data-status="<?php echo htmlspecialchars($status15946); ?>"
                        data-category="<?php echo htmlspecialchars($category15946); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15946); ?>">
                    ...
                    <!-- ASSET 15947 -->
                    <img src='../image.php?id=15947'
                        style='width:18px; cursor:pointer; position:absolute; top:87px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15947' onclick='fetchAssetData(15947);'
                        class="asset-image" data-id="<?php echo $assetId15947; ?>"
                        data-room="<?php echo htmlspecialchars($room15947); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15947); ?>"
                        data-image="<?php echo base64_encode($upload_img15947); ?>"
                        data-status="<?php echo htmlspecialchars($status15947); ?>"
                        data-category="<?php echo htmlspecialchars($category15947); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15947); ?>">
                    ...
                    <!-- ASSET 15948 -->
                    <img src='../image.php?id=15948'
                        style='width:18px; cursor:pointer; position:absolute; top:100px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15948' onclick='fetchAssetData(15948);'
                        class="asset-image" data-id="<?php echo $assetId15948; ?>"
                        data-room="<?php echo htmlspecialchars($room15948); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15948); ?>"
                        data-image="<?php echo base64_encode($upload_img15948); ?>"
                        data-status="<?php echo htmlspecialchars($status15948); ?>"
                        data-category="<?php echo htmlspecialchars($category15948); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15948); ?>">
                    ...
                    <!-- ASSET 15949 -->
                    <img src='../image.php?id=15949'
                        style='width:18px; cursor:pointer; position:absolute; top:113px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15949' onclick='fetchAssetData(15949);'
                        class="asset-image" data-id="<?php echo $assetId15949; ?>"
                        data-room="<?php echo htmlspecialchars($room15949); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15949); ?>"
                        data-image="<?php echo base64_encode($upload_img15949); ?>"
                        data-status="<?php echo htmlspecialchars($status15949); ?>"
                        data-category="<?php echo htmlspecialchars($category15949); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15949); ?>">
                    ...
                    <!-- ASSET 15950 -->
                    <img src='../image.php?id=15950'
                        style='width:18px; cursor:pointer; position:absolute; top:126px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15950' onclick='fetchAssetData(15950);'
                        class="asset-image" data-id="<?php echo $assetId15950; ?>"
                        data-room="<?php echo htmlspecialchars($room15950); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15950); ?>"
                        data-image="<?php echo base64_encode($upload_img15950); ?>"
                        data-status="<?php echo htmlspecialchars($status15950); ?>"
                        data-category="<?php echo htmlspecialchars($category15950); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15950); ?>">
                    ...
                    <!-- ASSET 15951 -->
                    <img src='../image.php?id=15951'
                        style='width:18px; cursor:pointer; position:absolute; top:155px; left:505px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15951' onclick='fetchAssetData(15951);'
                        class="asset-image" data-id="<?php echo $assetId15951; ?>"
                        data-room="<?php echo htmlspecialchars($room15951); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15951); ?>"
                        data-image="<?php echo base64_encode($upload_img15951); ?>"
                        data-status="<?php echo htmlspecialchars($status15951); ?>"
                        data-category="<?php echo htmlspecialchars($category15951); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15951); ?>">
                    ...
                    <!-- ASSET 15952 -->
                    <img src='../image.php?id=15952'
                        style='width:18px; cursor:pointer; position:absolute; top:167px; left:505px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15952' onclick='fetchAssetData(15952);'
                        class="asset-image" data-id="<?php echo $assetId15952; ?>"
                        data-room="<?php echo htmlspecialchars($room15952); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15952); ?>"
                        data-image="<?php echo base64_encode($upload_img15952); ?>"
                        data-status="<?php echo htmlspecialchars($status15952); ?>"
                        data-category="<?php echo htmlspecialchars($category15952); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15952); ?>">
                    ...
                    <!-- ASSET 15953 -->
                    <img src='../image.php?id=15953'
                        style='width:18px; cursor:pointer; position:absolute; top:179px; left:505px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15953' onclick='fetchAssetData(15953);'
                        class="asset-image" data-id="<?php echo $assetId15953; ?>"
                        data-room="<?php echo htmlspecialchars($room15953); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15953); ?>"
                        data-image="<?php echo base64_encode($upload_img15953); ?>"
                        data-status="<?php echo htmlspecialchars($status15953); ?>"
                        data-category="<?php echo htmlspecialchars($category15953); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15953); ?>">
                    ...
                    <!-- ASSET 15954 -->
                    <img src='../image.php?id=15954'
                        style='width:18px; cursor:pointer; position:absolute; top:191px; left:505px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15954' onclick='fetchAssetData(15954);'
                        class="asset-image" data-id="<?php echo $assetId15954; ?>"
                        data-room="<?php echo htmlspecialchars($room15954); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15954); ?>"
                        data-image="<?php echo base64_encode($upload_img15954); ?>"
                        data-category="<?php echo htmlspecialchars($category15954); ?>"
                        data-status="<?php echo htmlspecialchars($status15954); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15954); ?>">
                    ...
                    <!-- ASSET 15955 -->
                    <img src='../image.php?id=15955'
                        style='width:18px; cursor:pointer; position:absolute; top:203px; left:505px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15955' onclick='fetchAssetData(15955);'
                        class="asset-image" data-id="<?php echo $assetId15955; ?>"
                        data-room="<?php echo htmlspecialchars($room15955); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15955); ?>"
                        data-image="<?php echo base64_encode($upload_img15955); ?>"
                        data-status="<?php echo htmlspecialchars($status15955); ?>"
                        data-category="<?php echo htmlspecialchars($category15955); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15955); ?>">
                    ...
                    <!-- ASSET 15956 -->
                    <img src='../image.php?id=15956'
                        style='width:18px; cursor:pointer; position:absolute; top:155px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15956' onclick='fetchAssetData(15956);'
                        class="asset-image" data-id="<?php echo $assetId15956; ?>"
                        data-room="<?php echo htmlspecialchars($room15956); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15956); ?>"
                        data-image="<?php echo base64_encode($upload_img15956); ?>"
                        data-status="<?php echo htmlspecialchars($status15956); ?>"
                        data-category="<?php echo htmlspecialchars($category15956); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15956); ?>">
                    ...
                    <!-- ASSET 15957 -->
                    <img src='../image.php?id=15957'
                    style='width:18px; cursor:pointer; position:absolute; top:167px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15957' onclick='fetchAssetData(15957);'
                        class="asset-image" data-id="<?php echo $assetId15957; ?>"
                        data-room="<?php echo htmlspecialchars($room15957); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15957); ?>"
                        data-image="<?php echo base64_encode($upload_img15957); ?>"
                        data-category="<?php echo htmlspecialchars($category15957); ?>"
                        data-status="<?php echo htmlspecialchars($status15957); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15957); ?>">
                    ...
                    <!-- ASSET 15958 -->
                    <img src='../image.php?id=15958'
                        style='width:18px; cursor:pointer; position:absolute; top:179px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15958' onclick='fetchAssetData(15958);'
                        class="asset-image" data-id="<?php echo $assetId15958; ?>"
                        data-room="<?php echo htmlspecialchars($room15958); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15958); ?>"
                        data-image="<?php echo base64_encode($upload_img15958); ?>"
                        data-status="<?php echo htmlspecialchars($status15958); ?>"
                        data-category="<?php echo htmlspecialchars($category15958); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15958); ?>">
                    ...
                    <img src='../image.php?id=15959'
                        style='width:18px; cursor:pointer; position:absolute; top:191px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15959' onclick='fetchAssetData(15959);'
                        class="asset-image" data-id="<?php echo $assetId15959; ?>"
                        data-room="<?php echo htmlspecialchars($room15959); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15959); ?>"
                        data-image="<?php echo base64_encode($upload_img15959); ?>"
                        data-category="<?php echo htmlspecialchars($category15959); ?>"
                        data-status="<?php echo htmlspecialchars($status15959); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15959); ?>">
                    ...
                    <!-- ASSET 15960 -->
                    <img src='../image.php?id=15960'
                        style='width:18px; cursor:pointer; position:absolute; top:203px; left:528px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15960' onclick='fetchAssetData(15960);'
                        class="asset-image" data-id="<?php echo $assetId15960; ?>"
                        data-room="<?php echo htmlspecialchars($room15960); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15960); ?>"
                        data-image="<?php echo base64_encode($upload_img15960); ?>"
                        data-category="<?php echo htmlspecialchars($category15960); ?>"
                        data-status="<?php echo htmlspecialchars($status15960); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15960); ?>">
                    ...
                    <!-- ASSET 15961 -->
                    <img src='../image.php?id=15961'
                        style='width:18px; cursor:pointer; position:absolute; top:155px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15961' onclick='fetchAssetData(15961);'
                        class="asset-image" data-id="<?php echo $assetId15961; ?>"
                        data-room="<?php echo htmlspecialchars($room15961); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15961); ?>"
                        data-image="<?php echo base64_encode($upload_img15961); ?>"
                        data-category="<?php echo htmlspecialchars($category15961); ?>"
                        data-status="<?php echo htmlspecialchars($status15961); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15961); ?>">
                    ...
                    <!-- ASSET 15962 -->
                    <img src='../image.php?id=15962'
                        style='width:18px; cursor:pointer; position:absolute; top:167px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15962' onclick='fetchAssetData(15962);'
                        class="asset-image" data-id="<?php echo $assetId15962; ?>"
                        data-room="<?php echo htmlspecialchars($room15962); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15962); ?>"
                        data-image="<?php echo base64_encode($upload_img15962); ?>"
                        data-category="<?php echo htmlspecialchars($category15962); ?>"
                        data-status="<?php echo htmlspecialchars($status15962); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15962); ?>">
                    ...
                    <!-- ASSET 15963 -->
                    <img src='../image.php?id=15963'
                        style='width:18px; cursor:pointer; position:absolute; top:179px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15963' onclick='fetchAssetData(15963);'
                        class="asset-image" data-id="<?php echo $assetId15963; ?>"
                        data-room="<?php echo htmlspecialchars($room15963); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15963); ?>"
                        data-image="<?php echo base64_encode($upload_img15963); ?>"
                        data-category="<?php echo htmlspecialchars($category15963); ?>"
                        data-status="<?php echo htmlspecialchars($status15963); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15963); ?>">
                    ...
                    <!-- ASSET 15964 -->
                    <img src='../image.php?id=15964'
                        style='width:18px; cursor:pointer; position:absolute; top:191px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15964' onclick='fetchAssetData(15964);'
                        class="asset-image" data-id="<?php echo $assetId15964; ?>"
                        data-room="<?php echo htmlspecialchars($room15964); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15964); ?>"
                        data-image="<?php echo base64_encode($upload_img15964); ?>"
                        data-category="<?php echo htmlspecialchars($category15964); ?>"
                        data-status="<?php echo htmlspecialchars($status15964); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15964); ?>">
                    ...
                    <!-- ASSET 15965 -->
                    <img src='../image.php?id=15965'
                        style='width:18px; cursor:pointer; position:absolute; top:203px; left:551px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15965' onclick='fetchAssetData(15965);'
                        class="asset-image" data-id="<?php echo $assetId15965; ?>"
                        data-room="<?php echo htmlspecialchars($room15965); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15965); ?>"
                        data-image="<?php echo base64_encode($upload_img15965); ?>"
                        data-status="<?php echo htmlspecialchars($status15965); ?>"
                        data-category="<?php echo htmlspecialchars($category15965); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15965); ?>">
                    ...
                    <!-- ASSET 15966 -->
                    <img src='../image.php?id=15966'
                        style='width:18px; cursor:pointer; position:absolute; top:155px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15966' onclick='fetchAssetData(15966);'
                        class="asset-image" data-id="<?php echo $assetId15966; ?>"
                        data-room="<?php echo htmlspecialchars($room15966); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15966); ?>"
                        data-image="<?php echo base64_encode($upload_img15966); ?>"
                        data-status="<?php echo htmlspecialchars($status15966); ?>"
                        data-category="<?php echo htmlspecialchars($category15966); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15966); ?>">
                    ...
                    <!-- ASSET 15967 -->
                    <img src='../image.php?id=15967'
                        style='width:18px; cursor:pointer; position:absolute; top:167px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15967' onclick='fetchAssetData(15967);'
                        class="asset-image" data-id="<?php echo $assetId15967; ?>"
                        data-room="<?php echo htmlspecialchars($room15967); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15967); ?>"
                        data-image="<?php echo base64_encode($upload_img15967); ?>"
                        data-category="<?php echo htmlspecialchars($category15967); ?>"
                        data-status="<?php echo htmlspecialchars($status15967); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15967); ?>">
                    ...
                    <!-- ASSET 15968 -->
                    <img src='../image.php?id=15968'
                        style='width:18px; cursor:pointer; position:absolute; top:179px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15968' onclick='fetchAssetData(15968);'
                        class="asset-image" data-id="<?php echo $assetId15968; ?>"
                        data-room="<?php echo htmlspecialchars($room15968); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15968); ?>"
                        data-image="<?php echo base64_encode($upload_img15968); ?>"
                        data-status="<?php echo htmlspecialchars($status15968); ?>"
                        data-category="<?php echo htmlspecialchars($category15968); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15968); ?>">
                    ...
                    <img src='../image.php?id=15969'
                        style='width:18px; cursor:pointer; position:absolute; top:191px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15969' onclick='fetchAssetData(15969);'
                        class="asset-image" data-id="<?php echo $assetId15969; ?>"
                        data-room="<?php echo htmlspecialchars($room15969); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15969); ?>"
                        data-image="<?php echo base64_encode($upload_img15969); ?>"
                        data-status="<?php echo htmlspecialchars($status15969); ?>"
                        data-category="<?php echo htmlspecialchars($category15969); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15969); ?>">
                    ...
                    <!-- ASSET 15970 -->
                    <img src='../image.php?id=15970'
                        style='width:18px; cursor:pointer; position:absolute; top:203px; left:574px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15970' onclick='fetchAssetData(15970);'
                        class="asset-image" data-id="<?php echo $assetId15970; ?>"
                        data-room="<?php echo htmlspecialchars($room15970); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15970); ?>"
                        data-status="<?php echo htmlspecialchars($status15970); ?>"
                        data-image="<?php echo base64_encode($upload_img15970); ?>"
                        data-category="<?php echo htmlspecialchars($category15970); ?>">
                    ...
                    <!-- ASSET 15971 -->
                    <img src='../image.php?id=15971'
                        style='width:18px; cursor:pointer; position:absolute; top:155px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15971' onclick='fetchAssetData(15971);'
                        class="asset-image" data-id="<?php echo $assetId15971; ?>"
                        data-room="<?php echo htmlspecialchars($room15971); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15971); ?>"
                        data-image="<?php echo base64_encode($upload_img15971); ?>"
                        data-status="<?php echo htmlspecialchars($status15971); ?>"
                        data-category="<?php echo htmlspecialchars($category15971); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15971); ?>">
                    ...
                    <!-- ASSET 15972 -->
                    <img src='../image.php?id=15972'
                        style='width:18px; cursor:pointer; position:absolute; top:167px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15972' onclick='fetchAssetData(15972);'
                        class="asset-image" data-id="<?php echo $assetId15972; ?>"
                        data-room="<?php echo htmlspecialchars($room15972); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15972); ?>"
                        data-image="<?php echo base64_encode($upload_img15972); ?>"
                        data-status="<?php echo htmlspecialchars($status15972); ?>"
                        data-category="<?php echo htmlspecialchars($category15972); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15972); ?>">
                    ...
                    <!-- ASSET 15973 -->
                    <img src='../image.php?id=15973'
                        style='width:18px; cursor:pointer; position:absolute; top:179px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15973' onclick='fetchAssetData(15973);'
                        class="asset-image" data-id="<?php echo $assetId15973; ?>"
                        data-room="<?php echo htmlspecialchars($room15973); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15973); ?>"
                        data-status="<?php echo htmlspecialchars($status15973); ?>"
                        data-image="<?php echo base64_encode($upload_img15973); ?>"
                        data-category="<?php echo htmlspecialchars($category15973); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15973); ?>">
                    ...
                    <!-- ASSET 15974 -->
                    <img src='../image.php?id=15974'
                        style='width:18px; cursor:pointer; position:absolute; top:191px; left:597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15974' onclick='fetchAssetData(15974);'
                        class="asset-image" data-id="<?php echo $assetId15974; ?>"
                        data-room="<?php echo htmlspecialchars($room15974); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15974); ?>"
                        data-image="<?php echo base64_encode($upload_img15974); ?>"
                        data-category="<?php echo htmlspecialchars($category15974); ?>"
                        data-status="<?php echo htmlspecialchars($status15974); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15974); ?>">
                    ...
                    <!-- ASSET 15975 -->
                    <img src='../image.php?id=15975'
                        style='width:18px; cursor:pointer; position:absolute; top:203px; left: 597px;' alt='...'
                        data-bs-toggle='modal' data-bs-target='#imageModal15975' onclick='fetchAssetData(15975);'
                        class="asset-image" data-id="<?php echo $assetId15975; ?>"
                        data-room="<?php echo htmlspecialchars($room15975); ?>"
                        data-floor="<?php echo htmlspecialchars($floor15975); ?>"
                        data-image="<?php echo base64_encode($upload_img15975); ?>"
                        data-category="<?php echo htmlspecialchars($category15975); ?>"
                        data-status="<?php echo htmlspecialchars($status15975); ?>"
                        data-assignedname="<?php echo htmlspecialchars($assignedName15975); ?>">
...
position:absolute; top:142px; left:700px;'>
                    ...
                    <img src='../image.php?id=15566'
                        style='width:15px; cursor:pointer; position:absolute; top:143px; left: 698px;' alt='...'
